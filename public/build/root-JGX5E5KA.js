...
var require_prism_jsx = __commonJS({
  "node_modules/prismjs/components/prism-jsx.js"() {
    ...
    (function(Prism2) {
      ...
      Prism2.languages.jsx.tag.pattern = re3(/<\/?(?:[\w.:-]+(?:<S>+(?:[\w.:$-]+(?:=(?:"(?:\\[\s\S]|[^\\"])*"|'(?:\\[\s\S]|[^\\'])*'|[^\s{'"/>=]+|<BRACES>))?|<SPREAD>))*<S>*\/?)?>/.source);
...
var P = function(e2) {
  var t2 = e2.size, n2 = t2 === void 0 ? "large" : t2, r2 = l(me(), 1)[0];
  return import_react.default.createElement(N2, null, import_react.default.createElement(_, null, import_react.default.createElement("div", { className: (0, import_classnames.default)("text-3xl", { "sm:text-5xl": n2 === "large" }, { "sm:text-4xl": n2 === "medium" }) }, import_react.default.createElement(C, { propName: "title", renderBlock: function(e3) {
...
var B = function() {
  return import_react.default.createElement(N2, null, import_react.default.createElement(_, null, import_react.default.createElement(Y, { propName: "text", placeholder: "Paragraph...", renderBlock: function(e2) {
    var t2 = e2.children;
    return import_react.default.createElement("p", { className: "text-lg leading-relaxed mb-2 text-gray-700 dark:text-gray-200" }, t2);
  }, allowedFeatures: [b.RichTextFeatures.Heading2, b.RichTextFeatures.Heading3, b.RichTextFeatures.Heading4, b.RichTextFeatures.Bold, b.RichTextFeatures.Italic, b.RichTextFeatures.Link, b.RichTextFeatures.Code, b.RichTextFeatures.Highlight, b.RichTextFeatures.UnorderedList, b.RichTextFeatures.OrderedList], renderH2: function(e2) {
    var t2 = e2.children;
    ...
    return import_react.default.createElement(H, { href: n2, className: "text-blue-500 underline dark:text-blue-300" }, t2);
  } })));
};
B.schema = { name: T.Paragraph, label: "Paragraph", playgroundLinkLabel: "View source code on Github", playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/blog/Paragraph/Paragraph.tsx", getDefaultProps: function() {
...
}, sideEditProps: [{ name: "platform", label: "Video platform", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Radio, options: [{ value: "youtube", label: "YouTube" }, { value: "vimeo", label: "Vimeo" }] } }, { name: "url", label: 'Video ID (i.e. "A60xWr-nqv0")', type: b.SideEditPropType.Text }] };
var I = function() {
  return import_react.default.createElement(N2, null, import_react.default.createElement(_, null, import_react.default.createElement(te, { propName: "image", aspectRatio: 1.78, alt: "" })));
};
...
var z = function(e2) {
  var t2 = e2.id, n2 = e2.placeholder, r2 = e2.align, o3 = e2.cards, l3 = e2.conversation, s3 = e2.theme, m2 = (0, import_react.useRef)(null), h = l((0, import_react.useState)(true), 2), g2 = h[0], f = h[1], b2 = (0, import_react.useContext)(A).isDarkColorMode;
  return (0, import_react.useEffect)(function() {
    var e3 = s3 === "dark" || s3 === "auto" && !!b2 ? "dark" : "";
  ...
  }, [g2, t2, n2, r2, o3, l3, s3, b2]), i2.createElement(N2, null, i2.createElement(_, null, i2.createElement("div", { ref: m2 }, g2 && n2)));
};
z.schema = { name: T.Tweet, label: "Tweet", playgroundLinkLabel: "View source code on Github", playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/blog/Tweet/Tweet.tsx", getDefaultProps: function() {
...
}, sideEditProps: [{ name: "id", label: "Tweet ID", type: b.SideEditPropType.Text }, { name: "placeholder", label: "Loading Placeholder", type: b.SideEditPropType.Text }, { name: "align", label: "Align", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "left", label: "Left" }, { value: "center", label: "Center" }, { value: "right", label: "Right" }] } }, { name: "cards", label: "Cards", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "", label: "Show" }, { value: "hidden", label: "Hidden" }] } }, { name: "conversation", label: "Conversation", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "", label: "Show" }, { value: "none", label: "None" }] } }, { name: "theme", label: "Theme", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "auto", label: "Automatic" }, { value: "light", label: "Light" }, { value: "dark", label: "Dark" }] } }] };
...
var U = function(e2) {
      ...
      if (!l3 || (l3(e3), !e3.defaultPrevented)) {
        ...
        if (e3.keyCode === 9 && !o3 && t2.state.capture)
          if (e3.preventDefault(), e3.shiftKey) {
            ...
            var f, b2 = (f = t2._getLines(s3, c4)).length - 1, y = t2._getLines(s3, d3).length - 1;
            g2 = f[b2];
            t2._applyEdits({ value: s3.split("\n").map(function(e4, t3) {
              return t3 >= b2 && t3 <= y ? u2 + e4 : e4;
            }).join("\n"), selectionStart: /\S/.test(g2) ? c4 + u2.length : c4, selectionEnd: d3 + u2.length * (y - b2 + 1) });
          } else {
            var k2 = c4 + u2.length;
          ...
          if (c4 === d3) {
            var x = t2._getLines(s3, c4).pop(), E = x == null ? void 0 : x.match(/^\s+/);
            if (E && E[0]) {
              e3.preventDefault();
              var w2 = "\n" + E[0];
              k2 = c4 + w2.length;
          ...
          var C4 = void 0;
          e3.keyCode === 57 && e3.shiftKey ? C4 = ["(", ")"] : e3.keyCode === 219 ? C4 = e3.shiftKey ? ["{", "}"] : ["[", "]"] : e3.keyCode === 222 ? C4 = e3.shiftKey ? ['"', '"'] : ["'", "'"] : e3.keyCode !== 192 || e3.shiftKey || (C4 = ["`", "`"]), c4 !== d3 && C4 && (e3.preventDefault(), t2._applyEdits({ value: s3.substring(0, c4) + C4[0] + s3.substring(c4, d3) + C4[1] + s3.substring(d3), selectionStart: c4, selectionEnd: d3 + 2 }));
        } else
  ...
  return a(a2, e2), a2.prototype.componentDidMount = function() {
    ...
    var e3 = this, a3 = this.props, r2 = a3.value, o3 = a3.style, l3 = a3.padding, s3 = a3.highlight, c4 = a3.textareaId, d3 = a3.textareaClassName, u2 = a3.autoFocus, p2 = a3.disabled, m2 = a3.form, h = a3.maxLength, g2 = a3.minLength, f = a3.name, b2 = a3.placeholder, y = a3.readOnly, k2 = a3.required, v = a3.onClick, x = a3.onFocus, E = a3.onBlur, w2 = a3.onKeyUp;
    a3.onKeyDown, a3.onValueChange, a3.tabSize, a3.insertSpaces, a3.ignoreTabKey;
    var C4 = a3.preClassName, S = t(a3, ["value", "style", "padding", "highlight", "textareaId", "textareaClassName", "autoFocus", "disabled", "form", "maxLength", "minLength", "name", "placeholder", "readOnly", "required", "onClick", "onFocus", "onBlur", "onKeyUp", "onKeyDown", "onValueChange", "tabSize", "insertSpaces", "ignoreTabKey", "preClassName"]), L3 = { paddingTop: l3, paddingRight: l3, paddingBottom: l3, paddingLeft: l3 }, T2 = s3(r2);
    return i2.createElement("div", r({}, S, { style: r(r({}, A2.container), o3) }), i2.createElement("textarea", { ref: function(t2) {
      return e3._input = t2;
    }, style: r(r(r({}, A2.editor), A2.textarea), L3), className: F + (d3 ? " ".concat(d3) : ""), id: c4, value: r2, onChange: this._handleChange, onKeyDown: this._handleKeyDown, onClick: v, onKeyUp: w2, onFocus: x, onBlur: E, disabled: p2, form: m2, maxLength: h, minLength: g2, name: f, placeholder: b2, readOnly: y, required: k2, autoFocus: u2, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", spellCheck: false, "data-gramm": false }), i2.createElement("pre", r({ className: C4, "aria-hidden": "true", style: r(r(r({}, A2.editor), A2.highlight), L3) }, typeof T2 == "string" ? { dangerouslySetInnerHTML: { __html: T2 + "<br />" } } : { children: T2 })), i2.createElement("style", { type: "text/css", dangerouslySetInnerHTML: { __html: O } }));
...
var H2 = function(e2) {
  ...
  i2.useEffect(function() {
    l3 && l3.current && C2.highlightElement(l3.current);
  }, [o3]);
...
}, sideEditProps: [{ name: "language", label: "Language", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "javascript", label: "JavaScript" }, { value: "css", label: "CSS" }, { value: "typescript", label: "TypeScript" }, { value: "bash", label: "Bash" }, { value: "jsx", label: "JSX" }, { value: "tsx", label: "TSX" }] } }, { name: "dataline", label: "Highlight line (ex: 1,2,3): ", type: b.SideEditPropType.Text }, { name: "showLineNumbers", label: "Show Line Numbers?", type: b.SideEditPropType.Boolean }, { name: "helper", label: "Warning", type: b.SideEditPropType.Custom, component: function() {
...
var G = function(e2) {
  var t2 = e2.tweetLink, r2 = e2.authorLink, o3 = ae(), l3 = o3.isAdmin, i3 = o3.previewMode, c4 = l((0, import_react.useState)(false), 2), u2 = c4[0], p2 = c4[1];
  ...
  } }, import_react.default.createElement("div", { className: "mr-2 w-12 h-12" }, import_react.default.createElement(te, { propName: "author", alt: "athor-name", imageClassName: "rounded-full filter hover:brightness-90" })), import_react.default.createElement("div", { className: "group" }, import_react.default.createElement(C, { propName: "authorName", placeholder: "Author Name", renderBlock: function(e3) {
    var t3 = e3.children;
  ...
  } }), import_react.default.createElement(C, { propName: "authorTwitterHandle", placeholder: "Author @", renderBlock: function(e3) {
    var t3 = e3.children;
    return import_react.default.createElement("div", { className: "text-sm text-gray-500 font-medium tracking-tight" }, t3);
  } }))), import_react.default.createElement("div", { className: "text-2xl dark:text-neutral-300", style: { color: "#1d9bf0" } }, import_react.default.createElement(FaTwitter, null))), import_react.default.createElement(N, { propName: "tweetContent", placeholder: "tweet content", renderBlock: function(e3) {
    var t3 = e3.children;
    return import_react.default.createElement("div", { className: "mb-2 text-xl font-medium leading-tight dark:text-neutral-300" }, t3);
  }, plugins: [r(r({}, J.link), { renderElement: function(e3) {
  ...
  }, label: "Twitter profile link", button: { isActive: J.link.button.isActive, icon: import_react.default.createElement(FaTwitter, null) } })] }), import_react.default.createElement(C, { propName: "date", placeholder: "Date", renderBlock: function(e3) {
    var t3 = e3.children;
...
}, sideEditProps: [{ name: "helper", label: "Why Tweet light?", type: b.SideEditPropType.Custom, component: function() {
...
} }, { name: "tweetLink", label: "Tweet Link", type: b.SideEditPropType.Text }, { name: "authorLink", label: "Author Link", type: b.SideEditPropType.Text }] };
var J2 = [P, B, K, j, I, W, z, G];
...
function osm(x, y, z3) {
  var s3 = String.fromCharCode(97 + (x + y + z3) % 3);
  return "https://" + s3 + ".tile.openstreetmap.org/" + z3 + "/" + x + "/" + y + ".png";
}
...
function tile2lng(x, z3) {
  return x / Math.pow(2, z3) * 360 - 180;
}
function tile2lat(y, z3) {
  var n2 = Math.PI - 2 * Math.PI * y / Math.pow(2, z3);
...
function srcSet(dprs, url, x, y, z3) {
  if (!dprs || dprs.length === 0) {
    return "";
  }
  return dprs.map(function(dpr) {
    return url(x, y, z3, dpr) + (dpr === 1 ? "" : " " + dpr + "x");
  }).join(", ");
}
...
var R2 = function(t2) {
  var a2 = t2.bg, r2 = a2 === void 0 ? c.white.value : a2, o3 = t2.borderTop, l3 = o3 === void 0 ? "none" : o3, i3 = t2.borderBottom, s3 = i3 === void 0 ? "none" : i3, n2 = t2.className, m2 = n2 === void 0 ? "" : n2, p2 = t2.children, b2 = r2.className;
  return c3.createElement("section", { className: (0, import_classnames2.default)(b2, m2, "overflow-hidden") }, l3 !== "none" && c3.createElement(P2, { boxed: l3 === "boxed" }), p2, s3 !== "none" && c3.createElement(P2, { boxed: s3 === "boxed" }));
};
var F2 = function(e2) {
  switch (e2) {
    case "lg":
...
var j2 = function(e2) {
  ...
  return r2 && (r2 == null ? void 0 : r2.length) > 0 ? { groupName: "Layout", props: [{ name: "bg", label: "Background", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Color, options: o([], l(r2), false) } }, { name: "borderTop", label: "Border Top", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "none", label: "None" }, { value: "full", label: "Full-width" }, { value: "boxed", label: "Boxed" }] } }, { name: "borderBottom", label: "Border Bottom", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "none", label: "None" }, { value: "full", label: "Full-width" }, { value: "boxed", label: "Boxed" }] } }, { name: "width", label: "Width", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "sm", label: "Small" }, { value: "md", label: "Medium" }, { value: "lg", label: "Large" }] } }] } : { groupName: "Layout", props: [{ name: "borderTop", label: "Border Top", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "none", label: "None" }, { value: "full", label: "Full-width" }, { value: "boxed", label: "Boxed" }] } }, { name: "borderBottom", label: "Border Bottom", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "none", label: "None" }, { value: "full", label: "Full-width" }, { value: "boxed", label: "Boxed" }] } }] };
};
var O2 = function(t2) {
  ...
  return c3.createElement(R2, { bg: l3, borderTop: s3, borderBottom: m2 }, c3.createElement(C3, { size: f, className: (0, import_classnames2.default)("py-12 flex flex-col sm:flex-row items-center text-center sm:text-left") }, c3.createElement("div", { className: "sm:mr-10 mb-4 sm:mb-0 w-32" }, c3.createElement(te, { propName: "imageSource", alt: "image" })), c3.createElement("div", { className: "flex-1" }, c3.createElement(C, { propName: "title", renderBlock: function(e2) {
  ...
  }, placeholder: "Title" }), c3.createElement(Y, { propName: "text", renderBlock: function(e2) {
    return c3.createElement("span", r({ className: (0, import_classnames2.default)("leading-6", n.gray700) }, e2.attributes), e2.children);
  }, placeholder: "Text", allowedFeatures: [b.RichTextFeatures.Link] }))));
};
...
var D2 = function(t2) {
  var a2 = t2.bg, l3 = a2 === void 0 ? c.white.value : a2, i3 = t2.borderTop, s3 = i3 === void 0 ? "boxed" : i3, n2 = t2.borderBottom, m2 = n2 === void 0 ? "none" : n2, p2 = t2.width, b2 = p2 === void 0 ? "sm" : p2;
  return c3.createElement(R2, { bg: l3, borderTop: s3, borderBottom: m2 }, c3.createElement(C3, { size: b2, className: (0, import_classnames2.default)("py-12 flex flex-col sm:flex-row items-center text-center sm:text-left") }, c3.createElement("div", { className: "flex-1 sm:pr-12 mb-4 sm:mb-0" }, c3.createElement(Y, { propName: "text", renderBlock: function(e2) {
  ...
  }, placeholder: "Call to action text" })), c3.createElement("div", null, c3.createElement(re, { propName: "buttons", itemProps: { padding: "small" } }))));
};
...
var M2 = function(e2) {
  var t2 = e2.grayscale, a2 = t2 === void 0 || t2, o3 = t(e2, ["grayscale"]), i3 = c3.useContext(A).isDarkColorMode;
  return c3.createElement("div", r({ className: "px-6 py-4 w-1/2 sm:w-1/3 md:w-1/6 flex justify-center items-center text-gray-300" }, o3), c3.createElement(te, { propName: "image", alt: "customer", imageClassName: "w-32 h-16", imageStyle: a2 ? i3 ? { filter: "opacity(0.5) grayscale(100%) invert(1)" } : { filter: "opacity(0.5) grayscale(100%)" } : {} }));
};
...
var G2 = function(t2) {
  var a2 = t2.bg, r2 = a2 === void 0 ? c.white.value : a2, o3 = t2.borderTop, l3 = o3 === void 0 ? "none" : o3, i3 = t2.borderBottom, s3 = i3 === void 0 ? "none" : i3, n2 = t2.width, m2 = n2 === void 0 ? "lg" : n2, p2 = t2.grayscale, b2 = p2 === void 0 || p2;
  return c3.createElement(R2, { bg: r2, borderTop: l3, borderBottom: s3 }, c3.createElement(C3, { size: m2, className: (0, import_classnames2.default)("py-12 flex flex-wrap justify-center items-center") }, c3.createElement(re, { propName: "customers", itemProps: { grayscale: b2 } })));
};
...
}, repeaterItems: [{ name: "customers", itemType: I2.Customer, itemLabel: "Customer", min: 0, max: 12 }], sideEditProps: [j2({ colors: [c.white, c.light, c.gray] }), { name: "grayscale", label: "Greyscale", type: b.SideEditPropType.Boolean }] };
var U2 = function(t2) {
  ...
  return c3.createElement(R2, { bg: r2, borderTop: l3, borderBottom: s3 }, c3.createElement(C3, { size: m2, className: (0, import_classnames2.default)("pt-12") }, c3.createElement(re, { propName: "faqs" })));
};
...
var z2 = function() {
  return c3.createElement("div", { className: "leading-6 mb-12" }, c3.createElement(C, { propName: "question", renderBlock: function(e2) {
  ...
  }, placeholder: "Answer..." }), c3.createElement(Y, { propName: "answer", renderBlock: function(e2) {
    return c3.createElement("p", r({ className: n.gray800 }, e2.attributes), e2.children);
  }, placeholder: "Answer..." }));
};
z2.schema = { name: I2.Faq, label: "Question", hideFromAddMenu: true, playgroundLinkLabel: "View source code on Github", playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/website/Faq/FaqItem.tsx", getDefaultProps: function() {
...
}, sideEditProps: [{ name: "isTextCenter", label: "center feature", type: b.SideEditPropType.Boolean }] };
var _2 = function(e2) {
  switch (e2) {
    case "base":
      return "max-w-3xl";
...
var A3 = function(t2) {
  ...
  return c3.createElement(R2, { bg: r2, borderTop: l3, borderBottom: s3 }, c3.createElement(C3, { size: "lg", className: (0, import_classnames2.default)("py-12 flex flex-wrap justify-center items-center") }, c3.createElement(re, { propName: "feature-item", renderWrapper: function(e2) {
...
}, repeaterItems: [{ name: "feature-item", itemType: I2.FeatureItem, itemLabel: "Feature", min: 0, max: 4 }], sideEditProps: [j2(), { name: "screenLayout", label: "Screen Layout", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "base", label: "Two columns" }, { value: "small", label: "Small two columns" }, { value: "small-3cols", label: "Three columns" }] } }] };
var H3 = function(t2) {
  var a2 = t2.bg, l3 = a2 === void 0 ? c.white.value : a2, s3 = t2.borderTop, n2 = s3 === void 0 ? "none" : s3, m2 = t2.borderBottom, b2 = m2 === void 0 ? "none" : m2, u2 = t2.textGradient, f = u2 === void 0 ? "none" : u2, x = t2.size, y = x === void 0 ? "large" : x, v = n.gray800, k2 = n.gray700, w2 = n.purple500, E = f !== "none" ? { WebkitTextFillColor: "transparent" } : {};
  return c3.createElement(R2, { bg: l3, borderTop: n2, borderBottom: b2 }, c3.createElement(C3, { size: "lg", className: "py-12 xl:py-20" }, c3.createElement("div", { className: "max-w-xl mx-auto px-5" }, c3.createElement(re, { propName: "badge", renderWrapper: function(e2) {
    return c3.createElement("div", { className: "mb-4" }, e2);
  } }), c3.createElement("div", { className: (0, import_classnames2.default)(v, i[f], "text-3xl", { "sm:text-5xl": y === "large" }, { "sm:text-4xl": y === "medium" }), style: E }, c3.createElement(Y, { renderBlock: function(e2) {
  ...
  }, placeholder: "Type a title...", propName: "title", allowedFeatures: [b.RichTextFeatures.Highlight], renderHighlight: function(e2) {
    return c3.createElement("span", r({ className: w2 }, e2.attributes), e2.children);
  } })), c3.createElement(Y, { renderBlock: function(e2) {
  ...
  }, placeholder: "Type a text...", propName: "text", allowedFeatures: [b.RichTextFeatures.Bold, b.RichTextFeatures.Link] }), c3.createElement(re, { propName: "buttons", renderWrapper: function(e2) {
    return c3.createElement("div", { className: "flex justify-center items-center flex-col sm:flex-row mt-6" }, e2);
  } }))));
};
H3.schema = { name: I2.HeroUnit, label: "Hero Unit", playgroundLinkLabel: "View source code on Github", playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/website/Hero%20Unit/HeroUnit.tsx", getDefaultProps: function() {
...
}, repeaterItems: [{ name: "badge", itemType: I2.Badge, itemLabel: "Badge", min: 0, max: 1 }, { name: "buttons", itemType: I2.Button, itemLabel: "Button", min: 0, max: 2 }], sideEditProps: [j2({ colors: [c.white, c.light, c.gray, c.lightBlue, c.orange, c.green, c.darkBlue, c.dark] }), { groupName: "Title", defaultOpen: true, props: [{ name: "textGradient", label: "Text gradient", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: "none", label: "None" }, { value: "ocean", label: "Ocean" }, { value: "violet", label: "Violet" }, { value: "sun", label: "Sunset" }] } }, { name: "size", label: "Title size", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Radio, options: [{ value: "medium", label: "Medium" }, { value: "large", label: "Large" }] } }] }] };
var K2;
var J3 = function(e2, t2, a2, r2) {
...
var Q = function(e2) {
  ...
  return import_react3.default.createElement(R2, { bg: o3, borderTop: a2, borderBottom: i3 }, import_react3.default.createElement(C3, { size: t2 }, import_react3.default.createElement(Map, r({ center: [n2, d3], height: 350, metaWheelZoom: true, zoom: 10, provider: J3, dprs: [1, 2] }, p2), import_react3.default.createElement(Marker, { anchor: [n2, d3] }))));
};
...
}, sideEditProps: [j2({ colors: [c.white, c.light, c.gray] }), { groupName: "Map", defaultOpen: true, props: [{ name: "lat", label: "Latitude", type: b.SideEditPropType.Number }, { name: "lng", label: "Longitude", type: b.SideEditPropType.Number }] }] }, function(e2) {
  e2.MailChimp = "MAILCHIMP", e2.ConvertKit = "CONVERTKIT";
}(K2 || (K2 = {}));
var Z = function(e2) {
  var t2 = e2.centered, o3 = t2 !== void 0 && t2, l3 = e2.provider, i3 = e2.mailchimpUrl, s3 = e2.buttonText, n2 = e2.resultOkText, m2 = n2 === void 0 ? "Thank you, we'll keep in touch with you!" : n2, p2 = l(c3.useState(""), 2), b2 = p2[0], g2 = p2[1], h = l(c3.useState({ status: "IDLE", message: "" }), 2), f = h[0], x = h[1];
  return c3.createElement("section", { className: "py-12", style: { backgroundColor: "#deeffc", color: "#113d5f" } }, c3.createElement("div", { className: (0, import_classnames2.default)("max-w-xl mx-auto flex flex-col", { "items-center": o3 }) }, c3.createElement(C, { renderBlock: function(e3) {
    return c3.createElement("h1", r({ className: "text-2xl mb-4 font-extrabold" }, e3.attributes), e3.children);
  }, placeholder: "Type a title...", propName: "title" }), c3.createElement(C, { renderBlock: function(e3) {
    ...
    if (e3.preventDefault(), l3 === K2.MailChimp)
      if ((0, import_email_validator.validate)(b2))
        if (!i3 || i3.length < 10 || i3.indexOf("post") === -1)
          x({ status: "ERROR", message: "Invalid Mailchimp URL" });
        else {
          var t3 = encodeURIComponent(b2), a2 = i3.replace(/\/post/g, "/post-json");
          !function(e4) {
  ...
  } }, c3.createElement("input", { className: "bg-white focus:outline-none border-t-2 border-l-2 border-b-2 border-transparent focus:border-sky-500 rounded-l-lg py-2 px-4 appearance-none leading-normal", type: "text", placeholder: "jane@example.com", value: b2, onChange: function(e3) {
...
Z.schema = { name: I2.NewsletterSubscribe, label: "Newsletter Subscribe", playgroundLinkLabel: "View source code on Github", playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/website/NewsletterSubscribe/NewsletterSubscribe.tsx", getDefaultProps: function() {
...
}, sideEditProps: [{ name: "centered", label: "Centered", type: b.SideEditPropType.Boolean }, { name: "provider", label: "Provider", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Select, options: [{ value: K2.MailChimp, label: "MailChimp" }, { value: K2.ConvertKit, label: "ConvertKit - TODO" }] } }, { name: "mailchimpUrl", label: "Mailchimp Form URL", type: b.SideEditPropType.Text, validate: function(e2) {
  return e2 && e2.length > 10 && e2.indexOf("https://") !== -1;
} }, { name: "buttonText", label: "Button text", type: b.SideEditPropType.Text }, { name: "resultOkText", label: "Result OK text", type: b.SideEditPropType.Text }] };
var Y2 = function(e2) {
  var t2 = e2.color, a2 = t2 === void 0 ? s.gray.value : t2, o3 = e2.className, i3 = t(e2, ["color", "className"]);
  return c3.createElement("div", r({}, i3, { className: "flex justify-center items-center" }), c3.createElement(C, { renderBlock: function(e3) {
...
Y2.schema = { name: I2.Badge, label: "Badge", hideFromAddMenu: true, playgroundLinkLabel: "View source code on Github", playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/website/shared/Badge.tsx", getDefaultProps: function() {
  return { text: "Special", color: s.gray.value };
}, sideEditProps: [{ name: "color", label: "Badge Color", type: b.SideEditPropType.Select, shouldRefreshText: true, selectOptions: { display: b.OptionsDisplay.Color, options: [s.gray, s.pink, s.blue, s.green] } }] };
var X = function(e2) {
  var t2 = e2.color, a2 = t2 === void 0 ? g.pinkLight.value : t2, o3 = e2.className, i3 = t(e2, ["color", "className"]);
  return c3.createElement("div", r({ className: (0, import_classnames2.default)("flex justify-start items-center py-2 leading-tight", o3) }, i3), c3.createElement("div", { className: (0, import_classnames2.default)("flex justify-center items-center w-5 h-5 rounded-full mr-4 text-sm", a2.className), style: { minWidth: "1.25rem" } }, c3.createElement(FiCheck, null)), c3.createElement(C, { propName: "text", renderBlock: function(e3) {
...
X.schema = { name: I2.BulletListItem, label: "List item", hideFromAddMenu: true, playgroundLinkLabel: "View source code on Github", playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/website/shared/BulletListItem.tsx", getDefaultProps: function() {
  return { color: g.pinkLight.value, text: "New item" };
}, sideEditProps: [{ name: "color", label: "Color", type: b.SideEditPropType.Select, shouldRefreshText: true, selectOptions: { display: b.OptionsDisplay.Color, options: [g.pink, g.pinkLight, g.azure, g.azureLight, g.green, g.greenLight] } }] };
var $ = function(e2) {
  var t2 = e2.text, a2 = e2.href, o3 = e2.isTargetBlank, i3 = o3 !== void 0 && o3, s3 = e2.isBigButton, n2 = s3 !== void 0 && s3, m2 = e2.variant, p2 = m2 === void 0 ? "pink" : m2, b2 = e2.type, u2 = b2 === void 0 ? "solid" : b2, g2 = e2.padding, h = g2 === void 0 ? "normale" : g2, f = e2.className, y = t(e2, ["text", "href", "isTargetBlank", "isBigButton", "variant", "type", "padding", "className"]), v = i3 ? { target: "_blank", rel: "noopener noreferrer" } : {};
  return c3.createElement(H, r({ href: a2 }, v, { className: (0, import_classnames2.default)("py-3 mx-2 my-2 rounded-full font-bold leading-none translate-hover-2 hover:shadow-lg transition-all ease-in-out duration-150", h === "normal" ? "px-8" : "px-5", n2 && " w-3/5 text-center rounded-sm", { "bg-pink-500 text-white hover:bg-pink-600 hover:text-white": p2 === "pink" && u2 === "solid" }, { "bg-sky-500 text-white hover:bg-sky-600 hover:text-white": p2 === "azure" && u2 === "solid" }, { "border border-pink-600 text-pink-600 hover:text-pink-600 dark:border-pink-500 dark:text-pink-500": p2 === "pink" && u2 === "outline" }, { "border border-sky-600 text-sky-600 hover:text-sky-600 dark:border-sky-500 dark:text-sky-500": p2 === "azure" && u2 === "outline" }, f) }, y), t2);
};
...
}, sideEditProps: [{ name: "text", label: "Button text", type: b.SideEditPropType.Text }, { name: "isBigButton", label: "Size button big?", type: b.SideEditPropType.Boolean }, { name: "variant", label: "Variant", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Radio, options: [{ value: "azure", label: "Azure" }, { value: "pink", label: "Pink" }] } }, { name: "type", label: "Type", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Radio, options: [{ value: "solid", label: "Solid" }, { value: "outline", label: "Outline" }] } }, { name: "href", label: "Link (external or path)", type: b.SideEditPropType.Text }, { name: "isTargetBlank", label: "Open in new window", type: b.SideEditPropType.Boolean }] };
var ee = function(t2) {
...
te2.schema = { name: I2.TeamItem, label: "Team Item", hideFromAddMenu: true, playgroundLinkLabel: "View source code on Github", playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/website/Team/TeamItem.tsx", getDefaultProps: function() {
  return { bg: { color: "#fff", className: "bg-white dark:bg-gray-900" }, borderTop: "none", borderBottom: "none", width: "lg", memberName: "Matteo Frana", role: "Frontend Designer", twitter: "", github: "", linkedin: "", picture: { src: "https://images.reactbricks.com/original/7e7dcf49-04c8-4494-ab4a-bab1f88056aa.jpg", placeholderSrc: "https://images.reactbricks.com/placeholder/7e7dcf49-04c8-4494-ab4a-bab1f88056aa.jpg", srcSet: "https://images.reactbricks.com/src_set/7e7dcf49-04c8-4494-ab4a-bab1f88056aa-400.jpg 400w,\nhttps://images.reactbricks.com/src_set/7e7dcf49-04c8-4494-ab4a-bab1f88056aa-200.jpg 200w" } };
}, sideEditProps: [{ groupName: "Social Media", defaultOpen: true, props: [{ name: "twitter", label: "Twitter UserName", type: b.SideEditPropType.Text }, { name: "linkedin", label: "Linkedin UserName", type: b.SideEditPropType.Text }, { name: "github", label: "Github UserName", type: b.SideEditPropType.Text }] }] };
var ae2 = function(t2) {
  ...
  return c3.createElement(R2, { bg: m2, borderTop: g2, borderBottom: f }, c3.createElement(C3, { size: "sm", className: (0, import_classnames2.default)("pt-12 pb-20 flex flex-col justify-between ", s3 ? "items-start" : "items-center") }, c3.createElement(C, { renderBlock: function(e2) {
  ...
  }, propName: "quote" }), c3.createElement("div", { className: "flex items-center" }, o3 ? c3.createElement(te, { alt: a2, propName: "avatarImage", imageClassName: (0, import_classnames2.default)("rounded-full", s3 ? "w-8" : "w-10") }) : c3.createElement("div", { className: (0, import_classnames2.default)("flex justify-center items-center rounded-full bg-gray-100 text-gray-500 text-xl", s3 ? "w-8" : "w-10") }, c3.createElement(FiUser, null)), c3.createElement("div", { className: "ml-3 dark:text-gray-200" }, c3.createElement(C, { renderBlock: function(e2) {
    return c3.createElement("div", { className: "text-sm font-bold" }, e2.children);
  }, placeholder: "Author name...", propName: "authorName" }), c3.createElement(C, { renderBlock: function(e2) {
    return c3.createElement("div", { className: "text-xs" }, e2.children);
  }, placeholder: "Job title...", propName: "authorJobTitle" })), l3 && c3.createElement("div", { className: "ml-5 pl-5 border-l border-gray-300" }, c3.createElement(te, { alt: r2, propName: "logoImage", imageClassName: "h-6" })))));
};
...
var re2 = function(t2) {
  ...
  }, placeholder: "Type a title...", allowedFeatures: [b.RichTextFeatures.Highlight], renderHighlight: function(e2) {
    return c3.createElement("span", r({ className: G3 }, e2.attributes), e2.children);
  } }), c3.createElement(Y, { propName: "text", renderBlock: function(e2) {
  ...
  }, placeholder: "Type a text...", allowedFeatures: [b.RichTextFeatures.Bold, b.RichTextFeatures.Link], renderLink: function(e2) {
    return c3.createElement(H, r({}, e2, { className: "text-lg" }), e2.children, "\xA0\xBB");
  } }), c3.createElement(re, { propName: "bulletListItems", itemProps: { className: "lg:w-2/5 text-lg" }, renderWrapper: function(e2) {
    return c3.createElement("div", { className: "mt-4 w-full flex flex-col lg:flex-row lg:flex-wrap lg:justify-between" }, e2);
  } }), c3.createElement(re, { propName: "buttons", renderWrapper: function(e2) {
    return c3.createElement("div", { className: "flex items-center flex-col sm:flex-row mt-4" }, e2);
  } })), N3 ? c3.createElement("div", { className: "flex w-full md:w-2/5 lg:w-1/2 max-w-xs md:max-w-sm mx-auto mt-10 md:mt-0 flex-wrap justify-center -mb-6" }, c3.createElement(re, { propName: "logos" })) : c3.createElement("div", { className: (0, import_classnames2.default)(F3 ? "w-24" : "w-full", L3 ? "mt-0 mb-10" : "mt-10 mb-0", "md:w-2/5 md:mt-0 md:mb-0") }, c3.createElement(te, { propName: "imageSource", alt: "Image", imageClassName: (0, import_classnames2.default)({ "rounded-lg": D3 }, { "shadow-2xl": j3 }) }))));
};
re2.schema = { name: I2.TextImage, label: "Text Image", playgroundLinkLabel: "View source code on Github", playgroundLinkUrl: "https://github.com/ReactBricks/react-bricks-ui/blob/master/src/website/TextImage/TextImage.tsx", getDefaultProps: function() {
...
}, sideEditProps: [j2({ colors: [c.white, c.light, c.gray, c.darkBlue] }), { groupName: "Text", defaultOpen: true, props: [{ name: "heroTitle", label: "Hero-size Title", type: b.SideEditPropType.Boolean, shouldRefreshText: true }, { name: "mobileTextCenter", label: "Text centered on mobile", type: b.SideEditPropType.Boolean, shouldRefreshText: true }] }, { groupName: "Image", props: [{ name: "multiple", label: "Multiple logos", type: b.SideEditPropType.Boolean }, { name: "imageSide", label: "Image side", type: b.SideEditPropType.Select, selectOptions: { display: b.OptionsDisplay.Radio, options: [{ value: "left", label: "Left" }, { value: "right", label: "Right" }] } }, { name: "mobileImageTop", label: "Image on top on mobile", type: b.SideEditPropType.Boolean }, { name: "mobileIcon", label: "Show as icon on mobile", type: b.SideEditPropType.Boolean, show: function(e2) {
  return !e2.multiple;
} }, { name: "hasShadow", label: "Image shadow", type: b.SideEditPropType.Boolean, show: function(e2) {
  return !e2.multiple;
} }, { name: "isRounded", label: "Image rounded corners", type: b.SideEditPropType.Boolean, show: function(e2) {
  return !e2.multiple;
...
var oe2 = function(e2) {
  var t2 = t(e2, []);
  return c3.createElement("div", r({}, t2), c3.createElement(te, { propName: "imageSource", alt: "logo", containerClassName: "w-16 h-16 lg:w-24 lg:h-24 mx-3 mb-6 p-2 flex justify-center items-center bg-white rounded-full shadow-xl", imageClassName: "w-12 h-12 lg:w-16 lg:h-16" }));
};
...
var le = [Y2, $, X, H3, re2, oe2, ae2, G2, M2, U2, z2, D2, Q, O2, Z, ee, te2, A3, V2];
...
var MyHeroUnit = ({ padding }) => {
  return /* @__PURE__ */ import_react4.default.createElement("div", {
  ...
  }, /* @__PURE__ */ import_react4.default.createElement(te, {
    propName: "icon",
    alt: "Icon",
    maxWidth: 80,
    aspectRatio: 1,
    imageClassName: "w-20 mb-5"
  }), /* @__PURE__ */ import_react4.default.createElement(C, {
    ...
    propName: "title"
  }), /* @__PURE__ */ import_react4.default.createElement(Y, {
    ...
    propName: "text",
    allowedFeatures: [
      b.RichTextFeatures.Bold,
      b.RichTextFeatures.Italic,
      b.RichTextFeatures.Highlight,
      b.RichTextFeatures.Code,
      b.RichTextFeatures.Link
    ],
  ...
  sideEditProps: [
    {
      name: "padding",
      label: "Padding",
      type: b.SideEditPropType.Select,
      selectOptions: {
        display: b.OptionsDisplay.Select,
        options: [
...
var MdwpHeroUnit = ({ background, color, bgColor, paragraphColor, headlineAlignment, paragraphAlignment, fullHeight }) => {
  return /* @__PURE__ */ import_react5.default.createElement("section", {
  ...
  }, /* @__PURE__ */ import_react5.default.createElement(C, {
    ...
    placeholder: "Type a title...",
    propName: "title"
  }), /* @__PURE__ */ import_react5.default.createElement(Y, {
...
MdwpHeroUnit.schema = {
  ...
  sideEditProps: [
    ...
    },
    {
      ...
      type: b.SideEditPropType.Select,
      selectOptions: {
        display: b.OptionsDisplay.Color,
        options: Colors
      }
    },
    {
    ...
    },
    {
      name: "fullHeight",
      label: "Full Height",
      type: b.SideEditPropType.Boolean
    }
  ]
};
...
var pageTypes = [
  {
    ...
    pluralName: "pages",
    defaultLocked: false,
    defaultStatus: b.PageStatus.Published,
    getDefaultContent: () => [],
    excludedBlockTypes: [
      "title",
      "paragraph",
...
var config = {
  ...
  useCssInJs: false,
  appRootElement: "#root",
  clickToEditSide: b.ClickToEditSide.BottomRight,
  customFields: [],
  enableAutoSave: true,
 ...
 * @public
 */
//# sourceMappingURL=/build/root-JGX5E5KA.js.map
