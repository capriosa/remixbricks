...
var require_classList = __commonJS({
  "node_modules/react-modal/lib/helpers/classList.js"(exports) {
    ...
    function removeClass(at2, cls) {
      at2.classList.remove(cls);
    }
    function resetState() {
...
var require_conversions = __commonJS({
  "node_modules/color/node_modules/color-convert/conversions.js"(exports, module) {
    ...
    convert.xyz.rgb = function(xyz) {
      ...
      let g3;
      let b3;
      r3 = x2 * 3.2406 + y3 * -1.5372 + z3 * -0.4986;
      g3 = x2 * -0.9689 + y3 * 1.8758 + z3 * 0.0415;
      b3 = x2 * 0.0557 + y3 * -0.204 + z3 * 1.057;
...
function n(n4) {
  ...
  if (true) {
    var i2 = Y[n4], o2 = i2 ? typeof i2 == "function" ? i2.apply(null, t3) : i2 : "unknown error nr: " + n4;
...
function t(n4) {
  return !!n4 && (function(n5) {
    ...
    return t3 === Object || typeof t3 == "function" && Function.toString.call(t3) === Z2;
  }(n4) || Array.isArray(n4) || !!n4[L] || !!n4.constructor[L] || s(n4) || v2(n4));
}
function i(n4, r3, t3) {
...
function o(n4) {
  var r3 = n4[Q];
  return r3 ? r3.i > 3 ? r3.i - 4 : r3.i : Array.isArray(n4) ? 1 : s(n4) ? 2 : v2(n4) ? 3 : 0;
}
function u(n4, r3) {
...
function P(r3, e2) {
  ...
  return e2.h.g || b2("ES5").S(e2, r3, o2), o2 ? (i2[Q].P && (O(e2), n(4)), t(r3) && (r3 = M(e2, r3), e2.l || x(e2, r3)), e2.u && b2("Patches").M(i2[Q].t, r3, e2.u, e2.s)) : r3 = M(e2, i2, []), O(e2), e2.u && e2.v(e2.u, e2.s), r3 !== H ? r3 : void 0;
}
function M(n4, r3, t3) {
  if (y2(r3))
    return r3;
...
function A2(e2, i2, o2, a2, c2, s2) {
  if (c2 === o2 && n(5), r(c2)) {
    var v3 = M(e2, c2, s2 && i2 && i2.i !== 3 && !u(i2.D, a2) ? s2.concat(a2) : void 0);
    if (f2(o2, a2, v3), !r(v3))
      return;
    e2.m = false;
  }
...
function R2(n4, r3, t3) {
  var e2 = s(r3) ? b2("MapSet").N(r3, t3) : v2(r3) ? b2("MapSet").T(r3, t3) : n4.g ? function(n5, r4) {
...
var en = { get: function(n4, r3) {
  ...
  var i2 = e2[r3];
  return n4.I || !t(i2) ? i2 : i2 === z2(n4.t, r3) ? (E2(n4), n4.o[r3] = R2(n4.A.h, i2, n4)) : i2;
}, has: function(n4, r3) {
  return r3 in p2(n4);
}, ownKeys: function(n4) {
  ...
  if (!n4.P) {
    var i2 = z2(p2(n4), r3), o2 = i2 == null ? void 0 : i2[Q];
    if (o2 && o2.t === t3)
  ...
  return z2(n4.t, r3) !== void 0 || r3 in n4.t ? (n4.D[r3] = false, E2(n4), k2(n4)) : delete n4.D[r3], n4.o && delete n4.o[r3], true;
...
var un = function() {
  function e2(r3) {
    ...
    this.g = B2, this.F = true, this.produce = function(r4, i3, o2) {
      ...
      if (typeof i3 != "function" && n(6), o2 !== void 0 && typeof o2 != "function" && n(7), t(r4)) {
        var c2 = w2(e3), s2 = R2(e3, r4, void 0), v3 = true;
        try {
          f3 = i3(s2), v3 = false;
        } finally {
          v3 ? O(c2) : g2(c2);
      ...
      if (!r4 || typeof r4 != "object") {
        if ((f3 = i3(r4)) === void 0 && (f3 = r4), f3 === H && (f3 = void 0), e3.F && d(f3, true), o2) {
          var p3 = [], l2 = [];
  ...
  return i2.createDraft = function(e3) {
    ...
    var i3 = w2(this), o2 = R2(this, e3, void 0);
...
var Editor = {
  above(editor) {
    ...
    var path = Editor.path(editor, at2);
  ...
  before(editor, at2) {
    ...
    var focus = Editor.point(editor, at2, {
      edge: "start"
    });
    var range = {
      anchor,
  ...
  fragment(editor, at2) {
    var range = Editor.range(editor, at2);
  ...
  isEdge(editor, point, at2) {
    return Editor.isStart(editor, point, at2) || Editor.isEnd(editor, point, at2);
  },
  ...
  leaf(editor, at2) {
    var options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    var path = Editor.path(editor, at2, options);
  ...
  *levels(editor) {
  ...
  next(editor) {
    ...
    if (match == null) {
      if (Path.isPath(at2)) {
        var [parent] = Editor.parent(editor, at2);
  ...
  *nodes(editor) {
    ...
    if (Span.isSpan(at2)) {
      ...
      var first = Editor.path(editor, at2, {
        edge: "start"
      });
      var last = Editor.path(editor, at2, {
        edge: "end"
      });
  ...
  path(editor, at2) {
    ...
    if (Path.isPath(at2)) {
      if (edge === "start") {
        var [, firstPath] = Node.first(editor, at2);
        at2 = firstPath;
      } else if (edge === "end") {
        var [, lastPath] = Node.last(editor, at2);
        at2 = lastPath;
      }
    }
    ...
    for (var [node2, path] of Editor.nodes(editor, {
      ...
      if (Element2.isElement(node2)) {
        ...
        if (Editor.hasInlines(editor, node2)) {
          ...
          var s2 = Path.isAncestor(path, start2.path) ? start2 : Editor.start(editor, path);
...
var NodeTransforms = {
    ...
    Editor.withoutNormalizing(editor, () => {
      ...
      if (Point.isPoint(at2)) {
        ...
        if (entry) {
          ...
          var isAtEnd = Editor.isEnd(editor, at2, _matchPath);
          Transforms.splitNodes(editor, {
            at: at2,
            match,
            mode,
      ...
      if (select) {
        var point = Editor.end(editor, at2);
        if (point) {
  ...
  liftNodes(editor) {
    ...
    Editor.withoutNormalizing(editor, () => {
      ...
      if (match == null) {
        match = Path.isPath(at2) ? matchPath(editor, at2) : (n4) => Editor.isBlock(editor, n4);
      }
      if (!at2) {
        return;
      }
  ...
  setNodes(editor, props) {
    ...
    Editor.withoutNormalizing(editor, () => {
      ...
      if (split && Range.isRange(at2)) {
        ...
        var rangeRef = Editor.rangeRef(editor, at2, {
          affinity: "inward"
        });
        var [start2, end2] = Range.edges(at2);
  ...
  splitNodes(editor) {
    ...
    Editor.withoutNormalizing(editor, () => {
      ...
      var afterRef = Editor.pointRef(editor, at2);
  ...
  unwrapNodes(editor) {
    ...
    Editor.withoutNormalizing(editor, () => {
      ...
      var rangeRef = Range.isRange(at2) ? Editor.rangeRef(editor, at2) : null;
      var matches = Editor.nodes(editor, {
        at: at2,
        match,
        mode,
  ...
  wrapNodes(editor, element) {
    ...
    Editor.withoutNormalizing(editor, () => {
      ...
      for (var [, rootPath] of roots) {
        var a2 = Range.isRange(at2) ? Range.intersection(at2, Editor.range(editor, rootPath)) : at2;
        if (!a2) {
          continue;
        }
...
function index_module_default(e2, i2) {
  ...
  for (var f3 = document.scrollingElement || document.documentElement, s2 = [], p3 = e2; t2(p3) && c2(p3); ) {
    if ((p3 = p3.parentElement) === f3) {
      s2.push(p3);
      break;
    }
    p3 != null && p3 === document.body && n2(p3) && !n2(document.documentElement) || p3 != null && n2(p3, a2) && s2.push(p3);
  }
  for (var m2 = o2.visualViewport ? o2.visualViewport.width : innerWidth, g3 = o2.visualViewport ? o2.visualViewport.height : innerHeight, w3 = window.scrollX || pageXOffset, v3 = window.scrollY || pageYOffset, W2 = e2.getBoundingClientRect(), b3 = W2.height, H2 = W2.width, y3 = W2.top, E3 = W2.right, M2 = W2.bottom, V2 = W2.left, x2 = d2 === "start" || d2 === "nearest" ? y3 : d2 === "end" ? M2 : y3 + b3 / 2, I2 = u2 === "center" ? V2 + H2 / 2 : u2 === "end" ? E3 : V2, C = [], T2 = 0; T2 < s2.length; T2++) {
    var k3 = s2[T2], B3 = k3.getBoundingClientRect(), D2 = B3.height, O2 = B3.width, R3 = B3.top, X3 = B3.right, Y2 = B3.bottom, L2 = B3.left;
    if (l2 === "if-needed" && y3 >= 0 && V2 >= 0 && M2 <= g3 && E3 <= m2 && y3 >= R3 && M2 <= Y2 && V2 >= L2 && E3 <= X3)
      return C;
    var S2 = getComputedStyle(k3), j2 = parseInt(S2.borderLeftWidth, 10), q2 = parseInt(S2.borderTopWidth, 10), z3 = parseInt(S2.borderRightWidth, 10), A3 = parseInt(S2.borderBottomWidth, 10), F2 = 0, G2 = 0, J = "offsetWidth" in k3 ? k3.offsetWidth - k3.clientWidth - j2 - z3 : 0, K2 = "offsetHeight" in k3 ? k3.offsetHeight - k3.clientHeight - q2 - A3 : 0;
    if (f3 === k3)
      F2 = d2 === "start" ? x2 : d2 === "end" ? x2 - g3 : d2 === "nearest" ? r2(v3, v3 + g3, g3, q2, A3, v3 + x2, v3 + x2 + b3, b3) : x2 - g3 / 2, G2 = u2 === "start" ? I2 : u2 === "center" ? I2 - m2 / 2 : u2 === "end" ? I2 - m2 : r2(w3, w3 + m2, m2, j2, z3, w3 + I2, w3 + I2 + H2, H2), F2 = Math.max(0, F2 + v3), G2 = Math.max(0, G2 + w3);
    else {
      F2 = d2 === "start" ? x2 - R3 - q2 : d2 === "end" ? x2 - Y2 + A3 + K2 : d2 === "nearest" ? r2(R3, Y2, D2, q2, A3 + K2, x2, x2 + b3, b3) : x2 - (R3 + D2 / 2) + K2 / 2, G2 = u2 === "start" ? I2 - L2 - j2 : u2 === "center" ? I2 - (L2 + O2 / 2) + J / 2 : u2 === "end" ? I2 - X3 + z3 + J : r2(L2, X3, O2, j2, z3 + J, I2, I2 + H2, H2);
      var N2 = k3.scrollLeft, P2 = k3.scrollTop;
      x2 += P2 - (F2 = Math.max(0, Math.min(P2 + F2, k3.scrollHeight - D2 + K2))), I2 += N2 - (G2 = Math.max(0, Math.min(N2 + G2, k3.scrollWidth - O2 + J)));
    }
    C.push({ el: k3, top: F2, left: G2 });
  }
  return C;
}
  ...
  constructor(editor, restoreDOM) {
    ...
    this.insertText = (insertedText) => {
      ...
      insertedText.forEach((insertion) => {
        ...
        var at2 = normalizeTextInsertionRange(this.editor, selection, insertion);
        Transforms.setSelection(this.editor, at2);
    ...
    onCompositionEnd: (0, import_react.useCallback)((event) => {
      if (hasEditableTarget(editor, event.target) && !isEventHandled(event, attributes.onCompositionEnd)) {
        ...
        setTimeout(() => {
          ...
          insertedText.forEach((insertion) => {
            var text = insertion.text.insertText;
            var at2 = normalizeTextInsertionRange(editor, selection, insertion);
            Transforms.setSelection(editor, at2);
            Editor.insertText(editor, text);
          });
        }, RESOLVE_DELAY);
      }
...
var Toast = function(t3) {
  var n4, e2, o2, i2, a2 = "margin" + ((t3.position || "top-center").includes("bottom") ? "Bottom" : "Top"), r3 = ["ct-toast", t3.onClick ? " ct-cursor-pointer" : "", "ct-toast-" + t3.type].join(" "), c2 = (((e2 = t3.bar) === null || e2 === void 0 ? void 0 : e2.size) || "3px") + " " + (((o2 = t3.bar) === null || o2 === void 0 ? void 0 : o2.style) || "solid") + " " + (((i2 = t3.bar) === null || i2 === void 0 ? void 0 : i2.color) || colors[t3.type]), s2 = Icons[t3.type], l2 = (0, import_react4.useState)(((n4 = { opacity: 0 })[a2] = -15, n4)), d2 = l2[0], u2 = l2[1], f3 = __assign2({ paddingLeft: t3.heading ? 25 : void 0, minHeight: t3.heading ? 50 : void 0, borderLeft: c2 }, d2), p3 = function() {
    var n5;
  ...
  return import_react4.default.createElement("div", __assign2({ className: r3, role: t3.role ? t3.role : "status", style: f3 }, t3.onClick ? g3 : {}), t3.renderIcon ? t3.renderIcon() : import_react4.default.createElement(s2, null), import_react4.default.createElement("div", { className: t3.heading ? "ct-text-group-heading" : "ct-text-group" }, t3.heading && import_react4.default.createElement("h4", { className: "ct-heading" }, t3.heading), import_react4.default.createElement("div", { className: "ct-text" }, t3.text)));
};
...
var Qt = function(e2, t3, n4) {
  ...
  if (r3) {
    ...
    return r3.renderElement({ children: a2.map(function(e3, t4) {
      return me.createElement(me.Fragment, { key: t4 }, r3.renderItemElement({ children: e3 }));
    }), element: { url: e2.url } });
  }
...
var qt = function(e2, t3, n4) {
  ...
  return (r3 = e2.children) === null || r3 === void 0 ? void 0 : r3.map(function(e3, r4) {
    return me.createElement(me.Fragment, { key: r4 }, Qt(e3, t3, n4));
  });
};
var Zt = me.createContext({ isAdmin: false, currentPage: { pageId: "" }, setCurrentPage: function() {
...
var Gt = function(t3) {
  ...
  return t3.normalizeNode = function(r3) {
    var a2 = y(r3, 2), o2 = a2[0], i2 = a2[1];
    return i2.length === 0 && t3.children.length > 1 && Transforms.mergeNodes(t3), n4([o2, i2]);
  }, t3;
};
var _t = [{ type: "paragraph", children: [{ text: "New text" }] }];
var $t = typeof window != "undefined" && /Mac|iPod|iPhone|iPad/.test(window.navigator.platform);
var en2 = function(e2) {
  ...
  if ((c2 == null ? void 0 : c2.rangeCount) === 0)
    return null;
  var s2 = c2 ? c2.getRangeAt(0) : null, d2 = s2 ? s2.getBoundingClientRect() : null;
  if (!d2)
    return null;
  ...
  return h3 = (h3 = h3 < 3 - f3 ? 3 - f3 : h3) + p3 + f3 + 3 > g3 ? g3 - f3 - p3 - 3 : h3, me.createElement("div", null, me.createElement("style", null, "\n.toolbar {\n  display: flex;\n  background-color: #1a202c;\n  overflow: hidden;\n  font-size: 0.875rem;\n  border-radius: 0.25rem;\n}\n\n.toolbar button {\n  font-family: inherit;\n  font-size: 100%;\n  line-height: 1.15;\n  margin: 0;\n  overflow: visible;\n  -webkit-appearance: button;\n  padding: 0;\n  line-height: inherit;\n  color: inherit;\n  cursor: pointer;\n  border: none;\n  background-color: transparent;\n}\n.toolbar button:focus {\n  outline: 1px dotted;\n  outline: 5px auto -webkit-focus-ring-color;\n}\n.toolbar button {\n  padding: 0.75rem;\n}"), me.createElement("div", { className: "toolbar", style: { position: "absolute", zIndex: 100, top: d2.top - u2.top - 42, left: h3 } }, n4.map(function(e3) {
    if (!e3.button)
      return null;
    var r4 = {};
    e3.button.isActive(a2) ? (r4.color = "#f6e05e", r4.backgroundColor = "black") : r4.color = "white";
    var o3 = e3.hotKey ? $t ? e3.hotKey.replace("mod", "cmd") : e3.hotKey.replace("mod", "ctrl") : "";
    return me.createElement(tippy_react_esm_default, { key: e3.name, appendTo: t3.current, content: "".concat(e3.label).concat(e3.hotKey ? " (".concat(o3, ")") : "") }, me.createElement("button", { style: r4, onMouseDown: function(t4) {
      t4.preventDefault(), e3.toggle(a2, n4);
    } }, e3.button.icon));
  })));
};
var tn2 = function(e2) {
  var t3 = e2.renderBlock, r3 = e2.placeholder, a2 = e2.renderPlaceholder, o2 = e2.propName, l2 = e2.plugins, s2 = l2 === void 0 ? [] : l2, u2 = e2.multiline, p3 = u2 === void 0 || u2, g3 = (0, import_react5.useRef)(null), f3 = withHistory(withReact(createEditor()));
  ...
  var h3 = (0, import_react5.useMemo)(function() {
    return f3;
  }, []), b3 = (0, import_react5.useContext)(Zt), v3 = b3.isAdmin, x2 = b3.previewMode, y3 = (0, import_react5.useContext)(k), w3 = y3.values, k3 = y3.onChange, E3 = y3.contentRef, C = x2 || !v3, A3 = w3[o2], N2 = (0, import_react5.useCallback)(function(e3) {
    var t4 = e3.children, n4 = e3.attributes;
    if (!a2)
      return null;
    n4.style;
    var r4 = f(n4, ["style"]);
    return me.cloneElement(a2({ children: t4 }), r4);
  }, [w3]), S2 = (0, import_react5.useCallback)(function(e3) {
    var n4 = e3.element, r4 = e3.children, a3 = e3.attributes, o3 = s2.find(function(e4) {
    ...
    var i2 = s2.find(function(e4) {
      return e4.renderItemElement && n4.type === e4.itemName;
    });
    return i2 && i2.renderItemElement ? i2.renderItemElement({ element: n4, children: r4, attributes: a3 }) : me.cloneElement(t3({ children: r4, attributes: a3, element: n4 }), a3);
  }, [w3]), I2 = (0, import_react5.useCallback)(function(e3) {
    ...
    }), me.createElement("span", m({}, t4), n4);
  }, [w3]);
  if (C) {
    var L2 = A3;
    return A3 ? (typeof A3 == "string" && (L2 = w.deserialize(A3)), me.createElement(me.Fragment, null, L2.map(function(e3, n4) {
      return me.createElement(me.Fragment, { key: n4 }, Qt(e3, s2, t3));
    }))) : null;
  }
  var B3 = A3;
  A3 ? typeof A3 == "string" && (B3 = w.deserialize(A3)) : B3 = w.deserialize("New text");
  var z3 = {};
  return a2 && (z3 = { renderPlaceholder: N2 }), me.createElement("div", { ref: g3, style: { position: "relative" } }, me.createElement(Slate, { editor: h3, value: B3, onChange: function(e3) {
    w3[o2] !== e3 && k3(o2, e3);
  } }, me.createElement(en2, { rtRef: g3, blockRef: E3, plugins: s2 }), me.createElement(Editable, m({ placeholder: r3, renderElement: S2, renderLeaf: I2, readOnly: C, onKeyDown: function(e3) {
    var t4, n4;
    try {
      for (var r4 = v(s2), a3 = r4.next(); !a3.done; a3 = r4.next()) {
        var o3 = a3.value;
        o3.hotKey && (0, import_is_hotkey2.default)(o3.hotKey, e3) && o3.toggle(h3, s2);
      }
    } catch (e4) {
      t4 = { error: e4 };
    } finally {
...
var rn2 = function(e2) {
  ...
  return e2.icon && (t3.button = { isActive: function(t4) {
    return nn2(t4, e2.name);
  }, icon: e2.icon }), t3;
};
var an2 = rn2({ name: "bold", hotKey: "mod+b", render: function(e2) {
  return me.createElement("strong", null, e2.children);
}, icon: me.createElement(FaBold, null) });
var on2 = rn2({ name: "italic", hotKey: "mod+i", render: function(e2) {
  return me.createElement("em", null, e2.children);
}, icon: me.createElement(FaItalic, null) });
var ln2 = rn2({ name: "code", hotKey: "mod+`", render: function(e2) {
  return me.createElement("code", { style: { margin: "0 1px", display: "inline-block", padding: "3px 6px", fontSize: "0.875rem", lineHeight: 1.25, maxWidth: "100%", fontFamily: 'Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', borderRadius: "3px", backgroundColor: "#F5F7F9" } }, e2.children);
}, icon: me.createElement(FaCode, null) });
var cn2 = rn2({ name: "highlight", hotKey: "mod+h", render: function(e2) {
  return me.createElement("mark", { style: { paddingLeft: 4, paddingRight: 4, borderRadius: 2, backgroundColor: "#ff0", color: "#0f0f05" } }, e2.children);
}, icon: me.createElement(FaHighlighter, null) });
var sn2 = /^((((?:\w+:)?\/\/)(\S+))|(mailto:(\S+@)(\S+))|(tel:(\S+)))$/;
var dn2 = /^localhost[\:?\d]*(?:[^\:?\d]\S*)?$/;
var un2 = /^[^\s\.]+\.\S{2,}$/;
var mn = /^((mailto:(\S+@)(\S+))|(tel:(\S+)))$/;
function pn2(e2) {
  if (typeof e2 != "string")
    return false;
  var t3 = e2.match(sn2);
  if (!t3)
    return false;
  var n4 = t3[1];
  return !!n4 && !!(dn2.test(n4) || un2.test(n4) || mn.test(n4));
}
var gn;
var fn4 = function(e2) {
  var t3 = e2.href, n4 = e2.children, r3 = e2.target, a2 = e2.className, o2 = f(e2, ["href", "children", "target", "className"]), i2 = (0, import_react5.useContext)(B).renderLocalLink, l2 = (0, import_react5.useContext)(Zt), s2 = l2.isAdmin, u2 = l2.previewMode, m2 = !s2 || u2, p3 = m2 ? { href: t3 } : {};
  return /^\/(?!\/)/.test(t3) ? i2 && m2 ? i2(m({ href: t3, target: r3, children: n4, className: a2 }, o2)) : (i2 || console.warn("Local path found in Link, but no renderLocalLink function was provided. Rendering <a> as fallback"), me.createElement("a", m({}, p3, { target: r3, className: a2 }, o2), n4)) : me.createElement("a", m({}, p3, { target: r3, className: a2 }, o2), n4);
};
var hn = function(e2, t3) {
  e2.selection && xn(e2, t3);
};
var bn = function(e2) {
...
var yn = { type: "Block", name: "link", label: "Link", isInline: true, renderElement: function(e2) {
  var t3 = e2.attributes, n4 = e2.children, r3 = e2.element;
  return me.createElement(fn4, m({}, t3, { href: r3.url }), n4);
}, toggle: function(e2) {
  if (bn(e2)) {
    var t3 = function(e3) {
    ...
    (n4 = window.prompt("Enter the URL of the link:", (t3 == null ? void 0 : t3.url) || "")) === "" ? vn2(e2) : n4 && hn(e2, n4);
  } else {
    var n4, r3 = function(e3) {
      return e3 && e3.selection ? Editor.string(e3, e3.selection) : "";
    }(e2), a2 = r3 && pn2(r3) ? r3 : "";
    (n4 = window.prompt("Enter the URL of the link:", a2)) && hn(e2, n4);
  }
}, button: { isActive: function(e2) {
  return bn(e2);
}, icon: me.createElement(FaLink, null) }, enhanceEditor: function(e2) {
  var t3 = e2.insertText, n4 = e2.insertData;
  return e2.insertText = function(n5) {
    n5 && pn2(n5) ? xn(e2, n5) : t3(n5);
  }, e2.insertData = function(t4) {
    var r3 = t4.getData("text/plain");
    r3 && pn2(r3) ? xn(e2, r3) : n4(t4);
  }, e2;
} };
var wn = function(e2, t3) {
...
var kn = function(e2) {
  ...
  return e2.icon && (t3.button = { isActive: function(t4) {
    return wn(t4, e2.name);
  }, icon: e2.icon }), t3;
};
var En = kn({ name: "h1", hotKey: "mod+shift+1", render: function(e2) {
  return me.createElement("h1", null, e2.children);
}, icon: me.createElement(MdLooksOne, null) });
var Cn = kn({ name: "h2", hotKey: "mod+shift+2", render: function(e2) {
  return me.createElement("h2", null, e2.children);
}, icon: me.createElement(MdLooksTwo, null) });
var An = kn({ name: "h3", hotKey: "mod+shift+3", render: function(e2) {
  return me.createElement("h3", null, e2.children);
}, icon: me.createElement(MdLooks3, null) });
var Nn = kn({ name: "h4", hotKey: "mod+shift+4", render: function(e2) {
  return me.createElement("h4", null, e2.children);
}, icon: me.createElement(MdLooks4, null) });
var Sn = kn({ name: "h5", hotKey: "mod+shift+5", render: function(e2) {
  return me.createElement("h5", null, e2.children);
}, icon: me.createElement(MdLooks5, null) });
var In = kn({ name: "h6", hotKey: "mod+shift+6", render: function(e2) {
  return me.createElement("h6", null, e2.children);
}, icon: me.createElement(MdLooks6, null) });
var Ln = kn({ name: "quote", render: function(e2) {
  return me.createElement("blockquote", null, e2.children);
}, icon: me.createElement(FaQuoteRight, null) });
var Bn = kn({ name: "ol", label: "Number list", itemName: "li", render: function(e2) {
  return me.createElement("ol", { className: "list-decimal" }, e2.children);
}, renderItem: function(e2) {
  return me.createElement("li", null, e2.children);
}, icon: me.createElement(FaListOl, null) });
var zn = kn({ name: "ul", label: "Bullet list", itemName: "li", render: function(e2) {
  return me.createElement("ul", { className: "list-disc" }, e2.children);
}, renderItem: function(e2) {
  return me.createElement("li", null, e2.children);
}, icon: me.createElement(FaListUl, null) });
var Dn = Object.freeze({ __proto__: null, bold: an2, italic: on2, code: ln2, highlight: cn2, link: yn, heading1: En, heading2: Cn, heading3: An, heading4: Nn, heading5: Sn, heading6: In, quote: Ln, orderedList: Bn, unorderedList: zn });
var Pn = ((gn = {})[E.RichTextFeatures.Bold] = { newPlugin: an2, renderLeaf: "renderBold" }, gn[E.RichTextFeatures.Italic] = { newPlugin: on2, renderLeaf: "renderBold" }, gn[E.RichTextFeatures.Highlight] = { newPlugin: cn2, renderLeaf: "renderHighlight" }, gn[E.RichTextFeatures.Code] = { newPlugin: ln2, renderLeaf: "renderCode" }, gn[E.RichTextFeatures.Link] = { newPlugin: yn, renderLink: "renderLink" }, gn[E.RichTextFeatures.UnorderedList] = { newPlugin: zn, renderElement: "renderUL", renderItemElement: "renderLI" }, gn[E.RichTextFeatures.OrderedList] = { newPlugin: Bn, renderElement: "renderOL", renderItemElement: "renderLI" }, gn[E.RichTextFeatures.Heading1] = { newPlugin: En, renderElement: "renderH1" }, gn[E.RichTextFeatures.Heading2] = { newPlugin: Cn, renderElement: "renderH2" }, gn[E.RichTextFeatures.Heading3] = { newPlugin: An, renderElement: "renderH3" }, gn[E.RichTextFeatures.Heading4] = { newPlugin: Nn, renderElement: "renderH4" }, gn[E.RichTextFeatures.Heading5] = { newPlugin: Sn, renderElement: "renderH5" }, gn[E.RichTextFeatures.Heading6] = { newPlugin: In, renderElement: "renderH6" }, gn[E.RichTextFeatures.Quote] = { newPlugin: Ln, renderElement: "renderQuote" }, gn);
var Tn = function() {
...
var Mn = function(e2) {
  ...
  if (t3 / n4 <= r3 && (c2 = "width"), c2 === "height") {
    var s2 = n4 * r3;
    return { unit: "px", width: s2 / o2, height: n4 / i2, aspect: r3, x: (t3 - s2) / 2 / o2, y: 0 / i2 };
  }
  var d2 = t3 / r3;
  return { unit: "px", width: t3 / o2, height: d2 / i2, aspect: r3, x: 0 / o2, y: (n4 - d2) / 2 / i2 };
};
var Fn = { content: { top: "40px", left: "50%", right: "auto", bottom: "auto", transform: "translateX(-50%)", boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)", padding: 0, border: "none", minWidth: 400 }, overlay: { backgroundColor: "hsla(216, 10%, 60%, 0.7)", zIndex: 100 } };
var On = import_react5.default.forwardRef(function(e2, t3) {
  var n4 = e2.id, r3 = e2.type, a2 = r3 === void 0 ? "text" : r3, o2 = e2.name, i2 = e2.value, l2 = e2.onChange, c2 = e2.checked, s2 = c2 === void 0 ? void 0 : c2, d2 = e2.required, u2 = d2 !== void 0 && d2, m2 = e2.placeholder, p3 = m2 === void 0 ? "" : m2, g3 = e2.autoFocus, f3 = g3 !== void 0 && g3, h3 = e2.className, b3 = e2.style, v3 = e2.textSize, x2 = v3 === void 0 ? "sm" : v3, y3 = e2.radiusSize, w3 = y3 === void 0 ? "md" : y3, k3 = e2.disabled, E3 = k3 !== void 0 && k3;
  return import_react5.default.createElement("input", { ref: t3, id: n4, type: a2, name: o2, value: i2, onChange: l2, checked: s2, required: u2, placeholder: p3, autoFocus: f3, disabled: E3, style: b3, className: (0, import_classnames2.default)("border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50", x2 === "xs" ? "text-xs" : "text-sm", w3 === "full" || a2 === "radio" ? "rounded-full" : a2 === "checkbox" ? "rounded-sm" : "rounded-md", { "block w-full": a2 !== "radio" && a2 !== "checkbox" }, { "mr-2 text-blue-500 focus:ring-offset-0": a2 === "radio" || a2 === "checkbox" }, { "cursor-not-allowed": E3 }, h3) });
});
var Yn = { x: 0, y: 0, width: 0, height: 0, unit: "px" };
function Wn(e2, t3, n4) {
...
function jn(e2, t3, n4) {
  if (!e2.aspect || isNaN(e2.aspect))
    return console.warn("`crop.aspect` should be a number in order to make an aspect crop", e2), m(m({}, Yn), e2);
...
function Xn(e2, t3, n4) {
  return e2.unit === "%" ? m(m({}, Yn), e2) : { unit: "%", aspect: e2.aspect, x: e2.x ? e2.x / t3 * 100 : 0, y: e2.y ? e2.y / n4 * 100 : 0, width: e2.width ? e2.width / t3 * 100 : 0, height: e2.height ? e2.height / n4 * 100 : 0 };
}
function Un(e2, t3, n4) {
  return e2.unit ? e2.unit === "px" ? m(m({}, Yn), e2) : { unit: "px", aspect: e2.aspect, x: e2.x ? e2.x * t3 / 100 : 0, y: e2.y ? e2.y * n4 / 100 : 0, width: e2.width ? e2.width * t3 / 100 : 0, height: e2.height ? e2.height * n4 / 100 : 0 } : m(m(m({}, Yn), e2), { unit: "px" });
}
var Hn;
var Jn = { capture: true, passive: false };
var Kn = function(e2) {
  function t3() {
    var n4 = e2 !== null && e2.apply(this, arguments) || this;
    return n4.keysDown = /* @__PURE__ */ new Set(), n4.docMoveBound = false, n4.mouseDownOnCrop = false, n4.dragStarted = false, n4.evData = { clientStartX: 0, clientStartY: 0, cropStartWidth: 0, cropStartHeight: 0, cropStartX: 0, cropStartY: 0, xDiff: 0, yDiff: 0, xInversed: false, yInversed: false, xCrossOver: false, yCrossOver: false, lastYCrossover: false, startXCrossOver: false, startYCrossOver: false, isResize: true, ord: "nw" }, n4.componentRef = me.createRef(), n4.mediaWrapperRef = me.createRef(), n4.imageRef = me.createRef(), n4.cropSelectRef = me.createRef(), n4.state = { cropIsActive: false, newCropIsBeingDrawn: false }, n4.onCropPointerDown = function(e3) {
      var t4 = n4.props, r3 = t4.crop, a2 = t4.disabled, o2 = n4.mediaDimensions, i2 = Un(r3, o2.width, o2.height);
      if (!a2) {
        e3.cancelable && e3.preventDefault(), n4.bindDocMove(), n4.componentRef.current.focus({ preventScroll: true });
        var l2 = e3.target.dataset.ord, c2 = l2 === "nw" || l2 === "w" || l2 === "sw", s2 = l2 === "nw" || l2 === "n" || l2 === "ne";
        n4.evData = { clientStartX: e3.clientX, clientStartY: e3.clientY, cropStartWidth: i2.width, cropStartHeight: i2.height, cropStartX: c2 ? i2.x + i2.width : i2.x, cropStartY: s2 ? i2.y + i2.height : i2.y, xDiff: 0, yDiff: 0, xInversed: c2, yInversed: s2, xCrossOver: c2, yCrossOver: s2, lastYCrossover: s2, startXCrossOver: c2, startYCrossOver: s2, isResize: Boolean(l2), ord: l2 || "ne" }, n4.mouseDownOnCrop = true, n4.setState({ cropIsActive: true });
      }
    }, n4.onComponentPointerDown = function(e3) {
      var t4 = n4.props, r3 = t4.crop, a2 = t4.disabled, o2 = t4.locked, i2 = t4.keepSelection, l2 = t4.onChange, c2 = t4.zoom, s2 = c2 === void 0 ? 1 : c2, d2 = t4.spin, u2 = d2 === void 0 ? 0 : d2, m2 = n4.mediaWrapperRef.current.firstChild;
      if (e3.target === m2 && m2.contains(e3.target) && !(a2 || o2 || i2 && Vn(r3))) {
        e3.cancelable && e3.preventDefault(), n4.bindDocMove(), n4.componentRef.current.focus({ preventScroll: true });
        var p3 = n4.mediaWrapperRef.current.getBoundingClientRect(), g3 = 0, f3 = 0, h3 = (e3.clientX - p3.left) / s2, b3 = (e3.clientY - p3.top) / s2, v3 = u2, x2 = Math.abs(v3 * Math.PI / 180);
        ...
        var w3 = n4.mediaDimensions, k3 = w3.width, E3 = w3.height;
        l2(Un(y3, k3, E3), Xn(y3, k3, E3)), n4.setState({ cropIsActive: true, newCropIsBeingDrawn: true });
      }
    }, n4.onDocPointerMove = function(e3) {
      var t4 = n4.props, r3 = t4.crop, a2 = t4.disabled, o2 = t4.onChange, i2 = t4.onDragStart, l2 = t4.zoom, c2 = l2 === void 0 ? 1 : l2, s2 = t4.spin, d2 = s2 === void 0 ? 0 : s2;
      ...
      if (!o2) {
        ...
        var c2 = false;
        if (Vn(a2)) {
          var s2 = n4.makeNewCrop(), d2 = (navigator.platform.match("Mac") ? e3.metaKey : e3.ctrlKey) ? t3.nudgeStepLarge : e3.shiftKey ? t3.nudgeStepMedium : t3.nudgeStep;
          if (n4.keysDown.has("ArrowLeft") && (s2.x -= d2, c2 = true), n4.keysDown.has("ArrowRight") && (s2.x += d2, c2 = true), n4.keysDown.has("ArrowUp") && (s2.y -= d2, c2 = true), n4.keysDown.has("ArrowDown") && (s2.y += d2, c2 = true), c2) {
            e3.cancelable && e3.preventDefault();
            var u2 = n4.mediaDimensions, m2 = u2.width, p3 = u2.height;
            s2.x = Wn(s2.x, 0, m2 - s2.width), s2.y = Wn(s2.y, 0, p3 - s2.height);
            var g3 = Un(s2, m2, p3), f3 = Xn(s2, m2, p3);
      ...
      if (n4.unbindDocMove(), !a2 && n4.mouseDownOnCrop) {
        ...
        var l2 = n4.mediaDimensions, c2 = l2.width, s2 = l2.height;
        i2 && i2(e3), o2 && o2(Un(r3, c2, s2), Xn(r3, c2, s2)), n4.setState({ cropIsActive: false, newCropIsBeingDrawn: false });
      }
  ...
  return p(t3, e2), t3.prototype.componentDidMount = function() {
    ...
    if (this.imageRef.current && n4 && e3.crop !== n4 && n4.aspect && (n4.width && !n4.height || !n4.width && n4.height)) {
      var o2 = this.imageRef.current, i2 = o2.width, l2 = o2.height, c2 = jn(this.makeNewCrop(), i2, l2), s2 = Un(c2, i2, l2), d2 = Xn(c2, i2, l2);
      r3(s2, d2), a2 && a2(s2, d2);
    }
  }, t3.prototype.bindDocMove = function() {
    var e3, t4, n4;
    if (!this.docMoveBound) {
      var r3 = document.getElementById("rb-admin-frame");
      (e3 = r3.contentWindow) === null || e3 === void 0 || e3.document.addEventListener("pointermove", this.onDocPointerMove, Jn), (t4 = r3.contentWindow) === null || t4 === void 0 || t4.document.addEventListener("pointerup", this.onDocPointerDone, Jn), (n4 = r3.contentWindow) === null || n4 === void 0 || n4.document.addEventListener("pointercancel", this.onDocPointerDone, Jn), this.docMoveBound = true;
    }
  }, t3.prototype.unbindDocMove = function() {
    var e3, t4, n4;
    if (this.docMoveBound) {
      var r3 = document.getElementById("rb-admin-frame");
      (e3 = r3.contentWindow) === null || e3 === void 0 || e3.document.removeEventListener("pointermove", this.onDocPointerMove, Jn), (t4 = r3.contentWindow) === null || t4 === void 0 || t4.document.removeEventListener("pointerup", this.onDocPointerDone, Jn), (n4 = r3.contentWindow) === null || n4 === void 0 || n4.document.removeEventListener("pointercancel", this.onDocPointerDone, Jn), this.docMoveBound = false;
    }
  }, t3.prototype.createNewCrop = function() {
    var e3 = this.mediaDimensions, t4 = e3.width, n4 = e3.height, r3 = function(e4, t5, n5) {
      return !e4.aspect || e4.width && e4.height ? e4 : jn(e4, t5, n5);
    }(this.makeNewCrop(), t4, n4);
    return { pixelCrop: Un(r3, t4, n4), percentCrop: Xn(r3, t4, n4) };
    ...
    var e3, t4 = this.props, n4 = t4.crop, r3 = t4.minWidth, a2 = r3 === void 0 ? 0 : r3, o2 = t4.maxWidth, i2 = t4.minHeight, l2 = i2 === void 0 ? 0 : i2, c2 = t4.maxHeight, s2 = this.evData, d2 = this.mediaDimensions, u2 = d2.width, m2 = d2.height, p3 = s2.cropStartWidth + s2.xDiff;
    return s2.xCrossOver && (p3 = Math.abs(p3)), p3 = Wn(p3, a2, o2 || u2), e3 = n4.aspect ? p3 / n4.aspect : s2.cropStartHeight + s2.yDiff, s2.yCrossOver && (e3 = Math.min(Math.abs(e3), s2.cropStartY)), e3 = Wn(e3, l2, c2 || m2), n4.aspect && (p3 = Wn(e3 * n4.aspect, 0, u2)), { width: p3, height: e3 };
  }, t3.prototype.dragCrop = function() {
    var e3 = this.makeNewCrop(), t4 = this.evData, n4 = this.mediaDimensions, r3 = n4.width, a2 = n4.height;
    return e3.x = Wn(t4.cropStartX + t4.xDiff, 0, r3 - e3.width), e3.y = Wn(t4.cropStartY + t4.yDiff, 0, a2 - e3.height), e3;
  }, t3.prototype.resizeCrop = function() {
    var e3 = this.evData, n4 = this.props, r3 = n4.crop, a2 = n4.minWidth, o2 = a2 === void 0 ? 0 : a2, i2 = n4.minHeight, l2 = i2 === void 0 ? 0 : i2, c2 = this.makeNewCrop(), s2 = e3.ord;
    ...
    var p3 = this.mediaDimensions, g3 = p3.width, f3 = p3.height, h3 = function(e4, t4, n5, r4) {
      var a3 = Un(t4, n5, r4), o3 = Un(e4, n5, r4);
      if (!a3.aspect)
    ...
    return c2.aspect || t3.xyOrds.indexOf(s2) > -1 ? (c2.x = h3.x, c2.y = h3.y, c2.width = h3.width, c2.height = h3.height) : t3.xOrds.indexOf(s2) > -1 ? (c2.x = h3.x, c2.width = h3.width) : t3.yOrds.indexOf(s2) > -1 && (c2.y = h3.y, c2.height = h3.height), e3.lastYCrossover = e3.yCrossOver, this.crossOverCheck(), c2.width < o2 || c2.height < l2 ? r3 : c2;
    ...
    return me.createElement("div", { style: c2, className: "ReactCrop__crop-selection", onPointerDown: this.onCropPointerDown }, !t4 && !n4 && me.createElement("div", { className: "ReactCrop__drag-elements" }, me.createElement("div", { className: "ReactCrop__drag-bar ord-n", "data-ord": "n" }), me.createElement("div", { className: "ReactCrop__drag-bar ord-e", "data-ord": "e" }), me.createElement("div", { className: "ReactCrop__drag-bar ord-s", "data-ord": "s" }), me.createElement("div", { className: "ReactCrop__drag-bar ord-w", "data-ord": "w" }), me.createElement("div", { className: "ReactCrop__drag-handle ord-nw", "data-ord": "nw", style: this.getRotatedCursor("nw", l2) }), me.createElement("div", { className: "ReactCrop__drag-handle ord-n", "data-ord": "n", style: this.getRotatedCursor("n", l2) }), me.createElement("div", { className: "ReactCrop__drag-handle ord-ne", "data-ord": "ne", style: this.getRotatedCursor("ne", l2) }), me.createElement("div", { className: "ReactCrop__drag-handle ord-e", "data-ord": "e", style: this.getRotatedCursor("e", l2) }), me.createElement("div", { className: "ReactCrop__drag-handle ord-se", "data-ord": "se", style: this.getRotatedCursor("se", l2) }), me.createElement("div", { className: "ReactCrop__drag-handle ord-s", "data-ord": "s", style: this.getRotatedCursor("s", l2) }), me.createElement("div", { className: "ReactCrop__drag-handle ord-sw", "data-ord": "sw", style: this.getRotatedCursor("sw", l2) }), me.createElement("div", { className: "ReactCrop__drag-handle ord-w", "data-ord": "w", style: this.getRotatedCursor("w", l2) })), r3 && Vn(o2) && me.createElement("div", { className: "ReactCrop__selection-addon", onMouseDown: function(e4) {
      return e4.stopPropagation();
    } }, r3(this.state)), a2 && me.createElement(me.Fragment, null, me.createElement("div", { className: "ReactCrop__rule-of-thirds-hz" }), me.createElement("div", { className: "ReactCrop__rule-of-thirds-vt" })));
  }, t3.prototype.makeNewCrop = function(e3) {
    e3 === void 0 && (e3 = "px");
    var t4 = m(m({}, Yn), this.props.crop || {}), n4 = this.mediaDimensions, r3 = n4.width, a2 = n4.height;
    return e3 === "px" ? Un(t4, r3, a2) : Xn(t4, r3, a2);
    ...
    var e3 = this.props, t4 = e3.children, n4 = e3.circularCrop, r3 = e3.className, a2 = e3.crossorigin, o2 = e3.crop, i2 = e3.disabled, l2 = e3.imageStyle, s2 = e3.locked, d2 = e3.imageAlt, u2 = e3.onImageError, m2 = e3.renderComponent, p3 = e3.scale, g3 = p3 === void 0 ? 1 : p3, f3 = e3.src, h3 = e3.style, b3 = e3.rotate, v3 = b3 === void 0 ? 0 : b3, x2 = e3.ruleOfThirds, y3 = this.state, w3 = y3.cropIsActive, k3 = y3.newCropIsBeingDrawn, E3 = Vn(o2) && this.componentRef ? this.createCropSelection() : null, C = (0, import_classnames2.default)("ReactCrop", r3, { "ReactCrop--active": w3, "ReactCrop--disabled": i2, "ReactCrop--locked": s2, "ReactCrop--new-crop": k3, "ReactCrop--fixed-aspect": o2 && o2.aspect, "ReactCrop--circular-crop": o2 && n4, "ReactCrop--rule-of-thirds": o2 && x2, "ReactCrop--invisible-crop": !this.dragStarted && o2 && !o2.width && !o2.height });
    return me.createElement("div", { ref: this.componentRef, className: C, onPointerDown: this.onComponentPointerDown, tabIndex: 0, onKeyDown: this.onComponentKeyDown, onKeyUp: this.onComponentKeyUp }, me.createElement("div", { ref: this.mediaWrapperRef, style: m({ transform: "scale(".concat(g3, ") rotate(").concat(v3, "deg)") }, h3) }, m2 || me.createElement("img", { ref: this.imageRef, crossOrigin: a2, className: "ReactCrop__image", style: l2, src: f3, onLoad: this.onImageLoad, onError: u2, alt: d2 })), t4, E3);
...
var qn = function(t3) {
  var n4, r3 = t3.source, a2 = t3.alt, o2 = t3.maxWidth, i2 = t3.aspectRatio, l2 = t3.onChange, s2 = t3.setModalOpen, u2 = t3.modalOpen, m2 = (0, import_react5.useContext)(Zt).currentPage, p3 = r3 && r3.alt || a2, g3 = y((0, import_react5.useState)(), 2), f3 = g3[0], h3 = g3[1], v3 = Mn({ width: r3 ? r3.width : 0, height: r3 ? r3.height : 0, aspectRatio: i2, ref: f3 }), x2 = y((0, import_react5.useState)(false), 2), y3 = x2[0], w3 = x2[1], k3 = y((0, import_react5.useState)(""), 2), C = k3[0], A3 = k3[1], N2 = y((0, import_react5.useState)(false), 2), S2 = N2[0], I2 = N2[1], L2 = y((0, import_react5.useState)(false), 2), B3 = L2[0], z3 = L2[1], D2 = y((0, import_react5.useState)({ imageUrl: r3 ? r3.src : "", alt: r3 ? r3.alt : a2, seoName: r3 ? r3.seoName : "", crop: v3 }), 2), P2 = D2[0], T2 = D2[1], R3 = Rn(), M2 = function(e2) {
    T2(m(m({}, P2), e2));
  }, F2 = useDropzone({ accept: "image/*", maxSize: 3145728, onDropAccepted: function(e2) {
    var t4;
    I2(((t4 = e2[0]) === null || t4 === void 0 ? void 0 : t4.type) === "image/svg+xml"), A3("");
    var n5 = new FileReader();
    n5.addEventListener("load", function() {
      M2({ imageUrl: n5.result, image: e2[0] }), z3(true);
  ...
  } }), O2 = F2.getRootProps, Y2 = F2.getInputProps;
  (0, import_react5.useEffect)(function() {
    M2({ crop: Mn({ width: (f3 == null ? void 0 : f3.naturalWidth) || (r3 ? r3.width : 0), height: (f3 == null ? void 0 : f3.naturalHeight) || (r3 ? r3.height : 0), aspectRatio: i2, ref: f3 }) });
  }, [r3, f3]);
...
var Zn = function(t3) {
  var n4 = t3.source, r3 = t3.alt, a2 = t3.maxWidth, o2 = t3.aspectRatio, i2 = t3.onChange, l2 = t3.containerClassName, s2 = t3.containerStyle, d2 = s2 === void 0 ? {} : s2, u2 = t3.imageClassName, m2 = t3.imageStyle, p3 = m2 === void 0 ? {} : m2, g3 = t3.noWrapper, f3 = g3 !== void 0 && g3, h3 = n4 && n4.alt || r3, b3 = y((0, import_react5.useState)(false), 2), v3 = b3[0], x2 = b3[1];
  return f3 ? import_react5.default.createElement(import_react5.default.Fragment, null, (n4 == null ? void 0 : n4.src) ? import_react5.default.createElement("img", { src: n4.src, alt: h3, onClick: function() {
    return x2(true);
  }, className: u2, style: m({ cursor: "pointer" }, p3) }) : import_react5.default.createElement(Qn, { onClick: function() {
    return x2(true);
  }, className: u2, style: m({ cursor: "pointer" }, p3) }), v3 && import_react5.default.createElement(qn, { source: n4, alt: r3, maxWidth: a2, aspectRatio: o2, onChange: i2, setModalOpen: x2, modalOpen: v3 })) : import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement("div", { className: (0, import_classnames2.default)("react-bricks-image", l2), onClick: function() {
    return x2(true);
  }, style: m({ cursor: "pointer" }, d2) }, (n4 == null ? void 0 : n4.src) ? import_react5.default.createElement("img", { src: n4.src, alt: h3, className: (0, import_classnames2.default)("cursor-pointer", u2), style: p3 }) : import_react5.default.createElement(Qn, { className: (0, import_classnames2.default)("cursor-pointer", u2), style: m({ aspectRatio: o2 + "" }, p3) })), v3 && import_react5.default.createElement(qn, { source: n4, alt: r3, maxWidth: a2, aspectRatio: o2, onChange: i2, setModalOpen: x2, modalOpen: v3 }));
};
var Gn = require_dist().default;
var _n = function(e2, t3) {
  if (!t3)
    return e2;
...
var $n = function(t3) {
  t3.propName;
  var n4 = t3.source, r3 = t3.alt, a2 = t3.noLazyLoad, o2 = a2 !== void 0 && a2, i2 = t3.containerClassName, l2 = t3.containerStyle, s2 = l2 === void 0 ? {} : l2, u2 = t3.imageClassName, m2 = t3.imageStyle, p3 = m2 === void 0 ? {} : m2, g3 = f(t3, ["propName", "source", "alt", "noLazyLoad", "containerClassName", "containerStyle", "imageClassName", "imageStyle"]), f3 = (n4 == null ? void 0 : n4.alt) || r3;
  if (!n4)
    return null;
  var h3, b3, v3 = _n(n4.src, n4.seoName), x2 = _n(n4.placeholderSrc || "", n4.seoName), y3 = (h3 = n4.srcSet, b3 = n4.seoName, h3 ? b3 ? h3.split(",").map(function(t4) {
    var n5 = y(t4.trim().split(" "), 2), r4 = n5[0], a3 = n5[1];
    return r4 && a3 ? "".concat(_n(r4, b3), " ").concat(a3) : _n(t4, b3);
  }).join(", ") : h3 : "");
  return o2 ? me.createElement("div", { className: i2, style: s2 }, me.createElement("img", m({ src: v3, srcSet: y3, alt: f3, className: u2, style: s2 }, g3))) : me.createElement("div", { className: i2, style: s2 }, me.createElement(Gn, { src: v3, srcSetData: { srcSet: y3 }, placeholder: "" }, function(e2, t4, n5) {
    return t4 ? me.createElement("img", { src: x2, alt: f3, className: u2, style: m({ filter: "blur(8px)" }, p3) }) : me.createElement("img", m({ src: e2, srcSet: n5.srcSet, alt: f3, className: u2, style: p3 }, g3));
  }));
};
var er = function(t3) {
  var n4, r3 = t3.setModalOpen, a2 = t3.file, o2 = t3.modalOpen, i2 = t3.onChange, l2 = t3.allowedExtensions, s2 = (0, import_react5.useContext)(Zt).currentPage, d2 = y((0, import_react5.useState)({ name: a2 ? a2.name : "", size: a2 ? a2.size : 0, url: a2 ? a2.url : "" }), 2), u2 = d2[0], m2 = d2[1], p3 = y((0, import_react5.useState)(!!(a2 == null ? void 0 : a2.size)), 2), g3 = p3[0], f3 = p3[1], h3 = {};
  l2 && l2.length > 0 && (h3 = { accept: l2 });
  var v3 = useDropzone(m(m({}, h3), { onDropRejected: function(e2) {
    e2[0].errors.map(function(e3) {
      var t4 = e3.message;
      throw new Error(t4);
    });
  }, onDropAccepted: function(e2) {
    f3(true), m2(m(m({}, u2), { file: e2[0], name: "", size: e2[0].size / 1e3 }));
  } })), x2 = v3.getRootProps, y3 = v3.getInputProps, w3 = useMutation(function(e2) {
    return g(void 0, void 0, void 0, function() {
      return h(this, function(t4) {
        switch (t4.label) {
          case 0:
  ...
  return import_react5.default.createElement(import_react_modal.default, { isOpen: o2, style: Fn, onRequestClose: function() {
    return r3(false);
  ...
  } }, "Remove file"))) : import_react5.default.createElement("div", m({ className: "form-field dropzone" }, x2()), "Click or Drag & Drop to upload a file", import_react5.default.createElement("input", m({}, y3()))), import_react5.default.createElement("div", { className: "form-field" }, import_react5.default.createElement("label", null, "File Name"), import_react5.default.createElement(On, { name: "name", value: u2 == null ? void 0 : u2.name, onChange: function(e2) {
    return m2(m(m({}, u2), { name: e2.target.value }));
    ...
    return g(void 0, void 0, void 0, function() {
      var e3, t4;
      return h(this, function(n5) {
        switch (n5.label) {
          case 0:
            return e3 = new FormData(), u2.file && e3.append("file", u2.file), s2 && s2.pageId.indexOf("playground") === -1 && e3.append("pageId", s2.pageId), u2.name && e3.append("name", u2.name), u2.file ? [3, 1] : (u2.size === 0 ? i2(null) : i2(m({}, u2)), [3, 3]);
          case 1:
            return [4, w3.mutateAsync(e3)];
          case 2:
            t4 = n5.sent(), i2(m(m({}, a2), { name: t4.name, size: t4.size, url: t4.url })), n5.label = 3;
          case 3:
            return r3(false), [2];
        }
      });
...
var ar = function(t3, n4) {
  return n4.getDefaultContent ? n4.getDefaultContent().reduce(function(n5, r3) {
    ...
    return o2 ? b(b([], y(n5), false), [{ id: v4_default(), type: r3, props: o2 }], false) : n5;
  }, []) : [];
};
var or = function() {
...
var lr = function(e2, t3) {
  return e2 ? e2.filter(function(e3) {
    return e3.type === t3;
  }) : [];
};
var cr = function() {
  var t3 = (0, import_react5.useContext)(B), n4 = t3.pageTypes, r3 = t3.bricks, a2 = (0, import_react5.useContext)(Zt), o2 = a2.currentPage, i2 = a2.setCurrentPage, l2 = a2.previewMode, s2 = a2.sidebarCollapsed, d2 = we(), u2 = d2.data, m2 = d2.error, p3 = d2.isLoading, h3 = d2.isFetching, v3 = function() {
    ...
    }, onError: nr({ topic: "page", getLimitExceededError: function(e3, t4) {
  ...
  }(), x2 = y((0, import_react5.useState)(""), 2), y3 = x2[0], w3 = x2[1], k3 = y((0, import_react5.useState)(""), 2), C = k3[0], A3 = k3[1], N2 = y((0, import_react5.useState)([]), 2), S2 = N2[0], I2 = N2[1], L2 = y((0, import_react5.useState)(""), 2), z3 = L2[0], D2 = L2[1];
  (0, import_react5.useEffect)(function() {
    var e2 = n4.map(function(e3, t4) {
      return m(m({}, e3), { isOpen: !t4 });
    });
    I2(e2);
  }, [n4]);
  var P2 = function() {
    ...
    return g(void 0, void 0, void 0, function() {
      var t4, a3, o3;
      return h(this, function(l3) {
        switch (l3.label) {
          case 0:
            return e2.preventDefault(), (t4 = n4.find(function(e3) {
              return e3.name === y3;
            })) && C ? (a3 = { id: v4_default(), type: y3, name: C, status: t4.defaultStatus || E.PageStatus.Draft, isLocked: !!t4.defaultLocked, content: ar(r3, t4) }, [4, v3.mutateAsync(a3)]) : [3, 2];
          case 1:
  ...
  return m2 ? null : me.createElement("div", { style: { width: l2 || s2 ? 0 : 192, transition: "width 300ms" } }, !l2 && !s2 && me.createElement("div", { className: "fixed top-0 pt-10 pb-12 w-48 h-full overflow-y-auto scrolling-touch" }, me.createElement("nav", { className: "overflow-y-auto" }, me.createElement("div", { className: "relative px-2 mt-4 mb-4" }, me.createElement(On, { value: z3, onChange: function(e2) {
    D2(e2.target.value);
  }, className: "py-2 pr-5 pl-3", textSize: "xs", radiusSize: "full", placeholder: "Search page" }), me.createElement(FiSearch, { className: "absolute text-gray-400", style: { top: 8, right: 15 } })), S2.map(function(e2, t4) {
    return me.createElement("div", { className: "mb-3", key: e2.name }, me.createElement("div", { className: "flex flex-row justify-between items-center pl-2 border-b border-gray-300 pb-1 mb-2" }, me.createElement("h3", { className: "flex items-center text-xs cursor-pointer leading-none font-semibold uppercase tracking-widest text-gray-500", onClick: (r4 = e2.name, function() {
      I2(S2.map(function(e3) {
        return e3.name === r4 ? m(m({}, e3), { isOpen: !e3.isOpen }) : e3;
      }));
    }) }, R3(e2) ? me.createElement(FiChevronDown, { className: "text-sm mr-1" }) : me.createElement(FiChevronRight, { className: "text-sm mr-1" }), e2.pluralName, u2 && lr(u2, e2.name).length > 0 && me.createElement("div", { className: "ml-2 rounded-full bg-gray-200 flex justify-center items-center border border-gray-300", style: { fontSize: 9, width: 15, height: 15, flexShrink: 0 } }, lr(u2, e2.name).length)), p3 || h3 ? me.createElement("div", { className: "px-2 w-8 text-pink-500" }, me.createElement(ir, null)) : me.createElement(tippy_react_esm_default, { content: "Add new ".concat(e2.name) }, me.createElement("button", { type: "button", onClick: (n5 = e2.name, function() {
      w3(n5), A3("");
    }), title: "Add new ".concat(e2.name), className: "text-gray-700 hover:text-black px-2" }, me.createElement(VscNewFile, { className: "text-base" })))), R3(e2) && u2 && u2.length < 3 && y3 !== e2.name && t4 === 0 && me.createElement(or, null), y3 === e2.name && me.createElement("form", { onSubmit: T2, className: "flex flex-row justify-between items-center px-2 mb-3" }, me.createElement(On, { autoFocus: true, className: "h-6", textSize: "xs", style: { width: 132 }, value: C, onChange: function(e3) {
      return A3(e3.target.value);
    } }), me.createElement("div", { className: "mx-1" }, me.createElement("button", { type: "submit", className: "text-sm text-green-500 hover:text-green-600 mr-1" }, me.createElement(FiCheck, null)), me.createElement("button", { type: "button", onClick: P2, className: "text-sm text-gray-400 hover:text-red-500" }, me.createElement(FiX, null)))), me.createElement("ul", null, u2 && R3(e2) && lr(u2, e2.name).filter(function(e3) {
      return e3.name.toLowerCase().indexOf(z3.toLowerCase()) > -1;
    }).map(function(e3) {
      return me.createElement("li", { key: e3.id, onClick: function() {
        return i2({ pageId: e3.id });
      }, style: e3.id === o2.pageId ? { boxShadow: "0 0 5px rgba(74,85,104,0.08)" } : {}, className: (0, import_classnames2.default)("text-sm px-2 py-1 flex flex-row justify-between items-center cursor-pointer", e3.id === o2.pageId ? "bg-white border-t border-b border-gray-300 font-semibold text-black hover:text-black" : e3.status === E.PageStatus.Draft ? "hover:bg-white text-gray-400 hover:text-gray-900" : "hover:bg-white text-gray-700 hover:text-gray-900") }, me.createElement("div", { className: "flex flex-row justify-start items-center flex-1" }, me.createElement("div", { className: "mr-2" }, e3.isLocked ? me.createElement(FiLock, { className: "text-pink-400" }) : me.createElement(FiUnlock, { className: "text-gray-400" })), me.createElement("div", null, e3.name)), e3.status === E.PageStatus.Draft && me.createElement(FiEyeOff, { className: "text-gray-400 ml-2" }));
    })));
    var n5, r4;
  }))), me.createElement("div", { className: "fixed bg-gray-100 bottom-0 left-0 py-1 pl-2 text-xs flex flex-row justify-start items-center", style: { width: 180 } }, me.createElement("div", { className: "w-24" }, me.createElement(rr, null)), me.createElement("div", { className: "font-bold italic text-blue-500" }, "v3")));
};
var sr = function(e2, t3, n4) {
  if (typeof e2 != "function")
    return true;
  var r3 = e2(t3, n4);
  return !(!r3 || typeof r3 == "string");
};
var dr = function(e2, t3) {
  return !t3.schema.sideEditProps || t3.schema.sideEditProps.reduce(function(t4, n4) {
    return n4.groupName ? t4 && (r3 = e2.props, !(a2 = n4.props) || a2.reduce(function(e3, t5) {
      return e3 && sr(t5.validate, r3[t5.name], r3);
    }, true)) : t4 && sr(n4.validate, e2.props[n4.name], e2.props);
    var r3, a2;
  }, true);
};
var ur = function(e2, t3, n4) {
...
var mr = function(e2) {
  var t3, n4 = e2.onClick, r3 = e2.type, a2 = r3 === void 0 ? Hn.Default : r3, o2 = e2.active, i2 = o2 !== void 0 && o2, l2 = e2.tooltip, c2 = l2 === void 0 ? "" : l2, s2 = e2.className, d2 = s2 === void 0 ? "" : s2, u2 = e2.children, m2 = import_react5.default.createElement("button", { className: (0, import_classnames2.default)("focus:outline-none text-sm leading-none", { "block p-2 hover:text-gray-900 hover:bg-white border border-transparent hover:border-gray-300 rounded transition-colors duration-150": a2 === Hn.Default }, { "text-gray-600": a2 === Hn.Default && !i2 }, { "text-gray-900 bg-white border-gray-300": a2 === Hn.Default && i2 }, (t3 = {}, t3[d2] = !!d2, t3)), onClick: n4 }, u2);
  return c2 ? import_react5.default.createElement(tippy_react_esm_default, { content: c2 }, m2) : m2;
};
var pr = typeof window != "undefined" && /Mac|iPod|iPhone|iPad/.test(window.navigator.platform);
var gr = function(e2) {
  var t3 = e2.page, n4 = e2.sidebarOpen, r3 = e2.setSidebarOpen, a2 = e2.devicePreview, o2 = e2.setDevicePreview, i2 = e2.handleSave, l2 = e2.saveStatus, c2 = e2.isPlayground, s2 = c2 !== void 0 && c2, d2 = e2.autoSave, u2 = e2.setAutoSave, m2 = (0, import_react5.useContext)(B), p3 = m2.bricks, h3 = m2.isDarkColorMode, v3 = m2.toggleColorMode, x2 = m2.responsiveBreakpoints, y3 = m2.enableAutoSave, w3 = m2.disableSaveIfInvalidProps, k3 = m2.enablePreview, C = m2.editorPath, A3 = m2.previewPath, N2 = (0, import_react5.useContext)(Zt), S2 = N2.previewMode, I2 = N2.setPreviewMode, L2 = N2.sidebarCollapsed, B3 = N2.setSidebarCollapsed, z3 = function(e3, t4) {
    return t4 === void 0 && (t4 = 432e4), useMutation(function(e4) {
      ...
      (0, import_copy_to_clipboard.default)("".concat(e3, "?p=").concat(encodeURIComponent(t5.token))), index_es_default.success("Link copied to clipboard. It will expire in ".concat(72, " hours."), { position: "bottom-right", hideAfter: 4 });
    }, onError: function() {
      index_es_default.error("An error occurred while generating a preview token", { position: "top-center" });
    } });
  }(window.location.href.replace(C, A3)), D2 = t3.content.reduce(function(e3, t4) {
    var n5 = p3[t4.type];
    return n5 ? e3 && dr(t4, n5) && ur(t4, n5, p3) : e3;
  }, true);
  return S2 ? me.createElement("div", { className: "fixed z-20 py-2 flex flex-row justify-center items-center bg-gray-100", style: { top: 40, left: 0, right: 0 } }, me.createElement(mr, { className: "flex", onClick: function() {
    return I2(false);
  } }, me.createElement(FiMinimize2, { className: "mr-1" }), "Exit preview")) : me.createElement("div", { className: "fixed z-20 bg-gray-100", style: { top: 40, left: L2 ? 0 : 192, right: 0, transition: "all 300ms" } }, me.createElement("div", { className: "w-full flex flex-row items-center pt-2 pb-1" }, me.createElement("div", { className: "flex flex-1 justify-between" }, me.createElement("div", { className: "flex flex-row justify-start items-center min-w-0" }, me.createElement(mr, { onClick: function() {
    B3(!L2);
  }, tooltip: L2 ? "Open men\xF9" : "Close men\xF9", className: "mr-2" }, me.createElement(FiMenu, null)), me.createElement("h2", { className: "text-lg font-semibold text-gray-900 truncate mr-2 capitalize" }, t3.name), !s2 && me.createElement(me.Fragment, null, me.createElement("div", { className: "mr-2" }, t3.status === E.PageStatus.Published ? me.createElement("div", { className: "flex text-xs font-semibold leading-none py-1 px-2 rounded bg-green-200 text-green-800" }, me.createElement(FiEye, { className: "mr-1" }), "Published") : me.createElement("div", { className: "flex text-xs font-semibold leading-none py-1 px-2 rounded bg-gray-300 text-gray-700" }, me.createElement(FiEyeOff, { className: "mr-1" }), "Draft")), me.createElement("div", { className: "mr-2" }, t3.isLocked === true ? me.createElement("div", { className: "flex text-xs font-semibold leading-none py-1 px-2 rounded bg-pink-200 text-pink-700" }, me.createElement(FiLock, { className: "mr-1" }), "Locked") : me.createElement("div", { className: "flex text-xs font-semibold leading-none py-1 px-2 rounded bg-gray-300 text-gray-700" }, me.createElement(FiUnlock, { className: "mr-1" }), "Unlocked")))), me.createElement("div", { className: "flex items-center" }, v3 && me.createElement(mr, { onClick: v3, tooltip: "".concat(h3 ? "Light" : "Dark", " color mode"), className: "mr-1", active: h3 }, me.createElement(FiMoon, null)), x2.map(function(e3) {
    return me.createElement(mr, { key: e3.width, onClick: function() {
      return o2(e3);
    }, tooltip: e3.label, active: a2.width === e3.width, className: "mr-1" }, e3.type === E.DeviceType.Desktop ? me.createElement(MdDesktopMac, null) : e3.type === E.DeviceType.Tablet ? me.createElement(MdTabletMac, null) : me.createElement(MdSmartphone, null));
  }), k3 && me.createElement(mr, { onClick: function() {
    return z3.mutate({ pageId: t3.id, language: t3.language });
  }, tooltip: "Get preview link" }, me.createElement(FiShare2, null)), me.createElement(mr, { onClick: function() {
    return I2(true);
  }, tooltip: "Full-screen preview" }, me.createElement(FiMaximize2, null)))), me.createElement("div", { className: "flex flex-row justify-end items-center px-3 space-x-4", style: { width: 275 } }, !s2 && me.createElement(me.Fragment, null, y3 && me.createElement("div", null, me.createElement(es_default2, { checked: d2, onChange: function(e3) {
    return u2(e3);
  } }), me.createElement("span", { className: (0, import_classnames2.default)("text-xs ml-1", d2 ? "text-green-500 font-semibold" : "text-gray-600") }, "Autosave")), me.createElement(tippy_react_esm_default, { content: D2 ? "Save (".concat(pr ? "cmd" : "ctrl", "+s)") : "Warning: at least one block has validation errors" }, me.createElement("div", null, me.createElement("button", { className: "px-6 py-2 bg-blue-500 hover:bg-blue-600 hover:shadow-lg text-sm leading-none text-white font-semibold rounded disabled:opacity-75 disabled:cursor-not-allowed", onClick: i2, disabled: w3 && !D2 || l2 === "loading" }, "Save")))), me.createElement(mr, { onClick: function() {
    return r3(!n4);
  }, active: n4, tooltip: n4 ? "Close sidebar" : "Open sidebar" }, me.createElement(FiSettings, null)))));
};
var fr = function(t3) {
  var n4 = t3.children, r3 = t3.styles, a2 = t3.stylesheets, o2 = t3.head, i2 = f(t3, ["children", "styles", "stylesheets", "head"]), l2 = y((0, import_react5.useState)(null), 2), s2 = l2[0], u2 = l2[1], m2 = y((0, import_react5.useState)(null), 2), p3 = m2[0], g3 = m2[1], f3 = y((0, import_react5.useState)(false), 2), h3 = f3[0], b3 = f3[1], v3 = (0, import_react5.useRef)(null);
  (0, import_react5.useEffect)(function() {
    if (h3) {
  ...
  return import_react5.default.createElement("iframe", m({ ref: v3, srcDoc: "<!DOCTYPE html>", title: "content" }, i2, { onLoad: function(e2) {
    e2.defaultPrevented || e2.target.contentDocument && b3(true);
  } }), s2 && import_react_dom4.default.createPortal(o2, s2), p3 && import_react_dom4.default.createPortal(n4, p3));
};
var hr = function(t3) {
  var r3 = t3.contentLength, o2 = t3.contentRef, i2 = t3.block, l2 = t3.index, s2 = t3.locked, d2 = t3.setAddAfterBlockId, u2 = t3.handleChange, m2 = t3.handleAddBlockAfter, p3 = t3.handleAddBlockBefore, h3 = t3.handleRemoveBlock, b3 = t3.handleSort, v3 = t3.handleAddItem, x2 = t3.handleDuplicate, y3 = (0, import_react5.useContext)(B).bricks, w3 = (0, import_react5.useContext)(Zt).previewMode, k3 = (0, import_react5.useContext)(T), E3 = k3.focused, C = k3.setFocused, A3 = y(fe(), 1)[0], N2 = function(e2) {
    var t4 = y3[e2.type];
    if (t4) {
      var r4 = e2.props;
      return t4.schema.mapExternalDataToProps && typeof t4.schema.mapExternalDataToProps == "function" && A3.externalData && typeof A3.externalData == "object" && (r4 = t4.schema.mapExternalDataToProps(A3.externalData, e2.props)), me.createElement(k.Provider, { value: { values: r4, onChange: u2(e2.id), blockId: e2.id, parentId: e2.id, parentType: e2.type, contentRef: o2, handleChange: u2, handleAddItem: v3 } }, me.createElement(t4, m({}, r4)));
    }
  }, S2 = {};
  if (i2.id !== E3.blockId || w3 || (S2.border = "2px solid #f65a8e", S2.minHeight = "65px"), i2.id === "PREVIEW_NEW")
    return me.createElement("div", null, N2(i2));
  var I2 = { position: "relative", boxSizing: "border-box", display: "flex", flexDirection: "column", alignItems: "stretch" };
  return i2.id !== E3.blockId || w3 || s2 || (I2.minHeight = "30px"), me.createElement("div", { key: i2.id, style: I2 }, i2.id === E3.blockId && !w3 && !s2 && me.createElement(tippy_react_esm_default, { content: "Add new block before", appendTo: o2.current }, me.createElement("button", { onClick: p3(i2.id), className: "rb-action", tabIndex: -1, style: { top: -11, zIndex: 999, position: "absolute", left: "calc(50% - 12px)" } }, me.createElement(FiPlus, null))), me.createElement("div", { style: m({}, S2), onClick: function() {
    C({ blockId: i2.id, itemId: "", repeaterPropName: "" }), d2("");
  }, onFocus: function() {
    return setTimeout(function() {
      C({ blockId: i2.id, itemId: "", repeaterPropName: "" }), d2("");
    }, 0);
  } }, N2(i2)), i2.id === E3.blockId && !w3 && !s2 && me.createElement(me.Fragment, null, me.createElement(tippy_react_esm_default, { content: "Add new block after", appendTo: o2.current }, me.createElement("button", { onClick: m2(i2.id), className: "rb-action", tabIndex: -1, style: { bottom: -11, zIndex: 999, position: "absolute", left: "calc(50% - 12px)" } }, me.createElement(FiPlus, null))), me.createElement("div", { style: { zIndex: 999, position: "absolute", right: 6, top: 6 } }, me.createElement(tippy_react_esm_default, { content: "Remove block", appendTo: o2.current }, me.createElement("button", { className: "rb-action", onClick: h3(i2.id), tabIndex: -1 }, me.createElement(AiOutlineDelete, null)))), me.createElement("div", { style: { zIndex: 999, position: "absolute", right: 6, bottom: 6 } }, me.createElement(tippy_react_esm_default, { content: "Duplicate block", appendTo: o2.current }, me.createElement("button", { className: "rb-action", onClick: x2(i2.id), tabIndex: -1 }, me.createElement(FiCopy, null)))), me.createElement("div", { style: { zIndex: 999, position: "absolute", left: 6, top: 6, display: "flex", flexDirection: "column" } }, me.createElement(tippy_react_esm_default, { content: "Move block up", appendTo: o2.current }, me.createElement("button", { disabled: l2 === 0, onClick: b3(i2.id, E.SortDirection.Up), className: (0, import_classnames2.default)("rb-action", { disabled: l2 === 0 }), tabIndex: -1, style: { marginBottom: 4 } }, me.createElement(FiChevronUp, null))), me.createElement(tippy_react_esm_default, { content: "Move block down", appendTo: o2.current, placement: "bottom" }, me.createElement("button", { disabled: l2 === r3 - 1, onClick: b3(i2.id, E.SortDirection.Down), className: (0, import_classnames2.default)("rb-action", { disabled: l2 === r3 - 1 }), tabIndex: -1 }, me.createElement(FiChevronDown, null))))));
};
var br = function(e2) {
  var t3 = e2.previewNewBlock;
  return me.createElement("div", { style: { border: "2px solid #f65a8e" } }, me.createElement("div", { style: { color: "#b43179", letterSpacing: "0.05em", paddingTop: "1rem", paddingBottom: "1rem", textAlign: "center" } }, "NEW BLOCK HERE: SELECT ON THE RIGHT \xBB"), t3 && me.createElement(hr, { contentLength: 0, block: t3, index: 1, locked: true, setAddAfterBlockId: function() {
...
var vr = function(e2) {
  var t3 = e2.pageTypeName, n4 = (0, import_react5.useContext)(B), r3 = n4.bricks, a2 = n4.pageTypes;
  if (!t3)
    return null;
  ...
  var i2 = Object.keys(r3).filter(function(e3) {
    return !r3[e3].schema.hideFromAddMenu && ke(e3, o2.allowedBlockTypes, o2.excludedBlockTypes);
  }).map(function(e3) {
  ...
  return me.createElement("div", { className: "p-3" }, me.createElement("h3", { className: "text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Default status"), me.createElement("div", { className: "flex flex-row mb-5" }, me.createElement("div", { className: "flex-1 flex items-center py-1 px-3 bg-gray-500 text-white text-xs uppercase leading-none rounded mr-2 mb-1" }, o2.defaultStatus), me.createElement("div", { className: "flex-1 flex items-center py-1 px-3 bg-gray-500 text-white text-xs uppercase leading-none rounded mr-2 mb-1" }, o2.defaultLocked ? "LOCKED" : "UNLOCKED")), i2.length > 0 && me.createElement(me.Fragment, null, me.createElement("h3", { className: "text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Allowed blocks"), me.createElement("div", { className: "flex flex-row flex-wrap mb-5" }, i2.map(function(e3) {
    return me.createElement("div", { key: e3, className: "flex items-center py-1 px-3 bg-gray-500 text-white text-xs uppercase leading-none rounded mr-2 mb-1" }, e3);
  }))), l2.length > 0 && me.createElement(me.Fragment, null, me.createElement("h3", { className: "text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Blocks excluded"), me.createElement("div", { className: "flex flex-row flex-wrap" }, l2.map(function(e3) {
    return me.createElement("div", { key: e3, className: "flex items-center py-1 px-3 bg-gray-500 text-white text-xs uppercase leading-none rounded mr-2 mb-1" }, e3);
  }))));
};
var xr = function(e2) {
  var t3 = e2.blockTypeName, n4 = (0, import_react5.useContext)(B).pageTypes;
  if (!t3)
    return null;
  var r3 = n4.filter(function(e3) {
    return ke(t3, e3.allowedBlockTypes, e3.excludedBlockTypes);
  }).map(function(e3) {
    return e3.name;
  ...
  return me.createElement("div", { className: "p-3" }, r3.length > 0 && me.createElement(me.Fragment, null, me.createElement("h3", { className: "text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Allowed in"), me.createElement("div", { className: "flex flex-row flex-wrap mb-5" }, r3.map(function(e3) {
    return me.createElement("div", { key: e3, className: "flex items-center py-1 px-3 bg-gray-500 text-white text-xs uppercase leading-none rounded mr-2 mb-1" }, e3);
  }))), a2.length > 0 && me.createElement(me.Fragment, null, me.createElement("h3", { className: "text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Excluded from"), me.createElement("div", { className: "flex flex-row flex-wrap" }, a2.map(function(e3) {
    return me.createElement("div", { key: e3, className: "flex items-center py-1 px-3 bg-gray-500 text-white text-xs uppercase leading-none rounded mr-2 mb-1" }, e3);
  }))));
};
var yr = function(t3) {
  var n4 = t3.name, r3 = t3.defaultOpen, a2 = t3.children, o2 = y((0, import_react5.useState)(!!r3), 2), i2 = o2[0], l2 = o2[1];
  return me.createElement("div", { className: "w-full border-t border-b border-gray-300 -mt-px" }, me.createElement("div", { className: "flex justify-between items-center cursor-pointer p-3 text-gray-500 hover:bg-gray-200 hover:text-gray-700", onClick: function() {
    l2(!i2);
  } }, me.createElement("h3", { className: "text-xs leading-none font-semibold uppercase tracking-widest" }, n4), i2 ? me.createElement(FiChevronUp, { className: "text-sm mr-1" }) : me.createElement(FiChevronDown, { className: "text-sm mr-1" })), i2 && me.createElement("div", { className: "p-3" }, a2));
};
var wr = function(e2) {
  return me.createElement(Zn, m({}, e2, { source: e2.source, onChange: e2.onChange }));
};
var kr = function(e2) {
  var t3 = e2.options, n4 = e2.value, r3 = e2.onChange, a2 = e2.isValid;
  return t3[0] && t3[0].value && !t3[0].value.color ? (console.warn("DEPRECATED: Found color string instead of object with color prop", t3), me.createElement("div", { className: "flex flex-wrap" }, t3.map(function(e3) {
    return me.createElement(tippy_react_esm_default, { key: e3.value, content: e3.label, delay: 400 }, me.createElement("div", { title: e3.label, key: e3.value, style: { width: 28, height: 28, border: "1px solid ".concat(n4 !== e3.value || a2 ? "rgba(0,0,0,0.1)" : "#f56565"), backgroundColor: e3.value, marginRight: 8 }, className: "flex justify-center items-center rounded-full cursor-pointer mb-2 hover:transform hover:scale-125", onClick: function() {
      return r3(e3.value);
    } }, n4 && n4 === e3.value && me.createElement(FiCheck, { className: (0, import_color.default)(e3.value).isLight() ? "text-black" : "text-white" })));
  }))) : me.createElement("div", { className: "flex flex-wrap" }, t3.map(function(e3) {
    return e3.value && e3.value.color ? me.createElement(tippy_react_esm_default, { key: e3.value.color || e3.value, content: e3.label, delay: 400 }, me.createElement("div", { style: { width: 28, height: 28, border: "".concat((n4 == null ? void 0 : n4.color) !== e3.value.color || a2 ? "1px solid rgba(0,0,0,0.1)" : "2px solid #f56565"), backgroundColor: e3.value.color, marginRight: 8 }, className: "flex justify-center items-center rounded-full cursor-pointer mb-2 transform hover:scale-125 transition-transform duration-150", onClick: function() {
      return r3(e3.value);
    } }, (n4 == null ? void 0 : n4.color) === e3.value.color && me.createElement(FiCheck, { className: (0, import_color.default)(e3.value.color).isLight() ? "text-black" : "text-white" }))) : null;
  }));
};
var Er = function(e2) {
  var t3 = e2.options, n4 = e2.value, r3 = e2.onChange, a2 = e2.isValid;
  return me.createElement("div", null, t3.map(function(e3) {
    return me.createElement("label", { className: (0, import_classnames2.default)("block text-sm text-gray-700 mb-0.5", { "text-red-600": n4 === e3.value && !a2 }), htmlFor: e3.value, key: e3.value }, me.createElement(On, { type: "radio", id: e3.value, key: e3.value, name: e3.value, value: e3.value, checked: n4 === e3.value, onChange: function(e4) {
      return r3(e4.target.value);
    } }), e3.label);
  }));
};
var Cr = import_react5.default.forwardRef(function(e2, t3) {
  return import_react5.default.createElement("select", m({ ref: t3, disabled: e2.disabled }, e2, { className: (0, import_classnames2.default)("block w-full rounded-md text-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50", { "cursor-not-allowed": !!e2.disabled }, e2.classNames) }, e2.style));
});
var Ar = function(e2) {
  var t3 = e2.id, n4 = e2.options, r3 = e2.value, a2 = e2.onChange, o2 = e2.isValid;
  return me.createElement(Cr, { id: t3, className: (0, import_classnames2.default)({ "border-red-500": !!r3 && !o2 }), value: r3, onChange: function(e3) {
    return a2(e3.target.value);
  } }, n4.map(function(e3) {
    return me.createElement("option", { key: e3.value, value: e3.value }, e3.label);
  }));
};
var Nr = function(t3) {
  var n4, r3 = t3.id, a2 = t3.blockId, o2 = t3.value, i2 = t3.selectOptions, l2 = t3.onChange, c2 = t3.isValid, s2 = y((0, import_react5.useState)((i2 == null ? void 0 : i2.options) || []), 2), d2 = s2[0], u2 = s2[1];
  ...
  }, [a2]), ((n4 = i2 == null ? void 0 : i2.options) === null || n4 === void 0 ? void 0 : n4.length) || typeof (i2 == null ? void 0 : i2.getOptions) == "function" ? i2.display === E.OptionsDisplay.Select ? me.createElement(Ar, { id: r3, options: d2, value: o2, onChange: l2, isValid: c2 }) : i2.display === E.OptionsDisplay.Radio ? me.createElement(Er, { options: d2, value: o2, onChange: l2, isValid: c2 }) : i2.display === E.OptionsDisplay.Color ? me.createElement(kr, { options: d2, value: o2, onChange: l2, isValid: c2 }) : null : null;
};
var Sr = function(e2) {
  return import_react5.default.createElement("textarea", m({}, e2, { className: (0, import_classnames2.default)("mt-1 block w-full text-sm rounded-md border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50", e2.classNames), rows: e2.rows || 3 }));
};
var Ir = function(t3) {
  var n4, r3 = t3.id, a2 = t3.value, o2 = t3.sideEditProp, i2 = t3.isValid, l2 = t3.onChange, s2 = y((0, import_react5.useState)(a2), 2), d2 = s2[0], u2 = s2[1];
  if ((0, import_react5.useEffect)(function() {
    u2(a2);
  }, [a2]), o2.type === E.SideEditPropType.Textarea) {
    var m2 = {};
    return ((n4 = o2.textareaOptions) === null || n4 === void 0 ? void 0 : n4.height) && (m2 = { style: { height: o2.textareaOptions.height } }), me.createElement(Sr, m({ id: r3, className: (0, import_classnames2.default)({ "border-2 border-red-500": !i2 }), value: d2 || "", onChange: function(e2) {
      u2(e2.target.value), l2(e2.target.value);
    } }, m2));
  }
  var p3 = "text", g3 = {};
  return o2.type === E.SideEditPropType.Number && (p3 = "number", o2.rangeOptions && (g3 = m({}, o2.rangeOptions))), o2.type === E.SideEditPropType.Date && (p3 = "date"), me.createElement(On, m({ id: r3, textSize: "sm", className: (0, import_classnames2.default)({ "border-2 border-red-500": !i2 }), type: p3, value: d2 || "" }, g3, { onChange: function(e2) {
    u2(e2.target.value), l2(e2.target.value);
  } }));
};
var Lr = function(e2) {
  var t3 = e2.propName, n4 = e2.label, r3 = e2.checked, a2 = e2.onChange, o2 = e2.isValid;
  return import_react5.default.createElement("label", { htmlFor: t3, className: "text-sm text-gray-700" }, import_react5.default.createElement(On, { id: t3, className: (0, import_classnames2.default)({ "text-red-600": !o2 }), type: "checkbox", checked: r3, onChange: function(e3) {
...
var zr = function(e2) {
  var t3, n4, r3 = e2.prop, a2 = e2.allProps, o2 = e2.onChange, i2 = e2.blockId, l2 = null, s2 = { isValid: true };
  if (typeof r3.show == "function" && !r3.show(a2))
    return null;
  if (typeof r3.validate == "function") {
    var d2 = r3.validate(a2[r3.name], a2);
    typeof d2 == "string" ? (s2.isValid = false, s2.errorMessage = d2) : s2.isValid = !!d2;
  }
  if (r3.type === E.SideEditPropType.Custom) {
    if (!r3.component)
      return null;
    var u2 = r3.component;
    l2 = me.createElement(u2, { id: r3.name, value: a2[r3.name], onChange: o2, isValid: s2.isValid, errorMessage: s2.errorMessage });
  }
  return r3.type !== E.SideEditPropType.Text && r3.type !== E.SideEditPropType.Number && r3.type !== E.SideEditPropType.Date && r3.type !== E.SideEditPropType.Textarea || (l2 = me.createElement(Ir, { id: r3.name, value: a2[r3.name], sideEditProp: m({}, r3), isValid: s2.isValid, onChange: o2 })), r3.type === E.SideEditPropType.Boolean && (l2 = me.createElement(Lr, { propName: r3.name, label: r3.label, checked: a2[r3.name] || false, onChange: o2, isValid: s2.isValid })), r3.type === E.SideEditPropType.Range && r3.rangeOptions && (l2 = me.createElement(Br, { propName: r3.name, value: a2[r3.name], rangeOptions: r3.rangeOptions, onChange: o2, isValid: s2.isValid })), r3.type === E.SideEditPropType.Image && (l2 = me.createElement(wr, { containerClassName: "w-full", imageClassName: "object-cover", source: a2[r3.name], propName: r3.name, onChange: o2, alt: r3.name, maxWidth: (t3 = r3.imageOptions) === null || t3 === void 0 ? void 0 : t3.maxWidth, aspectRatio: (n4 = r3.imageOptions) === null || n4 === void 0 ? void 0 : n4.aspectRatio })), r3.type === E.SideEditPropType.Select && r3.selectOptions && (l2 = me.createElement(Nr, { id: r3.name, blockId: i2, value: a2[r3.name], selectOptions: r3.selectOptions, onChange: o2, isValid: s2.isValid })), me.createElement("div", { className: "mb-6", key: r3.name }, me.createElement("label", { htmlFor: r3.name, className: (0, import_classnames2.default)("block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1") }, r3.label), l2, s2.errorMessage && me.createElement("div", { className: "text-xs text-red-500 font-bold" }, s2.errorMessage));
};
var Dr = function(t3) {
  var n4, r3, a2 = t3.focusedBlock, o2 = t3.onChange, i2 = a2.block, l2 = a2.Brick, s2 = ((n4 = l2 == null ? void 0 : l2.schema) === null || n4 === void 0 ? void 0 : n4.label) || "General", d2 = y((0, import_react5.useState)([]), 2), u2 = d2[0], m2 = d2[1];
  if ((0, import_react5.useEffect)(function() {
    var t4, n5 = (((t4 = l2 == null ? void 0 : l2.schema) === null || t4 === void 0 ? void 0 : t4.sideEditProps) || []).reduce(function(t5, n6) {
      var r4;
      if (n6.groupName)
        return i2 && typeof n6.show == "function" && !n6.show(i2.props) ? t5 : b(b([], y(t5), false), [m(m({}, n6), { isOpen: !!n6.defaultOpen })], false);
      var a3 = { groupName: s2, props: [], defaultOpen: true }, o3 = t5;
      return t5 && t5[0] && t5[0].groupName === s2 && (a3 = (r4 = y(t5))[0], o3 = r4.slice(1)), a3.props = b(b([], y(a3.props), false), [n6], false), b([a3], y(o3), false);
    }, []);
    m2(n5);
  ...
  var p3 = function(e2) {
    return e2.map(function(e3) {
      return me.createElement(zr, { key: e3.name, prop: e3, allProps: i2.props, onChange: function(t4) {
        o2(e3.name, t4, e3.shouldRefreshText);
      }, blockId: i2.id });
    });
  };
  return me.createElement("div", { className: "knobs" }, u2.map(function(e2) {
    return me.createElement(yr, { key: e2.groupName, name: e2.groupName, defaultOpen: e2.defaultOpen }, p3(e2.props));
  }));
};
var Pr = function(t3) {
  var n4, r3 = t3.content, o2 = t3.pageType, i2 = t3.type, l2 = t3.addAfterBlockId, c2 = t3.handleChange, s2 = t3.handleAddBlock, d2 = t3.handleAddItem, u2 = t3.handleRemoveItem, m2 = t3.handleSortItem, p3 = t3.handlePreviewNewBlock, h3 = (0, import_react5.useContext)(B), b3 = h3.bricks, v3 = h3.pageTypes, x2 = (0, import_react5.useContext)(T), y3 = x2.focused, w3 = x2.setTriggerTextRefreshBlockId, k3 = y((0, import_react5.useState)(""), 2), E3 = k3[0], C = k3[1], N2 = (0, import_react5.useRef)(null), S2 = y((0, import_react5.useState)(function() {
  ...
  if (o2 !== "rb-playground") {
    var R3 = v3.find(function(e2) {
      return e2.name === o2;
    });
    if (!R3)
      return null;
    B3 = R3.allowedBlockTypes, z3 = R3.excludedBlockTypes;
  }
  var M2 = function(e2) {
    var t4, n5 = e2.brickToAdd;
    return me.createElement("button", { className: "block w-full bg-white border border-gray-500 text-sm text-gray-600 hover:text-pink-600 hover:bg-pink-100 hover:border-pink-400 hover:shadow-lg font-semibold py-1 px-4 rounded mb-2", onClick: (t4 = n5.name, function(e3) {
      clearTimeout(N2.current), s2(t4)(e3), C("");
    }), onMouseOver: D2(n5.name), onMouseOut: P2 }, n5.label);
  };
  return me.createElement(me.Fragment, null, !!I2.FocusedBrick && I2.FocusedBrick.schema.repeaterItems && me.createElement(me.Fragment, null, i2 === E.Tab.Block && function(e2, t4) {
    var n5 = e2.filter(function(e3) {
      return !(I2.focusedBlock && e3.max && I2.focusedBlock.props[e3.name] && I2.focusedBlock.props[e3.name].length >= e3.max);
    }).map(function(e3) {
      var t5 = e3.itemLabel;
      return e3.itemLabel || (t5 = b3[e3.itemType].schema.label), me.createElement("button", { key: e3.itemType, className: "block w-full bg-white border border-gray-500 text-sm text-gray-600 hover:text-pink-600 hover:bg-pink-100 hover:border-pink-400 hover:shadow-lg font-semibold py-1 px-4 rounded mb-2", onClick: d2(y3.blockId, e3.name, e3.itemType) }, t5);
    });
    if (n5.length === 0)
      return null;
    var r4 = n5.length < 5;
    return t4 !== false && t4 !== true || (r4 = t4), me.createElement(yr, { name: "Add new...", defaultOpen: r4 }, n5);
  }(I2.FocusedBrick.schema.repeaterItems, I2.FocusedBrick.schema.newItemMenuOpen), i2 === E.Tab.Item && !!I2.FocusedBrick && I2.focusedItem && I2.focusedItemRepeaterItem && y3.itemId && me.createElement(me.Fragment, null, me.createElement("div", { className: "flex justify-between items-center p-3" }, me.createElement("button", { className: "flex items-center leading-none p-2 border border-transparent hover:border-gray-300 rounded text-sm text-blue-600 hover:text-blue-700 hover:bg-white transition-colors duration-150 focus:outline-none", onClick: m2(y3.blockId, y3.itemId, E.SortDirection.Up) }, "Move\xA0", me.createElement(FiArrowUp, null)), me.createElement("button", { className: "flex items-center leading-none p-2 border border-transparent hover:border-gray-300 rounded text-sm text-blue-600 hover:text-blue-700 hover:bg-white transition-colors duration-150 focus:outline-none", onClick: m2(y3.blockId, y3.itemId, E.SortDirection.Down) }, "Move\xA0", me.createElement(FiArrowDown, null)), me.createElement("button", { title: "Remove ".concat(I2.focusedItemRepeaterItem.itemLabel || ((n4 = I2.FocusedItemBrick) === null || n4 === void 0 ? void 0 : n4.schema.label)), className: "flex items-center leading-none p-2 border border-transparent hover:border-gray-300 rounded text-sm text-red-700 hover:text-red-800 hover:bg-white transition-colors duration-150 focus:outline-none", onClick: u2(y3.blockId, y3.itemId) }, "Remove")), me.createElement(Dr, { focusedBlock: { block: I2.focusedItem, Brick: I2.FocusedItemBrick }, onChange: T2(y3.itemId, y3.blockId, I2.focusedItemRepeaterItem.name) }))), i2 === E.Tab.Block && y3.blockId && me.createElement(me.Fragment, null, me.createElement(Dr, { focusedBlock: { block: I2.focusedBlock, Brick: I2.FocusedBrick }, onChange: T2(y3.blockId) })), !y3.blockId && !l2 && me.createElement("h2", { className: "text-sm font-bold uppercase tracking-wider text-gray-600 mb-6" }, "Select a block to edit"), l2 && me.createElement("div", { className: "p-3" }, me.createElement("div", { className: "relative mb-3" }, me.createElement(On, { value: E3, onChange: function(e2) {
    C(e2.target.value);
  }, radiusSize: "full", className: "px-4 leading-none", placeholder: "Search block type...", autoFocus: true }), me.createElement(FiSearch, { className: "absolute text-gray-400", style: { top: 9, right: 11 } })), function(t4) {
    var n5 = function(e2) {
      return Object.keys(e2).map(function(t5) {
        ...
        return !e3.hideFromAddMenu && ke(e3.name, B3, z3) && (e3.label.toLowerCase().indexOf(E3.toLowerCase()) > -1 || e3.category.toLowerCase().indexOf(E3.toLowerCase()) > -1 || e3.tags.join(" ").toLowerCase().indexOf(E3.toLowerCase()) > -1);
      });
    }(t4);
    if (n5.some(function(e2) {
      ...
      var r4 = function(t5) {
        return t5.reduce(function(t6, n6) {
          return n6.category && t6.indexOf(n6.category) === -1 ? b(b([], y(t6), false), [n6.category], false) : t6;
        }, []);
      }(n5), a2 = n5.filter(function(e2) {
        return !e2.category;
      });
      return me.createElement(me.Fragment, null, r4.map(function(e2) {
        return me.createElement(yr, { key: e2, name: e2, defaultOpen: true }, n5.filter(function(t5) {
          return t5.category === e2;
        }).map(function(e3) {
          return me.createElement(M2, { key: e3.name, brickToAdd: e3 });
        }));
      }), a2.length > 0 && me.createElement(yr, { name: "Other", defaultOpen: true }, a2.map(function(e2) {
        return me.createElement(M2, { key: e2.name, brickToAdd: e2 });
      })));
    }
...
var Tr = function(e2) {
  var t3 = localStorage.getItem(ye), n4 = Ie("t");
...
var Mr = ["aa", "ab", "ae", "af", "ak", "am", "an", "ar", "as", "av", "ay", "az", "ba", "be", "bg", "bh", "bi", "bm", "bn", "bo", "br", "bs", "ca", "ce", "ch", "co", "cr", "cs", "cu", "cv", "cy", "da", "de", "dv", "dz", "ee", "el", "en", "eo", "es", "et", "eu", "fa", "ff", "fi", "fj", "fo", "fr", "fy", "ga", "gd", "gl", "gn", "gu", "gv", "ha", "he", "hi", "ho", "hr", "ht", "hu", "hy", "hz", "ia", "id", "ie", "ig", "ii", "ik", "io", "is", "it", "iu", "ja", "jv", "ka", "kg", "ki", "kj", "kk", "kl", "km", "kn", "ko", "kr", "ks", "ku", "kv", "kw", "ky", "la", "lb", "lg", "li", "ln", "lo", "lt", "lu", "lv", "mg", "mh", "mi", "mk", "ml", "mn", "mr", "ms", "mt", "my", "na", "nb", "nd", "ne", "ng", "nl", "nn", "no", "nr", "nv", "ny", "oc", "oj", "om", "or", "os", "pa", "pi", "pl", "ps", "pt", "qu", "rm", "rn", "ro", "ru", "rw", "sa", "sc", "sd", "se", "sg", "si", "sk", "sl", "sm", "sn", "so", "sq", "sr", "ss", "st", "su", "sv", "sw", "ta", "te", "tg", "th", "ti", "tk", "tl", "tn", "to", "tr", "ts", "tt", "tw", "ty", "ug", "uk", "ur", "uz", "ve", "vi", "vo", "wa", "wo", "xh", "yi", "yo", "za", "zh", "zu"];
var Fr = function(t3) {
  var n4 = t3.url, r3 = t3.onChange, a2 = y((0, import_react5.useState)(false), 2), o2 = a2[0], i2 = a2[1], l2 = y((0, import_react5.useState)(""), 2), s2 = l2[0], d2 = l2[1], u2 = Rn(), m2 = useDropzone({ accept: "image/*", maxSize: 3145728, onDropAccepted: function(e2) {
    return g(void 0, void 0, void 0, function() {
      var t4, n5;
  ...
  return me.createElement("div", { className: "mt-2 flex flex-col items-center" }, me.createElement("div", { className: "relative w-40 h-40 flex justify-center items-center cursor-pointer overflow-hidden" }, n4 ? me.createElement("img", { className: "w-full", src: n4, alt: "Featured Image" }) : me.createElement(Qn, { className: "w-full" }), me.createElement("div", m({ className: "absolute top-0 left-0 z-10 opacity-0 w-full h-full flex justify-center items-center transition-opacity duration-300 hover:opacity-100 bg-pink-200 bg-opacity-75" }, p3()), me.createElement("div", { className: "p-4 rounded-full cursor-pointer border border-gray-200 shadow-md focus:outline-none", style: { backgroundColor: "rgba(255, 255, 255, 0.8)" } }, me.createElement("svg", { style: { width: 40, fill: "#d9367f" }, viewBox: "0 0 312.602 312.602" }, me.createElement("path", { d: "M251.52,137.244c-3.966,0-7.889,0.38-11.738,1.134c-1.756-47.268-40.758-85.181-88.448-85.181c-43.856,0-80.964,32.449-87.474,75.106C28.501,129.167,0,158.201,0,193.764c0,36.106,29.374,65.48,65.48,65.48h54.782c4.143,0,7.5-3.357,7.5-7.5c0-4.143-3.357-7.5-7.5-7.5H65.48c-27.835,0-50.48-22.645-50.48-50.48c0-27.835,22.646-50.48,50.48-50.48c1.367,0,2.813,0.067,4.419,0.206l7.6,0.658l0.529-7.61c2.661-38.322,34.861-68.341,73.306-68.341c40.533,0,73.51,32.977,73.51,73.51c0,1.863-0.089,3.855-0.272,6.088l-0.983,11.968l11.186-4.367c5.356-2.091,10.99-3.151,16.747-3.151c25.409,0,46.081,20.672,46.081,46.081c0,25.408-20.672,46.08-46.081,46.08c-0.668,0-20.608-0.04-40.467-0.08c-19.714-0.04-39.347-0.08-39.999-0.08c-4.668,0-7.108-2.248-7.254-6.681v-80.959l8.139,9.667c2.667,3.17,7.399,3.576,10.567,0.907c3.169-2.667,3.575-7.398,0.907-10.567l-18.037-21.427c-2.272-2.699-5.537-4.247-8.958-4.247c-3.421,0-6.686,1.548-8.957,4.247l-18.037,21.427c-2.668,3.169-2.262,7.9,0.907,10.567c1.407,1.185,3.121,1.763,4.826,1.763c2.137,0,4.258-0.908,5.741-2.67l7.901-9.386v80.751c0,8.686,5.927,21.607,22.254,21.607c0.652,0,20.27,0.04,39.968,0.079c19.874,0.041,39.829,0.081,40.498,0.081c33.681,0,61.081-27.4,61.081-61.08C312.602,164.644,285.201,137.244,251.52,137.244z" })), me.createElement("input", m({}, g3())))), o2 && me.createElement("div", { className: "absolute top-0 left-0 w-full h-full bg-white opacity-75 z-50 flex justify-center items-center" }, me.createElement("div", { className: "loading w-24 text-pink-500" }, me.createElement(Tn, null)))), !!s2 && me.createElement("div", { className: "text-sm bg-pink-100 border-red-400 px-2 py-1 mt-6 text-red-600" }, s2), me.createElement("button", { className: "mt-6 text-sm text-red-700 hover:text-red-800 hover:underline transition-colors duration-150 focus:outline-none", onClick: function() {
    r3("");
  } }, "Remove featured image"));
};
var Or = function(t3) {
  var n4 = t3.pageId, r3 = t3.pageCustomFields, a2 = t3.customValues, o2 = t3.onChange, i2 = "Custom Fields", l2 = y((0, import_react5.useState)([]), 2), s2 = l2[0], d2 = l2[1];
  if ((0, import_react5.useEffect)(function() {
    var t4 = (r3 || []).reduce(function(t5, n5) {
      var r4;
      if (n5.groupName)
        return a2 && typeof n5.show == "function" && !n5.show(a2) ? t5 : b(b([], y(t5), false), [m(m({}, n5), { isOpen: !!n5.defaultOpen })], false);
      var o3 = { groupName: i2, props: [], defaultOpen: true }, l3 = t5;
      return t5 && t5[0] && t5[0].groupName === i2 && (o3 = (r4 = y(t5))[0], l3 = r4.slice(1)), o3.props = b(b([], y(o3.props), false), [n5], false), b([o3], y(l3), false);
    }, []);
    d2(t4);
  }, [r3, a2]), !r3)
    return null;
  var u2 = function(e2) {
    return e2.map(function(e3) {
      return me.createElement(zr, { key: e3.name, prop: e3, allProps: a2 || {}, onChange: function(t4) {
        var n5;
        o2(((n5 = {})[e3.name] = t4, n5));
      }, blockId: n4 });
    });
  };
  return me.createElement("div", { className: "knobs" }, s2.map(function(e2) {
    return me.createElement(yr, { key: e2.groupName, name: e2.groupName, defaultOpen: e2.defaultOpen }, u2(e2.props));
  }));
};
var Yr = [{ value: "00:00:00.000", label: "0:00" }, { value: "01:00:00.000", label: "1:00" }, { value: "02:00:00.000", label: "2:00" }, { value: "03:00:00.000", label: "3:00" }, { value: "04:00:00.000", label: "4:00" }, { value: "05:00:00.000", label: "5:00" }, { value: "06:00:00.000", label: "6:00" }, { value: "07:00:00.000", label: "7:00" }, { value: "08:00:00.000", label: "8:00" }, { value: "09:00:00.000", label: "9:00" }, { value: "10:00:00.000", label: "10:00" }, { value: "11:00:00.000", label: "11:00" }, { value: "12:00:00.000", label: "12:00" }, { value: "13:00:00.000", label: "13:00" }, { value: "14:00:00.000", label: "14:00" }, { value: "15:00:00.000", label: "15:00" }, { value: "16:00:00.000", label: "16:00" }, { value: "17:00:00.000", label: "17:00" }, { value: "18:00:00.000", label: "18:00" }, { value: "19:00:00.000", label: "19:00" }, { value: "20:00:00.000", label: "20:00" }, { value: "21:00:00.000", label: "21:00" }, { value: "22:00:00.000", label: "22:00" }, { value: "23:00:00.000", label: "23:00" }];
var Wr = require_ReactTags_umd();
var Vr = function(e2) {
  return !!e2 && (e2.toLowerCase() === "pro" || e2.toLowerCase() === "enterprise");
};
var jr = function(t3) {
  var n4, r3, a2 = t3.page, o2 = t3.handleChangePageValue, i2 = (0, import_react5.useContext)(Zt).setCurrentPage, l2 = (0, import_react5.useContext)(B), s2 = l2.pageTypes, d2 = l2.customFields, u2 = l2.appId, m2 = d2 || [], p3 = s2.find(function(e2) {
    return e2.name === a2.type;
  }), h3 = (p3 == null ? void 0 : p3.customFields) || [], v3 = b(b([], y(m2), false), y(h3), false), x2 = (n4 = localStorage.getItem(ye), r3 = Ie("t"), useQuery(["authors"], function() {
    return g(void 0, void 0, void 0, function() {
    ...
    var e2 = localStorage.getItem(ye), t4 = Ie("t");
  ...
  }().data, w3 = Tr(u2).data, k3 = function() {
    var e2 = useQueryClient();
    return useMutation(function(e3) {
      return g(void 0, void 0, void 0, function() {
        return h(this, function(t4) {
  ...
  }({ pageId: a2.id, language: a2.language }), S2 = y((0, import_react5.useState)(false), 2), I2 = S2[0], L2 = S2[1], B3 = y((0, import_react5.useState)(false), 2), z3 = B3[0], D2 = B3[1], P2 = y((0, import_react5.useState)(""), 2), T2 = P2[0], R3 = P2[1], M2 = y((0, import_react5.useState)(""), 2), F2 = M2[0], O2 = M2[1];
  (0, import_react5.useEffect)(function() {
    T2 && F2 && o2({ scheduledForPublishingOn: "".concat(T2, "T").concat(F2, "Z") });
  }, [T2, F2]), (0, import_react5.useEffect)(function() {
    if (a2.scheduledForPublishingOn) {
      var e2 = a2.scheduledForPublishingOn.slice(0, -1).split("T");
      e2.length === 2 && (R3(e2[0]), O2(e2[1]));
    }
  }, [a2]);
  var Y2 = function(e2) {
    o2({ meta: m(m({}, a2.meta), e2) });
  };
  return me.createElement(me.Fragment, null, me.createElement(yr, { name: "Status and Visibility", defaultOpen: true }, me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "status", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Visibility"), me.createElement(Cr, { id: "status", value: a2.status, onChange: function(e2) {
    return o2({ status: e2.target.value });
  } }, me.createElement("option", { value: E.PageStatus.Published }, "Published"), me.createElement("option", { value: E.PageStatus.Draft }, "Draft"))), me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "scheduledDate", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Schedule publish (GMT+0)", me.createElement("span", { className: "ml-1 text-xs bg-blue-200 text-blue-800 py-px px-1 rounded uppercase" }, "PRO")), me.createElement("div", { className: "flex" }, me.createElement(On, { type: "date", className: "mr-2", id: "scheduledDate", value: T2, onChange: function(e2) {
    return R3(e2.target.value);
  }, disabled: !Vr(w3 == null ? void 0 : w3.plan) }), me.createElement(Cr, { id: "scheduledTime", value: F2, onChange: function(e2) {
    return O2(e2.target.value);
  }, style: { width: 90 }, disabled: !Vr(w3 == null ? void 0 : w3.plan) }, Yr.map(function(e2) {
    return me.createElement("option", { key: e2.value, value: e2.value }, e2.label);
  })))), me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "isLocked", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Page structure locked?"), me.createElement(Cr, { id: "isLocked", value: a2.isLocked ? 1 : 0, onChange: function(e2) {
    return o2({ isLocked: e2.target.value !== "0" });
  } }, me.createElement("option", { value: 0 }, "Unlocked"), me.createElement("option", { value: 1 }, "Locked"))), me.createElement("div", { className: "mb-3" }, me.createElement("div", { className: "py-2" }, me.createElement(tippy_react_esm_default, { content: "Create a new page with the same content" }, me.createElement("button", { className: "text-sm text-blue-600 hover:text-blue-700 hover:underline transition-colors duration-150 focus:outline-none", onClick: function() {
    k3.mutate(a2.id);
  } }, "Duplicate Page"))), me.createElement("div", { className: "py-2" }, me.createElement(tippy_react_esm_default, { content: "Delete the Page" }, me.createElement("button", { className: "block text-sm text-red-700 hover:text-red-800 hover:underline transition-colors duration-150 focus:outline-none", onClick: function() {
    L2(true);
  } }, "Delete Page")), w3 && w3.languages.length > 1 && a2.translations.length >= 2 && me.createElement(tippy_react_esm_default, { content: "Delete this Translation" }, me.createElement("button", { className: "text-sm text-red-700 hover:text-red-800 hover:underline transition-colors duration-150 focus:outline-none", onClick: function() {
    D2(true);
  } }, "Delete Translation"))))), me.createElement(Rr, { title: 'Confirm to delete "'.concat(a2.name, '"?'), message: me.createElement("span", null, "Are you sure you want to delete this page", " ", me.createElement("b", { className: "text-gray-900" }, "and all its content in all languages"), "?"), buttons: [{ label: "Yes, delete the page", onClick: function() {
    return g(void 0, void 0, void 0, function() {
      return h(this, function(e2) {
        switch (e2.label) {
          case 0:
            return [4, C.mutateAsync(a2.id)];
          case 1:
  ...
  }, type: "cancel" }], isOpen: I2, setIsOpen: L2 }), me.createElement(Rr, { title: "Confirm delete", message: "Are you sure you want to delete this translation?", buttons: [{ label: "Yes, delete", onClick: function() {
    return g(void 0, void 0, void 0, function() {
      var t4, n5, r4;
      return h(this, function(o3) {
        switch (o3.label) {
          case 0:
            return t4 = b([], y(a2.translations), false), n5 = t4.filter(function(e2) {
              return e2.language !== a2.language;
            }), r4 = n5.some(function(e2) {
              return e2.language === (w3 == null ? void 0 : w3.defaultLanguage);
            }) ? w3 == null ? void 0 : w3.defaultLanguage : n5[0].language, [4, N2.mutateAsync()];
          case 1:
  ...
  }, type: "cancel" }], isOpen: z3, setIsOpen: D2 }), me.createElement(yr, { name: "Page attributes" }, me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "slug", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Slug"), me.createElement(On, { id: "slug", value: a2.slug || "", onChange: function(e2) {
    var t4 = e2.target.value;
    /^[A-Za-z0-9\-_]*$/.test(t4) && o2({ slug: t4 });
  } })), me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "name", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Name"), me.createElement(On, { id: "name", value: a2.name || "", onChange: function(e2) {
    return o2({ name: e2.target.value });
  } })), me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "authorId", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Author"), me.createElement(Cr, { id: "authorId", value: a2.authorId, onChange: function(e2) {
    return o2({ authorId: e2.target.value });
  } }, x2 && x2.map(function(e2) {
    return me.createElement("option", { key: e2.id, value: e2.id }, e2.firstName, " ", e2.lastName);
  }))), me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "publishedAt", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Publish Date"), me.createElement(On, { type: "date", id: "publishedAt", value: a2.publishedAt ? a2.publishedAt.substr(0, 10) : "", onChange: function(e2) {
    return o2({ publishedAt: e2.target.value });
  } })), me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "pageType", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Page Type"), me.createElement(Cr, { id: "pageType", value: a2.type, onChange: function(e2) {
    return o2({ type: e2.target.value });
  } }, s2.map(function(e2) {
    return me.createElement("option", { key: e2.name, value: e2.name }, e2.name);
  })))), me.createElement(yr, { name: "Tags" }, me.createElement(Wr, { tags: a2.tags.map(function(e2) {
    return { id: e2, name: e2 };
  }), allowNew: true, onAddition: function(t4) {
    if (a2.tags.indexOf(t4.name) === -1) {
      var n5 = b(b([], y(a2.tags), false), [t4.name.trim()], false);
      o2({ tags: n5 });
    }
    ...
    return { id: e2, name: e2 };
  }), minQueryLength: 1 })), me.createElement(yr, { name: "Featured Image" }, me.createElement(Fr, { url: a2.meta.featuredImage, onChange: function(e2) {
    Y2({ featuredImage: e2 });
  } })), me.createElement(yr, { name: "SEO Meta Tags" }, me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "meta_title", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Title"), me.createElement(On, { id: "meta_title", value: a2.meta.title || "", onChange: function(e2) {
    return Y2({ title: e2.target.value });
  } })), me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "meta_description", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Description"), me.createElement(Sr, { id: "meta_description", value: a2.meta.description || "", rows: 3, onChange: function(e2) {
    return Y2({ description: e2.target.value });
  } })), me.createElement("div", { className: "mb-3" }, me.createElement("label", { htmlFor: "language", className: "block text-xs font-bold uppercase tracking-wider text-gray-600 mb-1" }, "Language"), me.createElement(Cr, { id: "language", value: a2.meta.language || "en", onChange: function(e2) {
    return Y2({ language: e2.target.value });
  } }, Mr.map(function(e2) {
    return me.createElement("option", { key: e2, value: e2 }, e2);
  })))), me.createElement("div", { className: "border-t border-b border-gray-300" }), me.createElement(Or, { pageId: a2.id, pageCustomFields: v3, customValues: a2.customValues, onChange: function(e2) {
    o2({ customValues: m(m({}, a2.customValues), e2) });
  } }));
};
var Xr = function(t3) {
  var n4, r3 = t3.isOpen, a2 = t3.setIsOpen, o2 = t3.focusedBlock, i2 = y((0, import_react5.useState)(""), 2), l2 = i2[0], c2 = i2[1], s2 = function(e2) {
    var t4 = useQueryClient();
    return useMutation(function(t5) {
      var n5 = t5.name, r4 = t5.props;
      return t5.imageBlob, g(void 0, void 0, void 0, function() {
        var t6;
        return h(this, function(a3) {
          switch (a3.label) {
            case 0:
    ...
    }, onError: nr({ topic: "story", getLimitExceededError: function(e3, t5) {
  ...
  return import_react5.default.createElement(import_react_modal.default, { isOpen: r3, onRequestClose: function() {
    ...
    s2.mutate({ name: l2, props: (o2 == null ? void 0 : o2.props) || {} }), a2(false);
  } }, import_react5.default.createElement(On, { id: "name", value: l2, onChange: function(e2) {
...
var Ur = function(t3) {
  var n4 = t3.content, r3 = t3.handleSetStory, o2 = (0, import_react5.useContext)(T).focused, i2 = (0, import_react5.useContext)(B).appId, l2 = y((0, import_react5.useState)(""), 2), c2 = l2[0], s2 = l2[1], d2 = y((0, import_react5.useState)(), 2), u2 = d2[0], m2 = d2[1], p3 = y((0, import_react5.useState)(null), 2), f3 = p3[0], h3 = p3[1], v3 = y((0, import_react5.useState)(null), 2), x2 = v3[0], y3 = v3[1], w3 = y((0, import_react5.useState)(false), 2), k3 = w3[0], C = w3[1], A3 = (0, import_react5.useRef)(null);
  (0, import_react5.useEffect)(function() {
  ...
  var N2, S2, I2, L2 = (N2 = (f3 == null ? void 0 : f3.type) || "", S2 = localStorage.getItem(ye), I2 = Ie("t"), useQuery(["storiesByBlock", { blockType: N2 }], function() {
    return g(void 0, void 0, void 0, function() {
      return h(this, function(e2) {
        switch (e2.label) {
          case 0:
  ...
  }, { enabled: !(!N2 || !S2 && !I2), staleTime: 12e4 })).data, B3 = Tr(i2).data, z3 = function(e2) {
    var t4 = useQueryClient();
    return useMutation(function(t5) {
      return g(void 0, void 0, void 0, function() {
        return h(this, function(n5) {
  ...
  return (B3 == null ? void 0 : B3.plan.toLowerCase()) === "pro" || (B3 == null ? void 0 : B3.plan.toLowerCase()) === "enterprise" ? me.createElement("div", { className: "p-3" }, me.createElement("button", { className: "px-6 py-2 w-full bg-blue-500 hover:bg-blue-600 hover:shadow-lg text-sm leading-none text-white font-semibold rounded disabled:opacity-75 disabled:cursor-not-allowed mb-3", onClick: function() {
    return C(true);
  } }, "Save story as..."), !(L2 && L2.length > 0) && me.createElement("div", null, "No stories available yet for this block type."), L2 && L2.length > 0 && me.createElement("div", { className: "relative mb-3" }, me.createElement(On, { value: c2, onChange: function(e2) {
    s2(e2.target.value);
  }, radiusSize: "full", className: "px-4 leading-none", placeholder: "Search stories..." }), me.createElement(FiSearch, { className: "absolute text-gray-400", style: { top: 9, right: 11 } })), L2 && L2.length > 0 && L2.filter(function(e2) {
    return e2.name.toLowerCase().indexOf(c2.toLowerCase()) > -1;
  }).map(function(e2) {
    return me.createElement("div", { key: e2.id, className: "flex items-center justify-between space-x-3 mb-2" }, me.createElement("button", { className: (0, import_classnames2.default)("block w-full border border-gray-500 text-sm text-gray-600 hover:shadow-lg font-semibold py-1 px-4 rounded", e2.id === x2 ? "bg-green-200 transition-colors duration-200" : "duration-1000 bg-white hover:text-pink-600 hover:bg-pink-100 hover:border-pink-400"), onClick: D2(e2), onMouseOver: P2(e2), onMouseOut: T2 }, e2.name), me.createElement("button", { className: "text-sm text-red-700 hover:text-red-800 transition-colors duration-150 focus:outline-none", onClick: function() {
      return z3.mutate(e2.name);
    } }, me.createElement(FiTrash2, null)));
  }), me.createElement(Xr, { isOpen: k3, setIsOpen: C, focusedBlock: f3 })) : me.createElement("div", { className: "p-3" }, "This feature is allowed only for Pro or Enterprise plans.");
};
var Hr = function(t3) {
  var n4 = t3.page, r3 = t3.content, o2 = t3.addAfterBlockId, i2 = t3.handleChange, l2 = t3.handleSetStory, s2 = t3.handleAddBlock, d2 = t3.handleAddItem, u2 = t3.handleRemoveItem, m2 = t3.handleSortItem, p3 = t3.handlePreviewNewBlock, h3 = t3.handleChangePageValue, b3 = t3.playgroundSelectedItem, v3 = t3.sidebarOpen, x2 = (0, import_react5.useContext)(B).bricks, y3 = (0, import_react5.useContext)(T).focused, w3 = (0, import_react5.useContext)(Zt).previewMode, k3 = y((0, import_react5.useState)({ selectedTab: E.Tab.Document, block: "" }), 2), E3 = k3[0], C = k3[1];
  (0, import_react5.useEffect)(function() {
    var e2, t4 = y3.blockId ? r3.find(function(e3) {
      return e3.id === y3.blockId;
    ...
    var s3 = o3 ? E.Tab.Item : t4 || y3.blockId === "ADD_BLOCK" ? E.Tab.Block : (b3 == null ? void 0 : b3.type) === E.PlaygroundSelectedItemType.Page ? E.Tab.PageSettings : E.Tab.Document;
    C({ selectedTab: s3, block: (a2 == null ? void 0 : a2.schema.label) || "", item: (c2 == null ? void 0 : c2.itemLabel) || (l3 == null ? void 0 : l3.schema.label) || "" });
  }, [n4.id, y3]);
  var A3 = function(e2, t4, n5) {
    return n5 === void 0 && (n5 = false), t4 && me.createElement("button", { className: "flex-1 py-3 text-center leading-none text-sm border-b-4 focus:outline-none hover:text-gray-800 ".concat(E3.selectedTab === e2 || n5 ? "border-pink-500 text-gray-900 font-semibold" : "border-transparent text-gray-600"), style: { marginBottom: "-1px" }, onClick: function() {
      return function(e3) {
        C(m(m({}, E3), { selectedTab: e3 }));
      }(e2);
    } }, t4);
  };
  return me.createElement("aside", { style: { transition: "width 300ms", width: w3 || !v3 ? 0 : 275 } }, !w3 && me.createElement("div", { className: "fixed top-0 h-full overflow-y-auto", style: { paddingTop: 85, width: 275 } }, n4.invalidBlocksTypes && n4.invalidBlocksTypes.length > 0 && me.createElement("div", { className: "p-3" }, me.createElement("div", { className: "border border-pink-400 bg-pink-100 rounded px-2 py-1 mb-3 text-sm leading-tight" }, me.createElement("b", null, "Warning:"), " found ", n4.invalidBlocksTypes.length, " ", n4.invalidBlocksTypes.length > 1 ? "blocks" : "block", " of unrecognized or not allowed type:", n4.invalidBlocksTypes.map(function(e2) {
    return me.createElement("code", { key: e2, className: "ml-1 text-xs px-1 py-px bg-pink-200 rounded" }, e2);
  }), ". Saving will delete invalid blocks.")), me.createElement("div", { className: "flex flex-row items-center justify-around border-b" }, !b3 && A3(E.Tab.Document, "Page"), (b3 == null ? void 0 : b3.type) !== E.PlaygroundSelectedItemType.Page && y3.blockId && A3(E.Tab.Block, "Block"), (b3 == null ? void 0 : b3.type) !== E.PlaygroundSelectedItemType.Page && y3.blockId && A3(E.Tab.Stories, "Stories"), (b3 == null ? void 0 : b3.type) !== E.PlaygroundSelectedItemType.Page && y3.blockId && E3.item && A3(E.Tab.Item, "Item"), (b3 == null ? void 0 : b3.type) === E.PlaygroundSelectedItemType.Page && A3(E.Tab.PageSettings, "Page settings", true)), (b3 == null ? void 0 : b3.type) !== E.PlaygroundSelectedItemType.Page && (E3.selectedTab === E.Tab.Block || E3.selectedTab === E.Tab.Item) && me.createElement(Pr, { content: r3, pageType: n4.type, type: E3.selectedTab, addAfterBlockId: o2, handleChange: i2, handleAddBlock: s2, handleAddItem: d2, handleRemoveItem: u2, handleSortItem: m2, handlePreviewNewBlock: p3 }), (b3 == null ? void 0 : b3.type) !== E.PlaygroundSelectedItemType.Page && E3.selectedTab === E.Tab.Stories && me.createElement(Ur, { content: r3, handleSetStory: l2 }), !b3 && E3.selectedTab === E.Tab.Document && me.createElement(jr, { page: n4, handleChangePageValue: h3 }), (b3 == null ? void 0 : b3.type) === E.PlaygroundSelectedItemType.Block && me.createElement(xr, { blockTypeName: b3 == null ? void 0 : b3.name }), (b3 == null ? void 0 : b3.type) === E.PlaygroundSelectedItemType.Page && me.createElement(vr, { pageTypeName: b3 == null ? void 0 : b3.name })));
};
var Jr = function(t3) {
  var n4, r3 = t3.page, o2 = t3.content, l2 = t3.sidebarOpen, s2 = t3.devicePreview, u2 = t3.onChange, m2 = t3.handleChangePageValue, p3 = t3.locked, h3 = p3 !== void 0 && p3, v3 = t3.playgroundSelectedItem, x2 = t3.playgroundBlockId, y3 = t3.isPlayground, w3 = (0, import_react5.useContext)(B), k3 = w3.bricks, C = w3.contentClassName, N2 = w3.isDarkColorMode, S2 = w3.useCssInJs, I2 = w3.appId, L2 = Tr(I2).data, B3 = (0, import_react5.useContext)(Zt), z3 = B3.currentPage, D2 = B3.setCurrentPage, P2 = B3.previewMode, T2 = B3.getStyles, R3 = B3.getStylesheets, M2 = me.useRef(null), F2 = y((0, import_react5.useState)({ blockId: "", itemId: "", repeaterPropName: "" }), 2), O2 = F2[0], Y2 = F2[1], W2 = y((0, import_react5.useState)(""), 2), V2 = W2[0], j2 = W2[1], X3 = y((0, import_react5.useState)(null), 2), U2 = X3[0], H2 = X3[1], J = y((0, import_react5.useState)([]), 2), K2 = J[0], Q2 = J[1], q2 = y((0, import_react5.useState)([]), 2), Z3 = q2[0], G2 = q2[1], _2 = y((0, import_react5.useState)(false), 2), $ = _2[0], ee = _2[1], te = y((0, import_react5.useState)(""), 2), ne2 = te[0], re2 = te[1], ae2 = y((0, import_react5.useState)(false), 2), oe2 = ae2[0], ie2 = ae2[1], le = y((0, import_react5.useState)(null), 2), ce = le[0], se = le[1], de2 = (n4 = r3.id, useMutation(function(e2) {
    return g(void 0, void 0, void 0, function() {
      return h(this, function(t4) {
        switch (t4.label) {
          case 0:
  ...
  }, onError: nr({ topic: "page", getLimitExceededError: function(e2, t4) {
  ...
  (0, import_react5.useEffect)(function() {
    Y2(x2 ? { blockId: x2, itemId: "", repeaterPropName: "" } : { blockId: "", itemId: "", repeaterPropName: "" }), j2(""), S2 ? (ee(false), setTimeout(function() {
      Q2(T2()), G2(R3()), setTimeout(function() {
        ee(true);
      }, 200);
    }, 800)) : (ee(false), Q2(T2()), G2(R3()), ee(true));
  }, [z3]), (0, import_react5.useEffect)(function() {
  ...
  var ue = function(e2) {
  ...
  }, ge2 = function(e2, t4, n5) {
    return t4 === void 0 && (t4 = ""), n5 === void 0 && (n5 = ""), function(r4, a2) {
      var i2 = o2;
      i2 = t4 ? o2.map(function(o3) {
        var i3;
        return o3.id === t4 && o3.props[n5] ? m(m({}, o3), { props: m(m({}, o3.props), (i3 = {}, i3[n5] = o3.props[n5].map(function(t5) {
          var n6;
          return t5.id === e2 ? m(m({}, t5), { props: m(m({}, t5.props), (n6 = {}, n6[r4] = a2, n6)) }) : t5;
        }), i3)) }) : o3;
      }) : o2.map(function(t5) {
        var n6;
        return t5.id === e2 ? m(m({}, t5), { props: m(m({}, t5.props), (n6 = {}, n6[r4] = a2, n6)) }) : t5;
    ...
    return function(t4) {
      t4.preventDefault(), Y2({ blockId: "ADD_BLOCK", itemId: "", repeaterPropName: "" }), j2(e2);
    };
  }, ve3 = function(e2) {
    return function(t4) {
      t4.preventDefault(), Y2({ blockId: "ADD_BLOCK", itemId: "", repeaterPropName: "" });
      var n5 = we2(e2);
      j2(n5);
    };
  }, we2 = function(e2) {
    ...
    return function(n5) {
      ...
      if (a2) {
        var i2 = b(b(b([], y(o2.slice(0, r4)), false), [a2, m(m({}, a2), { id: v4_default() })], false), y(o2.slice(r4 + 1)), false);
        u2(i2);
      }
    };
  }, Ee2 = function(t4, n5) {
    return function(r4) {
      r4.preventDefault();
      var a2 = b([], y(o2), false), i2 = a2.findIndex(function(e2) {
        return e2.id === t4;
      });
      if (i2 !== -1) {
        if (n5 === E.SortDirection.Up && i2 > 0) {
          var l3 = a2[i2 - 1];
          a2[i2 - 1] = a2[i2], a2[i2] = l3;
        }
        if (n5 === E.SortDirection.Down && i2 < a2.length - 1) {
          l3 = a2[i2 + 1];
          a2[i2 + 1] = a2[i2], a2[i2] = l3;
        }
        u2(a2);
    ...
    return function(t4) {
      t4.preventDefault(), Y2({ blockId: "", itemId: "", repeaterPropName: "" });
    ...
    return function() {
      ...
      if (a2) {
        var i2 = { id: v4_default(), type: r4, props: a2.schema.getDefaultProps ? a2.schema.getDefaultProps() : {} }, l3 = o2.map(function(r5) {
          ...
          if (r5.id !== t4)
            return r5;
          var s3 = (l4 = (o3 = k3[r5.type].schema.repeaterItems) === null || o3 === void 0 ? void 0 : o3.find(function(e2) {
            return e2.name === n5;
          })) === null || l4 === void 0 ? void 0 : l4.max;
          return s3 && r5.props[n5] && r5.props[n5].length >= s3 ? (console.error("Cannot add new blocks. Maximum number is: " + s3), r5) : m(m({}, r5), { props: m(m({}, r5.props), (a3 = {}, a3[n5] = b(b([], y(r5.props[n5] || []), false), [i2], false), a3)) });
        });
        u2(l3);
      }
    };
  }, Ne2 = function() {
    ie2(true), setTimeout(function() {
      ie2(false);
    }, 3e3);
  }, Se2 = function(e2) {
    if (!e2)
    ...
    var t4 = Object.keys(e2).reduce(function(t5, n5) {
      var r4, a2, o3;
      return e2[n5] && e2[n5].document && e2[n5].object === "value" ? m(m({}, t5), ((r4 = {})[n5] = "**BEGIN-Plain.deserialize**".concat(w.serialize(e2[n5]), "**END-Plain.deserialize**"), r4)) : e2[n5] && Array.isArray(e2[n5]) ? m(m({}, t5), ((a2 = {})[n5] = e2[n5].map(function(e3) {
        return e3.id && e3.props && e3.type ? Se2(e3.props) : Se2(e3);
      }), a2)) : m(m({}, t5), ((o3 = {})[n5] = e2[n5], o3));
    }, {});
    return t4;
  }, Ie2 = !!v3 && v3.type === E.PlaygroundSelectedItemType.Page, Le2 = !!v3 && v3.type === E.PlaygroundSelectedItemType.Block, Be2 = function() {
    return null;
  };
  if (v3 && v3.type === E.PlaygroundSelectedItemType.Block) {
    var ze = k3[v3.name];
    ze.schema.playgroundLinkUrl && ze.schema.playgroundLinkLabel && (Be2 = function() {
      return me.createElement("a", { href: ze.schema.playgroundLinkUrl, target: "_blank", rel: "noopener noreferrer", style: { fontSize: 14, color: "#4299e1" } }, ze.schema.playgroundLinkLabel, " \xBB");
    });
  }
  r3.content;
  var De2, Pe3 = f(r3, ["content"]), Te2 = m({}, Pe3);
  return me.createElement(T.Provider, { value: { focused: O2, setFocused: Y2, triggerTextRefreshBlockId: ne2, setTriggerTextRefreshBlockId: re2, setAddAfterBlockId: j2, pageValues: Te2, handleChangePageValue: m2 } }, me.createElement("div", { className: "flex-1 flex" }, me.createElement("div", { className: "flex-1 flex justify-center bg-gray-200 shadow-inner rounded-md", style: { marginTop: 44 } }, me.createElement("div", { className: "shadow-lg rounded-md bg-white transition-all duration-200", style: { width: s2.width } }, !y3 && !P2 && L2 && L2.languages.length > 1 && me.createElement("div", { className: "flex justify-between text-sm border-b" }, me.createElement("div", { className: "flex" }, L2.languages.map(function(e2) {
    return e2.code === r3.language ? me.createElement("div", { key: e2.code, className: "bg-white pt-3 pb-2 px-1 ml-4 border-b-4 border-pink-500 font-semibold text-black", onClick: ue(e2.code) }, e2.name) : me.createElement("div", { key: e2.code, className: "cursor-pointer pt-3 pb-2 px-1 ml-4 text-gray-700 border-b-4 border-transparent flex items-center", onClick: r3.translations.some(function(t4) {
      return t4.language === e2.code;
    }) ? ue(e2.code) : pe3(e2) }, e2.name, !r3.translations.some(function(t4) {
      return t4.language === e2.code;
    }) && me.createElement(FiAlertTriangle, { className: "ml-1 text-gray-400" }));
  })), me.createElement("div", { className: "pt-2 px-4" }), me.createElement(Rr, { title: "Create a new translation", message: "Create the ".concat(ce == null ? void 0 : ce.name, " translation?"), buttons: [{ label: "Yes, create translation", onClick: function() {
    return g(void 0, void 0, void 0, function() {
      return h(this, function(e2) {
        switch (e2.label) {
          case 0:
            ...
            e2.label = 1;
          case 1:
            return e2.trys.push([1, 3, , 4]), [4, de2.mutate(ce.code)];
          case 2:
            return e2.sent(), D2({ pageId: r3.id, language: ce.code }), se(null), [3, 4];
          case 3:
            return e2.sent(), se(null), [3, 4];
          case 4:
            return [2];
        }
      });
  ...
  }, type: "cancel" }], isOpen: !!ce, setIsOpen: se })), me.createElement(fr, { id: "rb-content-frame", className: "overflow-hidden bg-white", style: { width: "100%", height: "calc(100vh - ".concat(!y3 && !P2 && L2 && L2.languages.length > 1 ? 129 : 84, "px)") }, styles: K2, stylesheets: Z3 }, $ && me.createElement("div", { style: { backgroundColor: "#fff", position: "relative", paddingTop: y3 ? 0 : 20, paddingBottom: 20 } }, me.createElement("style", null, "\nbutton.rb-action {\n  box-sizing: border-box;\n  width: unset;\n  font-family: inherit;\n  line-height: 1.15;\n  margin: 0;\n  overflow: visible;\n  -webkit-appearance: button;\n  cursor: pointer;\n  border: none;\n  background-color: #f65a8e;\n  padding: 4px;\n  border-radius: 4px;\n  font-size: 16px;\n  color: #fff;\n}\nbutton.rb-action:hover {\n  background-color: #d9367f;\n}\nbutton.rb-action:focus {\n  outline: none;\n}\nbutton.rb-action.disabled {\n  opacity: 50%;\n  cursor: not-allowed;\n}\nbutton.rb-action.disabled:hover {\n  background-color: #f65a8e;\n}"), me.createElement("div", { ref: M2, className: "react-bricks-content ".concat(C) }, !h3 && !Ie2 && !P2 && o2.length === 0 && me.createElement("div", { style: { display: "flex", justifyContent: "center", alignItems: "center", padding: 10 } }, me.createElement("button", { className: "rb-action", onClick: be2("FIRST") }, "Add your first block")), V2 === "FIRST" && me.createElement(br, { previewNewBlock: U2 }), o2.map(function(e2, t4) {
    return me.createElement(import_react5.Fragment, { key: e2.id }, me.createElement(import_react_error_boundary.ErrorBoundary, { FallbackComponent: (n5 = e2.type, function() {
      return me.createElement("div", { style: { padding: 8, backgroundColor: "#fff5f5", border: "2px solid #e53e3e", color: "#e53e3e", fontWeight: 600, textAlign: "center" } }, 'Block "', n5, '" threw an error');
    }) }, me.createElement(hr, { contentLength: o2.length, contentRef: M2, block: e2, index: t4, locked: h3 || Ie2, setAddAfterBlockId: j2, handleChange: ge2, handleAddBlockBefore: ve3, handleAddBlockAfter: be2, handleRemoveBlock: Ce2, handleSort: Ee2, handleAddItem: Ae2, handleDuplicate: ke2 })), V2 === e2.id && me.createElement(br, { previewNewBlock: U2 }));
    var n5;
  })), Ie2 && me.createElement("div", { style: { marginTop: 24, paddingLeft: 24, paddingRight: 24, fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif' } }, me.createElement("h3", { style: { fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 12, color: "#718096" } }, "Current content blocks"), me.createElement("div", { style: { position: "relative", fontFamily: 'Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', backgroundColor: "#edf2f7", fontSize: 12, color: "#4a5568", padding: 32, marginBottom: 12, borderRadius: 4, overflowX: "auto" } }, me.createElement(import_react_copy_to_clipboard.default, { text: JSON.stringify(o2.map(function(e2) {
    return e2.type;
  })).replace(/"/g, "'"), onCopy: Ne2 }, me.createElement("div", { style: { position: "absolute", fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif', top: 4, right: 4 } }, me.createElement("button", { className: "rb-action", style: { fontSize: 14, paddingLeft: 8, paddingRight: 8 } }, oe2 ? "Copied" : "Copy"))), "[", o2.map(function(e2, t4) {
    return me.createElement("span", { key: e2.type }, "'", me.createElement("span", { style: { color: "#d53f8c", fontWeight: 700 } }, e2.type), "'", t4 < o2.length - 1 && ", ");
  }), "]"), me.createElement("p", null, "You may copy the array to set it as the pageType's defaultContent")), Le2 && me.createElement("div", { style: { marginTop: 24, paddingLeft: 24, paddingRight: 24, fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif' } }, me.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, me.createElement("h3", { style: { fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 12, color: "#718096" } }, "Current props"), me.createElement(Be2, null)), me.createElement("div", { style: { position: "relative", fontFamily: 'Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', backgroundColor: "#edf2f7", fontSize: 12, color: "#4a5568", padding: 32, marginBottom: 12, borderRadius: 4, overflowX: "auto" } }, me.createElement(import_react_copy_to_clipboard.default, { text: (De2 = o2[0] && o2[0].props, JSON.stringify(Se2(De2), null, 2).replace(/\"\*\*BEGIN\-Plain\.deserialize\*\*/gi, '"').replace(/\*\*END\-Plain\.deserialize\*\*\"/gi, '"').replace(/  \"(\w*)\"\: /gi, "  $1: ")), onCopy: Ne2 }, me.createElement("div", { style: { position: "absolute", fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif', top: 4, right: 4 } }, me.createElement("button", { className: "rb-action", style: { fontSize: 14, paddingLeft: 8, paddingRight: 8 } }, oe2 ? "Copied" : "Copy"))), me.createElement("div", { className: "overflow-auto", dangerouslySetInnerHTML: { __html: function(e2) {
  ...
  }(o2[0] && o2[0].props) } }))))))), me.createElement(Hr, { page: r3, content: o2, addAfterBlockId: V2, handleChange: ge2, handleSetStory: function(e2, t4) {
    var n5 = o2.map(function(n6) {
      return n6.id === e2 ? m(m({}, n6), { props: t4 }) : n6;
    });
    u2(n5);
    ...
    return function(n5) {
      ...
      if (l3) {
        var s3 = l3.schema.getDefaultProps ? l3.schema.getDefaultProps() : {};
        if (((r4 = l3.schema.repeaterItems) === null || r4 === void 0 ? void 0 : r4.length) && (s3 = Object.keys(s3).reduce(function(e2, t5) {
          var n6, r5, a3, o3, i3 = s3[t5];
          if (!Array.isArray(i3))
            return m(m({}, e2), ((n6 = {})[t5] = i3, n6));
          var d3 = (o3 = l3.schema.repeaterItems) === null || o3 === void 0 ? void 0 : o3.find(function(e3) {
            return e3.name === t5;
          });
          if (!d3)
            return m(m({}, e2), ((r5 = {})[t5] = i3, r5));
          var u3 = i3.map(function(e3) {
            return { id: v4_default(), type: d3.itemType, props: m({}, e3) };
          });
          return m(m({}, e2), ((a3 = {})[t5] = u3, a3));
        }, {})), (a2 = l3.schema.sideEditProps) === null || a2 === void 0 ? void 0 : a2.length) {
          var d2 = l3.schema.sideEditProps.reduce(function(e2, t5) {
            return t5.groupName || t5.type !== "BOOLEAN" || (e2[t5.name] = !!s3[t5.name]), t5.groupName && t5.props.filter(function(e3) {
              return e3.type === "BOOLEAN";
            }).forEach(function(t6) {
              e2[t6.name] = !!s3[t6.name];
            }), e2;
          }, {});
          s3 = m(m({}, s3), d2);
        }
        var m3 = { id: i2, type: t4, props: s3 }, p4 = [];
        p4 = V2 === "FIRST" ? b([m3], y(o2), false) : o2.reduce(function(t5, n6) {
          return n6.id === V2 ? b(b([], y(t5), false), [n6, m3], false) : b(b([], y(t5), false), [n6], false);
        }, []), u2(p4), j2(""), H2(null), Y2({ blockId: i2, itemId: "", repeaterPropName: "" });
      }
    };
    ...
    return function() {
      var n5 = o2.map(function(n6) {
        var r4;
        return n6.id !== e2 ? n6 : m(m({}, n6), { props: m(m({}, n6.props), (r4 = {}, r4[O2.repeaterPropName] = n6.props[O2.repeaterPropName].filter(function(e3) {
          return e3.id !== t4;
        }), r4)) });
      });
      Y2({ blockId: O2.blockId, itemId: "", repeaterPropName: "" }), u2(n5);
    };
  }, handleSortItem: function(t4, n5, r4) {
    return function(a2) {
      a2.preventDefault();
      var i2 = b([], y(o2), false), l3 = i2.find(function(e2) {
        return e2.id === t4;
      });
      if (l3) {
        var c2 = l3.props[O2.repeaterPropName];
        if (c2 && Array.isArray(c2)) {
          var s3 = c2.findIndex(function(e2) {
            return e2.id === n5;
          });
          if (s3 !== -1) {
            if (r4 === E.SortDirection.Up && s3 > 0) {
              var d2 = c2[s3 - 1];
              c2[s3 - 1] = c2[s3], c2[s3] = d2;
            }
            if (r4 === E.SortDirection.Down && s3 < c2.length - 1) {
              d2 = c2[s3 + 1];
              c2[s3 + 1] = c2[s3], c2[s3] = d2;
            }
            u2(i2);
    ...
    if (n5) {
      ...
      ((t4 = n5.schema.repeaterItems) === null || t4 === void 0 ? void 0 : t4.length) && (r4 = Object.keys(r4).reduce(function(e3, t5) {
        var a2, o3, i2, l3, s3 = r4[t5];
        if (!Array.isArray(s3))
          return m(m({}, e3), ((a2 = {})[t5] = s3, a2));
        var d2 = (l3 = n5.schema.repeaterItems) === null || l3 === void 0 ? void 0 : l3.find(function(e4) {
          return e4.name === t5;
        });
        if (!d2)
          return m(m({}, e3), ((o3 = {})[t5] = s3, o3));
        var u3 = s3.map(function(e4) {
          return { id: v4_default(), type: d2.itemType, props: m({}, e4) };
        });
        return m(m({}, e3), ((i2 = {})[t5] = u3, i2));
      }, {})), H2({ id: "PREVIEW_NEW", type: e2, props: r4 });
    }
  }, handleChangePageValue: m2, playgroundSelectedItem: v3, sidebarOpen: l2 })));
};
var Kr = function() {
  var t3 = (0, import_react5.useContext)(B), n4 = t3.bricks, r3 = t3.pageTypes, a2 = t3.responsiveBreakpoints, o2 = t3.enableAutoSave, i2 = (0, import_react5.useContext)(Zt).currentPage, l2 = y((0, import_react5.useState)(Te), 2), s2 = l2[0], d2 = l2[1], u2 = y((0, import_react5.useState)(true), 2), m2 = u2[0], p3 = u2[1], f3 = y((0, import_react5.useState)(a2[a2.length - 1]), 2), h3 = f3[0], v3 = f3[1], x2 = y(function(t4, n5) {
    var r4 = y((0, import_react5.useState)(function() {
  ...
  }(false, "rb_autosave"), 2), y3 = x2[0], w3 = x2[1], k3 = Le(i2.pageId, i2.language).data, C = function(e2, t4) {
    ...
    }, onError: nr({ topic: "page", getLimitExceededError: function(e3, t5) {
...
var ea = function() {
  var e2 = localStorage.getItem(ye), t3 = Ie("t");
...
var ta = function() {
  var e2 = (0, import_react5.useContext)(B).appId, t3 = Tr(e2).data, n4 = $r(E.DeployEnvironment.Production), r3 = $r(E.DeployEnvironment.Staging), a2 = ea().data;
  return me.createElement("div", { className: "mt-20 py-16 px-20 max-w-3xl bg-white mx-auto" }, me.createElement("h2", { className: "text-lg font-semibold text-gray-700 mb-6 flex items-center" }, me.createElement("div", { className: "mr-2" }, t3 == null ? void 0 : t3.appName), t3 && me.createElement("div", { className: "inline-block text-white text-xs font-bold uppercase tracking-wide py-px px-2 rounded-sm", style: { backgroundColor: t3.plan.toLowerCase() === "enterprise" ? "#8a5df5" : t3.plan.toLowerCase() === "pro" ? "#3c81f6" : t3.plan.toLowerCase() === "essential" ? "#13b981" : "#84cc18" } }, t3.plan)), me.createElement("div", { className: "flex space-x-4" }, me.createElement("button", { type: "button", disabled: !((t3 == null ? void 0 : t3.deployHookStagingUrl) && (t3 == null ? void 0 : t3.canDeployStaging)), onClick: function() {
    r3.mutate();
  }, className: "flex-1 bg-blue-500 hover:bg-blue-600 hover:shadow-lg text-white font-semibold py-3 px-4 rounded disabled:opacity-75 disabled:cursor-not-allowed" }, "Deploy to Staging"), me.createElement("button", { type: "button", disabled: !((t3 == null ? void 0 : t3.deployHookUrl) && (t3 == null ? void 0 : t3.canDeploy)), onClick: function() {
    n4.mutate();
  }, className: "flex-1 bg-pink-500 hover:bg-pink-600 hover:shadow-lg text-white font-semibold py-2 px-4 rounded disabled:opacity-75 disabled:cursor-not-allowed" }, "Deploy to Production")), (t3 == null ? void 0 : t3.isAdmin) && a2 && me.createElement("div", { className: "py-6" }, me.createElement("h2", { className: "mt-6 text-lg font-semibold text-gray-700 mb-4 flex items-center" }, "App Settings"), me.createElement("p", { className: "mb-6 text-gray-500" }, "Shortcuts to reach the React Bricks Dashboard for this app."), me.createElement("div", null, me.createElement("div", { className: "flex space-x-4" }, me.createElement("a", { href: "https://dashboard.reactbricks.com/apps/".concat(e2, "/plan?t=").concat(a2), target: "_blank", className: "flex-1 py-2 px-4 border rounded mb-4 hover:bg-pink-100 hover:border-pink-400 hover:shadow-lg transition-all" }, me.createElement("h3", { className: "flex items-center" }, me.createElement(FiShoppingCart, { className: "text-lg text-pink-500 mr-2" }), me.createElement("span", null, "Upgrade or change plan"))), me.createElement("a", { href: "https://dashboard.reactbricks.com/apps/".concat(e2, "/users?t=").concat(a2), target: "_blank", className: "flex-1 py-2 px-4 border rounded mb-4 hover:bg-pink-100 hover:border-pink-400 hover:shadow-lg transition-all" }, me.createElement("h3", { className: "flex items-center" }, me.createElement(FiUsers, { className: "text-lg text-pink-500 mr-2" }), me.createElement("span", null, "Users")))), me.createElement("div", { className: "flex space-x-4" }, me.createElement("a", { href: "https://dashboard.reactbricks.com/apps/".concat(e2, "/web-hooks?t=").concat(a2), target: "_blank", className: "flex-1 py-2 px-4 border rounded mb-4 hover:bg-pink-100 hover:border-pink-400 hover:shadow-lg transition-all" }, me.createElement("h3", { className: "flex items-center" }, me.createElement(FiCpu, { className: "text-lg text-pink-500 mr-2" }), me.createElement("span", null, "Deploy hooks"))), me.createElement("a", { href: "https://dashboard.reactbricks.com/apps/".concat(e2, "/languages?t=").concat(a2), target: "_blank", className: "flex-1 py-2 px-4 border rounded mb-4 hover:bg-pink-100 hover:border-pink-400 hover:shadow-lg transition-all" }, me.createElement("h3", { className: "flex items-center" }, me.createElement(FiGlobe, { className: "text-lg text-pink-500 mr-2" }), me.createElement("span", null, "Languages (i18n)")))), me.createElement("div", { className: "flex space-x-4" }, me.createElement("a", { href: "https://dashboard.reactbricks.com/apps/".concat(e2, "/history?t=").concat(a2), target: "_blank", className: "flex-1 py-2 px-4 border rounded mb-4 hover:bg-pink-100 hover:border-pink-400 hover:shadow-lg transition-all" }, me.createElement("h3", { className: "flex items-center" }, me.createElement(FiClock, { className: "text-lg text-pink-500 mr-2" }), me.createElement("span", null, "Change history"))), me.createElement("a", { href: "https://dashboard.reactbricks.com/apps/".concat(e2, "/backup-restore?t=").concat(a2), target: "_blank", className: "flex-1 py-2 px-4 border rounded mb-4 hover:bg-pink-100 hover:border-pink-400 hover:shadow-lg transition-all" }, me.createElement("h3", { className: "flex items-center" }, me.createElement(FiUmbrella, { className: "text-lg text-pink-500 mr-2" }), me.createElement("span", null, "Backup and restore")))))));
};
var na = function(t3) {
  var n4 = t3.children;
  t3.styles, t3.stylesheets;
  var r3 = t3.head, a2 = f(t3, ["children", "styles", "stylesheets", "head"]), o2 = y((0, import_react5.useState)(null), 2), i2 = o2[0], l2 = o2[1], s2 = y((0, import_react5.useState)(null), 2), u2 = s2[0], m2 = s2[1], p3 = y((0, import_react5.useState)(false), 2), g3 = p3[0], f3 = p3[1], h3 = (0, import_react5.useRef)(null);
  (0, import_react5.useEffect)(function() {
    if (g3) {
  ...
  return import_react5.default.createElement("iframe", m({ ref: h3, srcDoc: "<!DOCTYPE html>", title: "content" }, a2, { onLoad: function(e2) {
...
var ra = function() {
  ...
  }(), t3 = useQueryClient(), n4 = (0, import_react5.useContext)(B), r3 = n4.appId, a2 = n4.navigate, o2 = n4.editorPath, i2 = n4.loginPath;
  return { loginUser: function(t4, n5) {
    return g(void 0, void 0, void 0, function() {
      ...
      return h(this, function(c2) {
        switch (c2.label) {
          ...
          case 2:
            return (l2 = c2.sent()) && l2.authToken ? (localStorage.setItem(ye, l2.authToken), a2(o2), [2, l2]) : [2, null];
          case 3:
    ...
    localStorage.removeItem(ye), t3.clear(), a2(i2);
  } };
};
var aa = function(e2) {
  var t3 = e2.dismissPopup, n4 = ea().data;
  return me.createElement("div", { className: "absolute bg-white border border-pink-400 shadow-lg", style: { top: 33, right: 0, width: 300, padding: "1rem 1.5rem 1rem" } }, me.createElement("p", { className: "font-semibold mb-2 text-pink-700" }, "Email not verified"), me.createElement("p", { className: "text-sm text-gray-500 mb-3" }, "Your email address hasn't been verified, yet. Some actions may be limited by this."), me.createElement("div", { className: "flex space-x-4" }, me.createElement("button", { type: "button", className: "px-6 py-2 bg-blue-500 hover:bg-blue-600 hover:shadow-lg text-sm leading-none text-white font-semibold rounded disabled:opacity-75 disabled:cursor-not-allowed", onClick: function() {
    window.open("https://dashboard.reactbricks.com/verify-email?t=".concat(n4));
  } }, "Verify now"), me.createElement("button", { type: "button", className: "px-6 py-2 bg-gray-100 hover:bg-gray-200 text-gray-500 hover:text-gray-700 hover:shadow-lg text-sm leading-none font-semibold rounded disabled:opacity-75 disabled:cursor-not-allowed", onClick: t3 }, "Postpone")));
};
var oa = function(t3) {
  var n4 = t3.renderMenu, r3 = t3.designSystemTitle, a2 = ra().logoutUser, o2 = (0, import_react5.useContext)(B), i2 = o2.appId, l2 = o2.logo, c2 = Tr(i2).data, s2 = y((0, import_react5.useState)(false), 2), d2 = s2[0], u2 = s2[1];
  return me.createElement("div", { className: "fixed top-0 inset-x-0 flex bg-white shadow z-50 h-10" }, me.createElement("div", { className: "w-full mx-auto px-4 flex justify-between items-center relative" }, l2 ? me.createElement("img", { src: l2, alt: "React Bricks", className: "h-6" }) : me.createElement(rr, { className: "h-6" }), r3 ? me.createElement("div", { className: "flex-1 flex justify-center" }, r3) : null, c2 && c2.email && n4 && n4(), c2 && c2.email && me.createElement("div", { className: "flex flex-row items-center text-xs leading-none text-gray-600 uppercase" }, c2.avatarUrl && me.createElement("img", { className: "w-8 h-8 border rounded-full mr-2", src: c2.avatarUrl, alt: "".concat(c2.firstName, " ").concat(c2.lastName) }), me.createElement("div", { className: "mr-2" }, c2.firstName, " ", c2.lastName), me.createElement("button", { className: "hover:text-gray-900", onClick: function() {
    return a2();
  } }, me.createElement(FiPower, null))), c2 && !c2.isVerified && !d2 && me.createElement(aa, { dismissPopup: function() {
    return u2(true);
  } })));
};
var ia = function(e2) {
  var t3 = e2.isPublicDesignSystem, n4 = t3 !== void 0 && t3, r3 = e2.designSystemTitle, a2 = (0, import_react5.useContext)(B), o2 = a2.renderLocalLink, i2 = a2.editorPath, l2 = a2.playgroundPath, c2 = a2.appSettingsPath, s2 = a2.appId;
  if (n4)
    return import_react5.default.createElement(oa, { designSystemTitle: r3 });
  var d2 = Tr(s2).data;
  return import_react5.default.createElement(oa, { renderMenu: function() {
    var e3 = function(e4) {
...
var ca = function(e2) {
  var t3 = e2.isLogin, n4 = t3 !== void 0 && t3, r3 = (0, import_react5.useContext)(B), a2 = r3.navigate, o2 = r3.loginPath, i2 = r3.editorPath, l2 = r3.appId, c2 = Tr(l2), s2 = c2.data, d2 = c2.isError, u2 = (0, import_react5.useContext)(Zt).setCurrentPage;
  return (0, import_react5.useEffect)(function() {
    var e3 = localStorage.getItem(ye), t4 = Ie("t");
    e3 || t4 || n4 || a2(o2);
  }, []), (0, import_react5.useEffect)(function() {
    if (d2 && (n4 || a2(o2)), s2) {
      var e3 = Ie("p"), t4 = Ie("l"), r4 = localStorage && localStorage.getItem("rb_p"), l3 = localStorage && localStorage.getItem("rb_l");
...
var sa = function(t3) {
  var n4 = t3.isLogin, r3 = n4 !== void 0 && n4, a2 = t3.isPublicDesignSystem, o2 = a2 !== void 0 && a2, i2 = t3.designSystemTitle, l2 = i2 === void 0 ? "Bricks documentation" : i2, c2 = t3.children, s2 = y((0, import_react5.useState)({ pageId: "" }), 2), d2 = s2[0], u2 = s2[1], m2 = y((0, import_react5.useState)(false), 2), p3 = m2[0], f3 = m2[1], h3 = y((0, import_react5.useState)(false), 2), b3 = h3[0], v3 = h3[1], x2 = y((0, import_react5.useState)(false), 2), y3 = x2[0], w3 = x2[1], k3 = (0, import_react5.useContext)(B).appRootElement;
  (0, import_react5.useEffect)(function() {
    w3(true), localStorage.removeItem("react-bricks-token"), k3 && import_react_modal.default.setAppElement(k3), k3 || console.error("You should provide the appRootElement prop on Reactbricks, with a string selector or HTML element corresponding to the root element of the React application.");
  }, []), (0, import_react5.useEffect)(function() {
  ...
  return me.createElement(na, { id: "rb-admin-frame", style: { width: "100%", height: "100vh", border: "none" }, head: me.createElement("style", { dangerouslySetInnerHTML: { __html: `@import url("https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap");
...
</style>` } }), key: y3 ? "client" : "server" }, me.createElement(la, null), me.createElement(Zt.Provider, { value: { isAdmin: true, currentPage: d2, setCurrentPage: u2, previewMode: p3, setPreviewMode: f3, sidebarCollapsed: b3, setSidebarCollapsed: v3, getStyles: function() {
    return document.querySelectorAll("style");
  }, getStylesheets: function() {
    return document.querySelectorAll("link[rel=stylesheet]");
  } } }, me.createElement("div", { className: "font-admin antialiased" }, !o2 && me.createElement(ca, { isLogin: r3 }), me.createElement(ia, { isPublicDesignSystem: o2, designSystemTitle: l2 }), c2)));
};
var da = function() {
  var t3 = y((0, import_react5.useState)(""), 2), n4 = t3[0], r3 = t3[1], a2 = y((0, import_react5.useState)(""), 2), o2 = a2[0], i2 = a2[1], l2 = y((0, import_react5.useState)(false), 2), c2 = l2[0], s2 = l2[1], d2 = ra().loginUser;
  return me.createElement("div", { className: "flex flex-col h-screen justify-center items-center px-4 sm:px-0" }, me.createElement("div", { className: "flex bg-white rounded shadow-lg w-full sm:w-3/4 lg:w-1/2 sm:mx-0", style: { height: 500 } }, me.createElement("div", { className: "flex flex-col w-full md:w-1/2 p-4" }, me.createElement("div", { className: "flex flex-col flex-1 justify-center mb-8" }, me.createElement("h1", { className: "text-4xl text-center font-thin" }, "Welcome"), me.createElement("div", { className: "w-full mt-4" }, me.createElement("form", { onSubmit: function(e2) {
    return g(void 0, void 0, void 0, function() {
      return h(this, function(t4) {
        switch (t4.label) {
          case 0:
          ...
          case 1:
            return t4.sent() || s2(true), [2];
        }
      });
    });
  }, className: "form-horizontal w-3/4 mx-auto" }, me.createElement("div", { className: "flex flex-col mt-4" }, me.createElement(On, { id: "email", type: "email", value: n4, onChange: function(e2) {
    return r3(e2.target.value);
  }, name: "email", placeholder: "Email" })), me.createElement("div", { className: "flex flex-col mt-4" }, me.createElement(On, { id: "password", type: "password", value: o2, onChange: function(e2) {
    return i2(e2.target.value);
  }, name: "password", required: true, placeholder: "Password" })), me.createElement("div", { className: "flex flex-col mt-8" }, me.createElement("button", { type: "submit", className: "bg-pink-500 hover:bg-pink-700 text-white text-sm font-semibold py-2 px-4 rounded" }, "Login"), c2 && me.createElement("div", { className: "text-red-500 mt-4 text-center" }, "Wrong username or password"))), me.createElement("div", { className: "text-center mt-4" }, me.createElement("a", { className: "no-underline hover:underline text-blue-dark text-xs", href: "https://dashboard.reactbricks.com/forgot-password", target: "_blank", rel: "noopener noreferrer" }, "Forgot Your Password?"))))), me.createElement("div", { className: "hidden md:block md:w-1/2 rounded-r-lg", style: { backgroundImage: "url(https://images.unsplash.com/photo-1461418559055-6f020c5a91e7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1601&q=80)", backgroundSize: "cover", backgroundPosition: "center center" } })));
};
N.prototype.renderAdmin = function(e2) {
  var t3 = e2.renderBlock, r3 = e2.placeholder, o2 = e2.renderPlaceholder, l2 = e2.propName, s2 = e2.multiline, u2 = s2 !== void 0 && s2, m2 = withHistory(withReact(createEditor()));
  u2 || (m2 = Gt(m2));
  var p3 = (0, import_react5.useMemo)(function() {
    return m2;
  }, []), g3 = (0, import_react5.useContext)(Zt), f3 = g3.isAdmin, h3 = g3.previewMode, b3 = (0, import_react5.useContext)(k), v3 = b3.values, x2 = b3.onChange, y3 = (0, import_react5.useContext)(T), w3 = y3.triggerTextRefreshBlockId, k3 = y3.setTriggerTextRefreshBlockId, E3 = h3 || !f3, C = v3[l2];
  (0, import_react5.useEffect)(function() {
    setTimeout(function() {
      return k3("");
    }, 1);
  ...
  var A3 = (0, import_react5.useCallback)(function(e3) {
    ...
    return me.cloneElement(t3({ children: n4, element: r4, attributes: a2 }), a2);
    ...
    n4.style;
    var r4 = f(n4, ["style"]);
    return me.cloneElement(o2({ children: t4 }), r4);
  }, [v3]);
  if (E3) {
    var S2 = C;
    return C ? (typeof C == "string" && (S2 = w.deserialize(C)), me.createElement(me.Fragment, null, S2.map(function(e3, n4) {
      return me.createElement(me.Fragment, { key: n4 }, Qt(e3, [], t3));
    }))) : null;
  }
  var I2 = C || _t;
  typeof I2 == "string" && (I2 = w.deserialize(I2));
  var L2 = {};
  return o2 && (L2 = { renderPlaceholder: N2 }), me.createElement(Slate, { editor: p3, value: I2, onChange: function(e3) {
    v3[l2] !== e3 && x2(l2, e3);
  } }, me.createElement(Editable, m({ renderElement: A3, placeholder: r3 }, L2)));
}, Z.prototype.renderAdmin = function(e2) {
  var t3 = [];
  return e2.allowedFeatures && e2.allowedFeatures.length > 0 && (t3 = e2.allowedFeatures.map(function(t4) {
    var n4 = Pn[t4], r3 = n4.newPlugin, a2 = n4.renderLeaf, o2 = n4.renderElement, i2 = n4.renderItemElement, l2 = n4.renderLink, s2 = {}, d2 = e2[a2], u2 = e2[o2], m2 = e2[i2], p3 = e2[l2];
    return a2 && d2 && (s2.renderLeaf = d2), o2 && u2 && (s2.renderElement = u2), i2 && m2 && (s2.renderItemElement = m2), l2 && p3 && (s2.renderElement = function(e3) {
      var t5 = e3.attributes, n5 = e3.children, r4 = e3.element;
      return p3({ attributes: t5, children: n5, element: r4, href: r4.url });
    }), m(m({}, r3), s2);
  })), import_react5.default.createElement(tn2, { renderBlock: e2.renderBlock, placeholder: e2.placeholder, propName: e2.propName, plugins: t3, multiline: e2.multiline });
}, A.prototype.renderAdmin = tn2, ne.prototype.renderAdmin = function(e2) {
  var t3 = (0, import_react5.useContext)(Zt), r3 = t3.isAdmin, a2 = t3.previewMode, o2 = (0, import_react5.useContext)(k), i2 = o2.values, l2 = o2.onChange, s2 = a2 || !r3, d2 = i2[e2.propName];
  return s2 ? me.createElement($n, m({}, e2, { source: d2 })) : me.createElement(Zn, m({}, e2, { source: d2, onChange: function(t4) {
    l2(e2.propName, t4);
  } }));
}, ae.prototype.renderAdmin = function(e2) {
  var t3 = e2.propName, r3 = e2.itemProps, o2 = r3 === void 0 ? {} : r3, i2 = e2.renderWrapper, l2 = e2.renderItemWrapper, s2 = (0, import_react5.useContext)(B).bricks, d2 = (0, import_react5.useContext)(k), u2 = d2.values, m2 = d2.parentId, p3 = d2.parentType, f3 = d2.handleChange, h3 = d2.handleAddItem, b3 = d2.contentRef, v3 = (0, import_react5.useContext)(T), x2 = v3.focused, y3 = v3.setFocused, w3 = v3.setAddAfterBlockId, k3 = (0, import_react5.useContext)(Zt).previewMode, E3 = u2[t3];
  if ((0, import_react5.useEffect)(function() {
    var e3, n4, r4 = (n4 = (e3 = s2[p3].schema) === null || e3 === void 0 ? void 0 : e3.repeaterItems) === null || n4 === void 0 ? void 0 : n4.find(function(e4) {
      return e4.name === t3;
    });
    r4 && r4.min && (!E3 || E3.length < r4.min) && h3 && h3(m2, t3, r4.itemType)();
  }, [m2, t3, E3]), !E3 || E3.length === 0)
    return null;
  var C = me.createElement(me.Fragment, null, E3.map(function(e3, r4) {
    var a2 = s2[e3.type];
    if (a2) {
      var i3 = a2.schema.sideEditProps ? a2.schema.sideEditProps.reduce(function(t4, n4) {
        ...
        return n4.groupName ? a3 = n4.props.map(function(t5) {
          ...
          return m(m({}, e4), t5);
        }, {}) : ((r5 = {})[n4.name] = e3.props[n4.name], a3 = r5), m(m({}, t4), a3);
      }, {}) : {}, d3 = m(m(m({}, i3), o2), { key: e3.id, index: r4, style: { outline: e3.id !== x2.itemId || k3 ? "none" : "2px solid #fb83a3" }, onClick: function(n4) {
        n4.stopPropagation(), y3({ blockId: m2, itemId: e3.id, repeaterPropName: t3 }), w3("");
      }, onFocus: function(n4) {
        n4.stopPropagation(), setTimeout(function() {
          y3({ blockId: m2, itemId: e3.id, repeaterPropName: t3 }), w3("");
        }, 0);
      }, onChange: function() {
      } }), u3 = me.createElement(k.Provider, { key: e3.id, value: { onChange: f3(e3.id, m2, t3), values: e3.props, blockId: e3.id, parentId: m2, contentRef: b3, parentType: p3, handleChange: f3 } }, me.createElement(a2, m({}, d3)));
      return l2 ? l2(u3, r4, E3.length) : u3;
    }
  }));
  return i2 ? i2(C) : C;
}, z.prototype.renderAdmin = fn4, re.prototype.renderAdmin = function(t3) {
  var r3 = t3.allowedExtensions, a2 = r3 === void 0 ? [] : r3, o2 = t3.propName, i2 = t3.renderBlock, l2 = (0, import_react5.useContext)(k), c2 = l2.values, s2 = l2.onChange, d2 = (0, import_react5.useContext)(Zt), u2 = d2.isAdmin, m2 = d2.previewMode, p3 = y((0, import_react5.useState)(false), 2), g3 = p3[0], f3 = p3[1], h3 = c2[o2], b3 = (0, import_react5.useCallback)(function(e2) {
  ...
  return m2 || !u2 ? i2(h3) : import_react5.default.createElement(import_react5.default.Fragment, null, b3(h3), g3 && import_react5.default.createElement(er, { setModalOpen: f3, modalOpen: g3, onChange: function(e2) {
    s2(o2, e2);
  }, allowedExtensions: a2, file: h3 }));
}, oe.prototype.useAdmin = function() {
  var e2 = (0, import_react5.useContext)(Zt);
  return { isAdmin: e2.isAdmin, previewMode: e2.previewMode, currentPage: e2.currentPage };
}, ie.prototype.useAdmin = function(e2) {
  var t3 = (0, import_react5.useContext)(Zt), r3 = t3.isAdmin, a2 = t3.previewMode, o2 = (0, import_react5.useContext)(k), i2 = o2.values, l2 = o2.onChange, c2 = a2 || !r3;
  return [i2[e2], function(t4) {
    return l2(e2, t4);
  }, c2];
}, K.prototype.adminConstructor = kn, R.prototype.adminConstructor = rn2, Object.keys(X).forEach(function(e2) {
  Dn[e2] && Object.assign(X[e2], Dn[e2]);
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-TUSY52DF.js.map
