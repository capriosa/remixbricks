...
// node_modules/react-bricks/react-bricks-c4223dd5.esm.js
init_react();
...
function p(e2, t2) {
  ...
  s(e2, t2), e2.prototype = t2 === null ? Object.create(t2) : (n2.prototype = t2.prototype, new n2());
}
var m = function() {
...
function h(e2, t2) {
  var n2, r2, a2, o2, i = { label: 0, sent: function() {
    if (1 & a2[0])
      throw a2[1];
    return a2[1];
  }, trys: [], ops: [] };
  return o2 = { next: l(0), throw: l(1), return: l(2) }, typeof Symbol == "function" && (o2[Symbol.iterator] = function() {
    return this;
  }), o2;
  function l(o3) {
    return function(l2) {
          ...
          try {
            ...
            switch (r2 = 0, a2 && (o4 = [2 & o4[0], a2.value]), o4[0]) {
              ...
              case 1:
                ...
                break;
              case 4:
                return i.label++, { value: o4[1], done: false };
              case 5:
                i.label++, r2 = o4[1], o4 = [0];
                continue;
              case 7:
                o4 = i.ops.pop(), i.trys.pop();
                continue;
              default:
                if (!(a2 = i.trys, (a2 = a2.length > 0 && a2[a2.length - 1]) || o4[0] !== 6 && o4[0] !== 2)) {
                  i = 0;
                  continue;
                }
                ...
                if (o4[0] === 6 && i.label < a2[1]) {
                  i.label = a2[1], a2 = o4;
                  break;
                }
                if (a2 && i.label < a2[2]) {
                  i.label = a2[2], i.ops.push(o4);
                  break;
                }
...
var E;
var k = e.createContext({ values: {}, onChange: function() {
...
!function(e2) {
  var t2, n2, r2, a2, o2, i, l, c, u, d2;
  (t2 = e2.SideEditPropType || (e2.SideEditPropType = {})).Text = "TEXT", t2.Textarea = "TEXTAREA", t2.Number = "NUMBER", t2.Date = "DATE", t2.Range = "RANGE", t2.Boolean = "BOOLEAN", t2.Select = "SELECT", t2.Image = "IMAGE", t2.Custom = "CUSTOM", (n2 = e2.OptionsDisplay || (e2.OptionsDisplay = {})).Select = "SELECT", n2.Radio = "RADIO", n2.Color = "COLOR", (r2 = e2.RichTextFeatures || (e2.RichTextFeatures = {})).Bold = "BOLD", r2.Italic = "ITALIC", r2.Code = "CODE", r2.Highlight = "HIGHLIGHT", r2.Link = "LINK", r2.UnorderedList = "UL", r2.OrderedList = "OL", r2.Heading1 = "H1", r2.Heading2 = "H2", r2.Heading3 = "H3", r2.Heading4 = "H4", r2.Heading5 = "H5", r2.Heading6 = "H6", r2.Quote = "QUOTE", (a2 = e2.SortDirection || (e2.SortDirection = {})).Up = "UP", a2.Down = "DOWN", (o2 = e2.PageStatus || (e2.PageStatus = {})).Draft = "DRAFT", o2.Published = "PUBLISHED", (i = e2.DeployEnvironment || (e2.DeployEnvironment = {})).Staging = "STAGING", i.Production = "PRODUCTION", (l = e2.PlaygroundSelectedItemType || (e2.PlaygroundSelectedItemType = {})).Block = "BLOCK", l.Page = "PAGE", (c = e2.DeviceType || (e2.DeviceType = {})).Desktop = "DESKTOP", c.Tablet = "TABLET", c.Phone = "PHONE", (u = e2.Tab || (e2.Tab = {})).Block = "BLOCK", u.Item = "ITEM", u.PageSettings = "PAGE-SETTINGS", u.Document = "DOCUMENT", u.Stories = "STORIES", (d2 = e2.ClickToEditSide || (e2.ClickToEditSide = {})).BottomRight = "BOTTOM-RIGHT", d2.BottomLeft = "BOTTOM-LEFT", d2.TopRight = "TOP-RIGHT", d2.TopLeft = "TOP-LEFT";
}(E || (E = {}));
var T = e.createContext({ focused: { blockId: "", itemId: "", repeaterPropName: "" }, setFocused: function() {
}, triggerTextRefreshBlockId: "", setTriggerTextRefreshBlockId: function() {
}, setAddAfterBlockId: function() {
}, pageValues: { id: "", type: "", name: "", slug: "", meta: {}, authorId: "", author: { id: "", email: "", firstName: "", lastName: "" }, invalidBlocksTypes: [], status: E.PageStatus.Draft, isLocked: false, tags: [], createdAt: "", publishedAt: "", language: "", translations: [] }, handleChangePageValue: function() {
} });
var x = function(e2) {
  return function(e3) {
    var t2, n2;
...
function P(e2) {
  return x(e2) ? e2.text : e2.children && Array.isArray(e2.children) ? e2.children.map(P).join("") : "";
}
function S(e2) {
...
var I;
var w = { serialize: function(e2) {
  return Array.isArray(e2) && e2.length > 0 ? e2.map(P).join("\n") : "";
...
var L = function(t2, n2, r2) {
  ...
  if (a2) {
    var o2 = C(t2, n2);
    return a2.renderElement({ children: o2.map(function(t3, n3) {
      return e.createElement(e.Fragment, { key: n3 }, a2.renderItemElement({ children: t3 }));
    }), element: { url: t2.url } });
  }
  var i = C(t2, n2, r2), l = n2.filter(function(e2) {
...
var C = function(t2, n2, r2) {
  var a2;
  return (a2 = t2.children) === null || a2 === void 0 ? void 0 : a2.map(function(t3, a3) {
    return e.createElement(e.Fragment, { key: a3 }, L(t3, n2, r2));
  });
};
var N = function(t2) {
  var r2, a2, o2 = t2.renderBlock, i = t2.placeholder, l = t2.renderPlaceholder, c = t2.propName, u = t2.multiline, d2 = u !== void 0 && u, s2 = (0, import_react9.useContext)(k).values[c];
  if ((r2 = N.prototype) === null || r2 === void 0 ? void 0 : r2.renderAdmin)
    return (a2 = N.prototype) === null || a2 === void 0 ? void 0 : a2.renderAdmin({ renderBlock: o2, placeholder: i, renderPlaceholder: l, propName: c, multiline: d2 });
  var p2 = s2;
  return s2 ? (typeof s2 == "string" && (p2 = w.deserialize(s2)), e.createElement(e.Fragment, null, p2.map(function(t3, n2) {
    return e.createElement(e.Fragment, { key: n2 }, L(t3, [], o2));
  }))) : null;
};
var A = function(t2) {
  var r2, a2, o2 = t2.renderBlock, i = t2.placeholder, l = t2.renderPlaceholder, c = t2.propName, u = t2.plugins, d2 = u === void 0 ? [] : u, s2 = t2.multiline, p2 = s2 === void 0 || s2, m2 = (0, import_react9.useContext)(k).values[c];
  if ((r2 = A.prototype) === null || r2 === void 0 ? void 0 : r2.renderAdmin)
    return (a2 = A.prototype) === null || a2 === void 0 ? void 0 : a2.renderAdmin({ renderBlock: o2, placeholder: i, renderPlaceholder: l, propName: c, plugins: d2, multiline: p2 });
  var f2 = m2;
  return m2 ? (typeof m2 == "string" && (f2 = w.deserialize(m2)), e.createElement(e.Fragment, null, f2.map(function(t3, n2) {
    return e.createElement(e.Fragment, { key: n2 }, L(t3, d2, o2));
  }))) : null;
};
var B = e.createContext({ appId: "", apiKey: "", bricks: {}, pageTypes: [], logo: "", contentClassName: "", renderLocalLink: function(t2) {
  var n2 = t2.href, r2 = t2.children;
  return e.createElement("a", { href: n2 }, r2);
}, navigate: function() {
}, loginPath: "", editorPath: "", playgroundPath: "", appSettingsPath: "", previewPath: "", useCssInJs: false, appRootElement: "", clickToEditSide: E.ClickToEditSide.BottomRight, responsiveBreakpoints: [], enableAutoSave: true, disableSaveIfInvalidProps: false, enablePreview: true });
var R = function(e2) {
  var t2, n2;
  return ((t2 = R.prototype) === null || t2 === void 0 ? void 0 : t2.adminConstructor) ? (n2 = R.prototype) === null || n2 === void 0 ? void 0 : n2.adminConstructor(e2) : { type: "Mark", name: e2.name, label: e2.label || e2.name[0].toUpperCase() + e2.name.slice(1), hotKey: e2.hotKey, renderLeaf: e2.render, toggle: function(e3) {
  } };
};
var D = R({ name: "bold", hotKey: "mod+b", render: function(t2) {
  return e.createElement("strong", null, t2.children);
} });
var O = R({ name: "italic", hotKey: "mod+i", render: function(t2) {
  return e.createElement("em", null, t2.children);
} });
var F = R({ name: "code", hotKey: "mod+`", render: function(t2) {
...
var H = R({ name: "highlight", hotKey: "mod+h", render: function(t2) {
...
var z = function(t2) {
  var r2, a2, o2 = t2.href, i = t2.children, l = t2.target, c = t2.className, u = f(t2, ["href", "children", "target", "className"]), d2 = (0, import_react9.useContext)(B).renderLocalLink;
  if ((r2 = z.prototype) === null || r2 === void 0 ? void 0 : r2.renderAdmin)
    return (a2 = z.prototype) === null || a2 === void 0 ? void 0 : a2.renderAdmin(m({ href: o2, children: i, target: l, className: c }, u));
  var s2 = { href: o2 };
  return /^\/(?!\/)/.test(o2) ? d2 ? d2(m({ href: o2, target: l, children: i, className: c }, u)) : (d2 || console.warn("Local path found in Link, but no renderLocalLink function was provided. Rendering <a> as fallback"), e.createElement("a", m({}, s2, { target: l, className: c }, u), i)) : e.createElement("a", m({}, s2, { target: l, className: c }, u), i);
};
var j = { type: "Block", name: "link", label: "Link", isInline: true, renderElement: function(t2) {
  var n2 = t2.attributes, r2 = t2.children, a2 = t2.element;
  return e.createElement(z, m({}, n2, { href: a2.url }), r2);
}, toggle: function(e2) {
} };
var K = function(e2) {
  var t2, n2;
  return ((t2 = K.prototype) === null || t2 === void 0 ? void 0 : t2.adminConstructor) ? (n2 = K.prototype) === null || n2 === void 0 ? void 0 : n2.adminConstructor(e2) : { type: e2.itemName ? "List" : "Block", name: e2.name, isInline: e2.isInline, itemName: e2.itemName, label: e2.label || e2.name[0].toUpperCase() + e2.name.slice(1), hotKey: e2.hotKey, renderElement: e2.render, renderItemElement: e2.renderItem, toggle: function(e3, t3) {
  } };
};
var M = K({ name: "h1", hotKey: "mod+shift+1", render: function(t2) {
  return e.createElement("h1", null, t2.children);
} });
var U = K({ name: "h2", hotKey: "mod+shift+2", render: function(t2) {
  return e.createElement("h2", null, t2.children);
} });
var _ = K({ name: "h3", hotKey: "mod+shift+3", render: function(t2) {
  return e.createElement("h3", null, t2.children);
} });
var G = K({ name: "h4", hotKey: "mod+shift+4", render: function(t2) {
  return e.createElement("h4", null, t2.children);
} });
var W = K({ name: "h5", hotKey: "mod+shift+5", render: function(t2) {
  return e.createElement("h5", null, t2.children);
} });
var V = K({ name: "h6", hotKey: "mod+shift+6", render: function(t2) {
  return e.createElement("h6", null, t2.children);
} });
var q = K({ name: "quote", render: function(t2) {
  return e.createElement("blockquote", null, t2.children);
} });
var Q = K({ name: "ol", label: "Number list", itemName: "li", render: function(t2) {
...
var J = K({ name: "ul", label: "Bullet list", itemName: "li", render: function(t2) {
  return e.createElement("ul", { className: "list-disc" }, t2.children);
}, renderItem: function(t2) {
  return e.createElement("li", null, t2.children);
} });
var X = Object.freeze({ __proto__: null, bold: D, italic: O, code: F, highlight: H, link: j, heading1: M, heading2: U, heading3: _, heading4: G, heading5: W, heading6: V, quote: q, orderedList: Q, unorderedList: J });
var Y = ((I = {})[E.RichTextFeatures.Bold] = { newPlugin: D, renderLeaf: "renderBold" }, I[E.RichTextFeatures.Italic] = { newPlugin: O, renderLeaf: "renderBold" }, I[E.RichTextFeatures.Highlight] = { newPlugin: H, renderLeaf: "renderHighlight" }, I[E.RichTextFeatures.Code] = { newPlugin: F, renderLeaf: "renderCode" }, I[E.RichTextFeatures.Link] = { newPlugin: j, renderLink: "renderLink" }, I[E.RichTextFeatures.UnorderedList] = { newPlugin: J, renderElement: "renderUL", renderItemElement: "renderLI" }, I[E.RichTextFeatures.OrderedList] = { newPlugin: Q, renderElement: "renderOL", renderItemElement: "renderLI" }, I[E.RichTextFeatures.Heading1] = { newPlugin: M, renderElement: "renderH1" }, I[E.RichTextFeatures.Heading2] = { newPlugin: U, renderElement: "renderH2" }, I[E.RichTextFeatures.Heading3] = { newPlugin: _, renderElement: "renderH3" }, I[E.RichTextFeatures.Heading4] = { newPlugin: G, renderElement: "renderH4" }, I[E.RichTextFeatures.Heading5] = { newPlugin: W, renderElement: "renderH5" }, I[E.RichTextFeatures.Heading6] = { newPlugin: V, renderElement: "renderH6" }, I[E.RichTextFeatures.Quote] = { newPlugin: q, renderElement: "renderQuote" }, I);
var Z = function(e2) {
  var n2, r2;
  if ((n2 = Z.prototype) === null || n2 === void 0 ? void 0 : n2.renderAdmin)
    return (r2 = Z.prototype) === null || r2 === void 0 ? void 0 : r2.renderAdmin(e2);
  var a2 = [];
  return e2.allowedFeatures && e2.allowedFeatures.length > 0 && (a2 = e2.allowedFeatures.map(function(t2) {
    var n3 = Y[t2], r3 = n3.newPlugin, a3 = n3.renderLeaf, o2 = n3.renderElement, i = n3.renderItemElement, l = n3.renderLink, c = {}, u = e2[a3], d2 = e2[o2], s2 = e2[i], p2 = e2[l];
    return a3 && u && (c.renderLeaf = u), o2 && d2 && (c.renderElement = d2), i && s2 && (c.renderItemElement = s2), l && p2 && (c.renderElement = function(e3) {
      var t3 = e3.attributes, n4 = e3.children, r4 = e3.element;
      return p2({ attributes: t3, children: n4, element: r4, href: r4.url });
    }), m(m({}, r3), c);
  })), import_react9.default.createElement(A, { renderBlock: e2.renderBlock, placeholder: e2.placeholder, propName: e2.propName, plugins: a2, multiline: e2.multiline });
};
var $ = require_dist().default;
...
var te = function(t2) {
  t2.propName;
  var n2 = t2.source, r2 = t2.alt, a2 = t2.noLazyLoad, o2 = a2 !== void 0 && a2, i = t2.containerClassName, l = t2.containerStyle, c = l === void 0 ? {} : l, u = t2.imageClassName, d2 = t2.imageStyle, s2 = d2 === void 0 ? {} : d2, p2 = t2.noWrapper, g2 = p2 !== void 0 && p2, h2 = f(t2, ["propName", "source", "alt", "noLazyLoad", "containerClassName", "containerStyle", "imageClassName", "imageStyle", "noWrapper"]), v2 = (n2 == null ? void 0 : n2.alt) || r2;
  if (!n2)
    return null;
  var b2, E2, k2 = ee(n2.src, n2.seoName), T2 = ee(n2.placeholderSrc || "", n2.seoName), x2 = (b2 = n2.srcSet, E2 = n2.seoName, b2 ? E2 ? b2.split(",").map(function(e2) {
    var t3 = y(e2.trim().split(" "), 2), n3 = t3[0], r3 = t3[1];
    return n3 && r3 ? "".concat(ee(n3, E2), " ").concat(r3) : ee(e2, E2);
  }).join(", ") : b2 : "");
  return o2 ? e.createElement("div", { className: i, style: c }, e.createElement("img", m({ src: k2, srcSet: x2, alt: v2, className: u, style: c }, h2))) : g2 ? e.createElement($, { src: k2, srcSetData: { srcSet: x2 }, placeholder: "" }, function(t3, n3, r3) {
    return n3 ? e.createElement("img", { src: T2, alt: v2, className: u, style: m({ filter: "blur(8px)" }, s2) }) : e.createElement("img", m({ src: t3, srcSet: r3.srcSet, alt: v2, className: u, style: s2 }, h2));
  }) : e.createElement("div", { className: i, style: c }, e.createElement($, { src: k2, srcSetData: { srcSet: x2 }, placeholder: "" }, function(t3, n3, r3) {
    return n3 ? e.createElement("img", { src: T2, alt: v2, className: u, style: m({ filter: "blur(8px)" }, s2) }) : e.createElement("img", m({ src: t3, srcSet: r3.srcSet, alt: v2, className: u, style: s2 }, h2));
  }));
};
var ne = function(t2) {
  var r2, a2, o2 = (0, import_react9.useContext)(k).values[t2.propName];
  if ((r2 = ne.prototype) === null || r2 === void 0 ? void 0 : r2.renderAdmin)
    return (a2 = ne.prototype) === null || a2 === void 0 ? void 0 : a2.renderAdmin(t2);
  t2.maxWidth, t2.aspectRatio;
  var i = f(t2, ["maxWidth", "aspectRatio"]);
  return e.createElement(te, m({}, i, { source: o2 }));
};
var re = function(e2) {
  var t2, r2 = e2.allowedExtensions, a2 = r2 === void 0 ? [] : r2, o2 = e2.propName, i = e2.renderBlock, l = (0, import_react9.useContext)(k).values[o2];
  return ((t2 = re.prototype) === null || t2 === void 0 ? void 0 : t2.renderAdmin) ? re.prototype.renderAdmin({ propName: o2, renderBlock: i, allowedExtensions: a2 }) : l ? i(l) : null;
};
var ae = function(t2) {
  var a2, o2, i = t2.propName, l = t2.itemProps, c = l === void 0 ? {} : l, u = t2.renderWrapper, d2 = t2.renderItemWrapper, s2 = (0, import_react9.useContext)(B).bricks, p2 = (0, import_react9.useContext)(k), f2 = p2.values, g2 = p2.parentId, h2 = p2.parentType, v2 = p2.handleChange, y2 = p2.handleAddItem, b2 = f2[i];
  ...
  }, [g2, i, b2]), (a2 = ae.prototype) === null || a2 === void 0 ? void 0 : a2.renderAdmin)
    return (o2 = ae.prototype) === null || o2 === void 0 ? void 0 : o2.renderAdmin({ propName: i, itemProps: c, renderWrapper: u, renderItemWrapper: d2 });
  if (!b2 || b2.length === 0)
    return null;
  var E2 = e.createElement(e.Fragment, null, b2.map(function(t3, n2) {
    var r2 = s2[t3.type];
    if (r2) {
      var a3 = r2.schema.sideEditProps ? r2.schema.sideEditProps.reduce(function(e2, n3) {
        ...
        return n3.groupName ? a4 = n3.props.map(function(e3) {
          ...
          return m(m({}, e3), t4);
        }, {}) : ((r3 = {})[n3.name] = t3.props[n3.name], a4 = r3), m(m({}, e2), a4);
      }, {}) : {}, o3 = m(m(m({}, a3), c), { key: t3.id, index: n2, onClick: function(e2) {
      }, onFocus: function(e2) {
      }, onChange: function() {
      } }), l2 = e.createElement(k.Provider, { key: t3.id, value: { onChange: v2(t3.id, g2, i), values: t3.props, blockId: t3.id, parentId: g2, parentType: h2, handleChange: v2 } }, e.createElement(r2, m({}, o3)));
...
var oe = function() {
  var e2, t2;
  return ((e2 = oe.prototype) === null || e2 === void 0 ? void 0 : e2.useAdmin) ? (t2 = oe.prototype) === null || t2 === void 0 ? void 0 : t2.useAdmin() : { isAdmin: false, previewMode: false, currentPage: { pageId: "" } };
};
var ie = function(e2) {
  var t2, r2, a2 = (0, import_react9.useContext)(k), o2 = a2.values, i = a2.onChange;
  if ((t2 = ie.prototype) === null || t2 === void 0 ? void 0 : t2.useAdmin)
    return (r2 = ie.prototype) === null || r2 === void 0 ? void 0 : r2.useAdmin(e2);
...
le.schema = { name: "paragraph", label: "Paragraph", getDefaultProps: function() {
  return { text: "Lorem ipsum dolor sit amet" };
} };
var ce = { paragraph: le };
var ue = [{ type: E.DeviceType.Phone, width: 375, label: "Phone (375px)" }, { type: E.DeviceType.Tablet, width: 768, label: "Tablet (768px)" }, { type: E.DeviceType.Desktop, width: "100%", label: "Desktop (100%)" }];
var de = new QueryClient();
var se = [{ name: "page", pluralName: "pages", defaultLocked: false, defaultStatus: E.PageStatus.Draft, defaultLanguage: "en", getDefaultContent: function() {
  return [];
} }];
var pe = function(t2) {
  var n2 = t2.appId, r2 = t2.apiKey, a2 = t2.bricks, o2 = t2.pageTypes, i = t2.customFields, c = t2.logo, u = c === void 0 ? "" : c, d2 = t2.contentClassName, s2 = d2 === void 0 ? "" : d2, p2 = t2.renderLocalLink, f2 = t2.navigate, g2 = t2.loginPath, h2 = g2 === void 0 ? "/admin" : g2, v2 = t2.editorPath, y2 = v2 === void 0 ? "/admin/editor" : v2, b2 = t2.playgroundPath, k2 = b2 === void 0 ? "/admin/playground" : b2, T2 = t2.appSettingsPath, x2 = T2 === void 0 ? "/admin/app-settings" : T2, P2 = t2.previewPath, S2 = P2 === void 0 ? "/preview" : P2, I2 = t2.isDarkColorMode, w2 = I2 !== void 0 && I2, L2 = t2.toggleColorMode, C2 = t2.useCssInJs, N2 = C2 !== void 0 && C2, A2 = t2.appRootElement, R2 = t2.clickToEditSide, D2 = R2 === void 0 ? E.ClickToEditSide.BottomRight : R2, O2 = t2.responsiveBreakpoints, F2 = t2.enableAutoSave, H2 = F2 === void 0 || F2, z2 = t2.disableSaveIfInvalidProps, j2 = z2 !== void 0 && z2, K2 = t2.enablePreview, M2 = K2 !== void 0 && K2, U2 = t2.children, _2 = false;
  if (a2 && a2.length !== 0 || console.warn("No bricks provided. Using default paragraph."), o2 || console.warn("No Page type schema provided. Using default page."), Array.isArray(a2) || (console.error('"bricks" should be an array of Bricks'), _2 = true), o2 == null || o2.forEach(function(e2) {
  ...
  var G2 = a2 == null ? void 0 : a2.reduce(function(e2, t3) {
    var n3;
    return m(m({}, e2), ((n3 = {})[t3.schema.name] = t3, n3));
  }, {}), W2 = O2 && O2.length ? O2 : ue;
  return e.createElement(B.Provider, { value: { appId: n2, apiKey: r2, bricks: G2 || ce, pageTypes: o2 || se, customFields: i, logo: u, contentClassName: s2, renderLocalLink: p2, navigate: f2, loginPath: h2, editorPath: y2, playgroundPath: k2, appSettingsPath: x2, previewPath: S2, isDarkColorMode: w2, toggleColorMode: L2, useCssInJs: N2, appRootElement: A2, clickToEditSide: D2, responsiveBreakpoints: W2, enableAutoSave: !!H2, disableSaveIfInvalidProps: !!j2, enablePreview: !!M2 } }, e.createElement(QueryClientProvider, { client: de }, U2));
};
var me = e.createContext({ pageValues: { id: "", type: "", name: "", slug: "", meta: {}, authorId: "", author: { id: "", email: "", firstName: "", lastName: "" }, invalidBlocksTypes: [], status: E.PageStatus.Draft, isLocked: false, tags: [], createdAt: "", publishedAt: "", language: "", translations: [] } });
var fe = function() {
  var e2 = (0, import_react9.useContext)(T), t2 = e2.pageValues, r2 = e2.handleChangePageValue, a2 = (0, import_react9.useContext)(me).pageValues;
  return [t2.id ? t2 : a2, r2];
};
var ge = function(t2) {
  var n2 = t2.bricks, r2 = t2.block;
  return e.createElement(e.Fragment, null, function(t3) {
    var r3 = n2[t3.type], a2 = y(fe(), 1)[0];
    if (r3) {
      var o2 = t3.props;
      return r3.schema.mapExternalDataToProps && typeof r3.schema.mapExternalDataToProps == "function" && a2.externalData && typeof a2.externalData == "object" && (o2 = r3.schema.mapExternalDataToProps(a2.externalData, t3.props)), e.createElement(k.Provider, { value: { values: o2, onChange: function() {
...
var he = function(t2) {
  ...
  return e.createElement("div", null, r2.map(function(t3) {
    return e.createElement(ge, { key: t3.id, bricks: n2, block: t3 });
  }));
};
var ve = "https://api.reactbricks.com/v2";
var ye = "rb_t";
var be = function(e2) {
  var r2 = e2.pageId, a2 = e2.language, o2 = (0, import_react9.useContext)(B), i = o2.navigate, l = o2.editorPath, c = o2.clickToEditSide;
  if (typeof localStorage == "undefined")
    return null;
  var d2, s2 = localStorage.getItem("rb_t");
  if (s2 && s2.length > 10 && s2.startsWith("ey")) {
    var p2 = {};
    return c === E.ClickToEditSide.BottomRight && (p2.bottom = 50, p2.right = 0, p2.borderTopLeftRadius = 999, p2.borderBottomLeftRadius = 999, p2.transform = "translate(8px,0)"), c === E.ClickToEditSide.BottomLeft && (p2.bottom = 50, p2.left = 0, p2.borderTopRightRadius = 999, p2.borderBottomRightRadius = 999, p2.transform = "translate(-8px,0)"), c === E.ClickToEditSide.TopRight && (p2.top = 50, p2.right = 0, p2.borderTopLeftRadius = 999, p2.borderBottomLeftRadius = 999, p2.transform = "translate(8px,0)"), c === E.ClickToEditSide.TopLeft && (p2.top = 50, p2.left = 0, p2.borderTopRightRadius = 999, p2.borderBottomRightRadius = 999, p2.transform = "translate(-8px,0)"), import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement("style", null, "\n.rb-click-to-edit {\n  position: fixed;\n  width: 61px;\n  height: 38px;\n  background-color: #f65a8e;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  color: #fff;\n  font-size: 20px;\n  cursor: pointer;\n  box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);\n  transition: all 150ms ease;\n  border: 2px solid #fff;\n}\n.rb-click-to-edit-left:hover {\n  transform: translate(-2px,0)!important;\n}\n.rb-click-to-edit-right:hover {\n  transform: translate(2px,0)!important;\n}\n      "), import_react9.default.createElement("div", { className: "rb-click-to-edit ".concat((d2 = c, d2 === E.ClickToEditSide.TopLeft || d2 === E.ClickToEditSide.BottomLeft ? "rb-click-to-edit-left" : "rb-click-to-edit-right")), style: p2, onClick: function() {
...
var Ee = function(t2) {
  ...
  if (!r2)
    return null;
  var a2 = (0, import_react9.useContext)(B).bricks;
  r2.content;
  var o2 = f(r2, ["content"]), i = m({}, o2);
  return e.createElement("div", null, r2 && r2.content && r2.content.length > 0 && e.createElement(me.Provider, { value: { pageValues: i } }, e.createElement(he, { bricks: a2, content: r2.content }), e.createElement(be, { pageId: r2.id, language: r2.language })));
};
...
var Te = { id: "", type: "", slug: "", name: "", meta: {}, author: { id: "", firstName: "", lastName: "", email: "" }, status: E.PageStatus.Draft, isLocked: false, content: [], tags: [], createdAt: "", language: "en", translations: [] };
var xe = function(e2, t2, n2) {
  ...
  if (!r2)
    return Te;
  var a2 = Pe(n2, e2.content, r2.allowedBlockTypes, r2.excludedBlockTypes);
  return m(m({}, e2), { content: a2.blocks, invalidBlocksTypes: a2.invalidBlocksTypes });
};
var Pe = function(e2, t2, n2, r2) {
  return t2.reduce(function(t3, a2) {
    var o2 = e2[a2.type];
    if (!o2 || !ke(a2.type, n2, r2))
      return m(m({}, t3), { invalidBlocksTypes: b(b([], y(t3.invalidBlocksTypes), false), [a2.type], false) });
    var i = o2.schema.sideEditProps ? o2.schema.sideEditProps.reduce(function(e3, t4) {
      if (t4.groupName || t4.type !== "BOOLEAN" || e3.push(t4), t4.groupName) {
        var n3 = t4.props.filter(function(e4) {
          return e4.type === "BOOLEAN";
        });
        e3 = b(b([], y(e3), false), y(n3), false);
      }
      return e3;
    }, []) : [], l = i.reduce(function(e3, t4) {
      var n3, r3 = a2.props[t4.name];
      return m(m({}, e3), ((n3 = {})[t4.name] = !!r3, n3));
    }, {}), c = m(m({}, a2), { props: m(m({}, a2.props), l) });
    return Object.keys(c.props).forEach(function(t4) {
      var n3, r3, a3, i2, l2, u, d2;
      c.props[t4] && ((r3 = (n3 = c.props[t4]) === null || n3 === void 0 ? void 0 : n3.document) === null || r3 === void 0 ? void 0 : r3.data) && ((i2 = (a3 = c.props[t4]) === null || a3 === void 0 ? void 0 : a3.document) === null || i2 === void 0 ? void 0 : i2.nodes) && ((u = (l2 = c.props[t4]) === null || l2 === void 0 ? void 0 : l2.document) === null || u === void 0 ? void 0 : u.object) === "document" || ((d2 = o2.schema.repeaterItems) === null || d2 === void 0 ? void 0 : d2.find(function(e3) {
        return e3.name === t4;
      })) && (c.props[t4] = Pe(e2, c.props[t4]).blocks);
    }), m(m({}, t3), { blocks: b(b([], y(t3.blocks), false), [c], false) });
...
var we = function(e2) {
  var t2 = e2 === void 0 ? {} : e2, n2 = t2.type, r2 = n2 === void 0 ? "" : n2, a2 = t2.types, o2 = a2 === void 0 ? [] : a2, i = t2.tag, l = i === void 0 ? "" : i, u = t2.language, s2 = u === void 0 ? "" : u, p2 = t2.page, m2 = p2 === void 0 ? 1 : p2, f2 = t2.pageSize, v2 = f2 === void 0 ? 500 : f2, y2 = t2.sort, b2 = y2 === void 0 ? "" : y2, E2 = t2.usePagination, k2 = E2 !== void 0 && E2;
  v2 <= 0 && (v2 = 500);
  var T2 = localStorage.getItem("rb_t"), x2 = Ie("t"), P2 = "type=".concat(r2, "&types=").concat(o2 == null ? void 0 : o2.join(","), "&tag=").concat(l, "&language=").concat(s2, "&page=").concat(m2, "&pageSize=").concat(v2, "&sort=").concat(b2);
  return useQuery(["pages", { pageType: r2, pageTypes: o2, tag: l, language: s2, page: m2, pageSize: v2, sort: b2 }], function() {
    return g(void 0, void 0, void 0, function() {
      var e3, t3, n3, r3;
      return h(this, function(a3) {
        switch (a3.label) {
          case 0:
            return [4, import_axios.default.get("".concat(ve, "/admin/pages?").concat(P2))];
          case 1:
...
var Le = function(e2, t2) {
  var r2 = (0, import_react9.useContext)(B).pageTypes, a2 = localStorage.getItem("rb_t"), o2 = Ie("t");
  return useQuery(["page", { pageId: e2, language: t2 }], function() {
    return g(void 0, void 0, Promise, function() {
      ...
      return h(this, function(c) {
        switch (c.label) {
          case 0:
            return [4, import_axios.default.get(t2 ? "".concat(ve, "/admin/pages/").concat(e2, "/translations/").concat(t2) : "".concat(ve, "/admin/pages/").concat(e2), { headers: { Authorization: "Bearer ".concat(a2 || o2) } })];
          case 1:
  ...
  }, { enabled: !(!e2 || !a2 && !o2), refetchOnWindowFocus: false });
};
...
*/
//# sourceMappingURL=/build/_shared/chunk-SEO2H4MT.js.map
